const YE=function(){const e=document.createElement("link").relList;return e&&e.supports&&e.supports("modulepreload")?"modulepreload":"preload"}(),hf={},XE="/",mi=function(e,n){return!n||n.length===0?e():Promise.all(n.map(r=>{if(r=`${XE}${r}`,r in hf)return;hf[r]=!0;const i=r.endsWith(".css"),s=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${s}`))return;const o=document.createElement("link");if(o.rel=i?"stylesheet":YE,i||(o.as="script",o.crossOrigin=""),o.href=r,document.head.appendChild(o),i)return new Promise((a,c)=>{o.addEventListener("load",a),o.addEventListener("error",()=>c(new Error(`Unable to preload CSS for ${r}`)))})})).then(()=>e())};function rh(t,e){const n=Object.create(null),r=t.split(",");for(let i=0;i<r.length;i++)n[r[i]]=!0;return e?i=>!!n[i.toLowerCase()]:i=>!!n[i]}const Pe={},gi=[],Kt=()=>{},ZE=()=>!1,eI=/^on[^a-z]/,Xa=t=>eI.test(t),ih=t=>t.startsWith("onUpdate:"),Ge=Object.assign,sh=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},tI=Object.prototype.hasOwnProperty,pe=(t,e)=>tI.call(t,e),Z=Array.isArray,_i=t=>Za(t)==="[object Map]",ug=t=>Za(t)==="[object Set]",se=t=>typeof t=="function",He=t=>typeof t=="string",oh=t=>typeof t=="symbol",Ve=t=>t!==null&&typeof t=="object",lg=t=>Ve(t)&&se(t.then)&&se(t.catch),hg=Object.prototype.toString,Za=t=>hg.call(t),nI=t=>Za(t).slice(8,-1),dg=t=>Za(t)==="[object Object]",ah=t=>He(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,ca=rh(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),ec=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},rI=/-(\w)/g,ln=ec(t=>t.replace(rI,(e,n)=>n?n.toUpperCase():"")),iI=/\B([A-Z])/g,ji=ec(t=>t.replace(iI,"-$1").toLowerCase()),tc=ec(t=>t.charAt(0).toUpperCase()+t.slice(1)),nu=ec(t=>t?`on${tc(t)}`:""),Ls=(t,e)=>!Object.is(t,e),ru=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Ea=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},sI=t=>{const e=parseFloat(t);return isNaN(e)?t:e},oI=t=>{const e=He(t)?Number(t):NaN;return isNaN(e)?t:e};let df;const Hu=()=>df||(df=typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{});function ch(t){if(Z(t)){const e={};for(let n=0;n<t.length;n++){const r=t[n],i=He(r)?lI(r):ch(r);if(i)for(const s in i)e[s]=i[s]}return e}else{if(He(t))return t;if(Ve(t))return t}}const aI=/;(?![^(]*\))/g,cI=/:([^]+)/,uI=/\/\*[^]*?\*\//g;function lI(t){const e={};return t.replace(uI,"").split(aI).forEach(n=>{if(n){const r=n.split(cI);r.length>1&&(e[r[0].trim()]=r[1].trim())}}),e}function uh(t){let e="";if(He(t))e=t;else if(Z(t))for(let n=0;n<t.length;n++){const r=uh(t[n]);r&&(e+=r+" ")}else if(Ve(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const hI="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",dI=rh(hI);function fg(t){return!!t||t===""}const Ck=t=>He(t)?t:t==null?"":Z(t)||Ve(t)&&(t.toString===hg||!se(t.toString))?JSON.stringify(t,pg,2):String(t),pg=(t,e)=>e&&e.__v_isRef?pg(t,e.value):_i(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[r,i])=>(n[`${r} =>`]=i,n),{})}:ug(e)?{[`Set(${e.size})`]:[...e.values()]}:Ve(e)&&!Z(e)&&!dg(e)?String(e):e;let Ct;class mg{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Ct,!e&&Ct&&(this.index=(Ct.scopes||(Ct.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=Ct;try{return Ct=this,e()}finally{Ct=n}}}on(){Ct=this}off(){Ct=this.parent}stop(e){if(this._active){let n,r;for(n=0,r=this.effects.length;n<r;n++)this.effects[n].stop();for(n=0,r=this.cleanups.length;n<r;n++)this.cleanups[n]();if(this.scopes)for(n=0,r=this.scopes.length;n<r;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0,this._active=!1}}}function gg(t){return new mg(t)}function fI(t,e=Ct){e&&e.active&&e.effects.push(t)}function _g(){return Ct}function pI(t){Ct&&Ct.cleanups.push(t)}const lh=t=>{const e=new Set(t);return e.w=0,e.n=0,e},yg=t=>(t.w&Qn)>0,vg=t=>(t.n&Qn)>0,mI=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=Qn},gI=t=>{const{deps:e}=t;if(e.length){let n=0;for(let r=0;r<e.length;r++){const i=e[r];yg(i)&&!vg(i)?i.delete(t):e[n++]=i,i.w&=~Qn,i.n&=~Qn}e.length=n}},Ia=new WeakMap;let ys=0,Qn=1;const Wu=30;let qt;const kr=Symbol(""),Qu=Symbol("");class hh{constructor(e,n=null,r){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,fI(this,r)}run(){if(!this.active)return this.fn();let e=qt,n=jn;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=qt,qt=this,jn=!0,Qn=1<<++ys,ys<=Wu?mI(this):ff(this),this.fn()}finally{ys<=Wu&&gI(this),Qn=1<<--ys,qt=this.parent,jn=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){qt===this?this.deferStop=!0:this.active&&(ff(this),this.onStop&&this.onStop(),this.active=!1)}}function ff(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let jn=!0;const wg=[];function Ki(){wg.push(jn),jn=!1}function zi(){const t=wg.pop();jn=t===void 0?!0:t}function Rt(t,e,n){if(jn&&qt){let r=Ia.get(t);r||Ia.set(t,r=new Map);let i=r.get(n);i||r.set(n,i=lh()),Eg(i)}}function Eg(t,e){let n=!1;ys<=Wu?vg(t)||(t.n|=Qn,n=!yg(t)):n=!t.has(qt),n&&(t.add(qt),qt.deps.push(t))}function vn(t,e,n,r,i,s){const o=Ia.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&Z(t)){const c=Number(r);o.forEach((u,l)=>{(l==="length"||l>=c)&&a.push(u)})}else switch(n!==void 0&&a.push(o.get(n)),e){case"add":Z(t)?ah(n)&&a.push(o.get("length")):(a.push(o.get(kr)),_i(t)&&a.push(o.get(Qu)));break;case"delete":Z(t)||(a.push(o.get(kr)),_i(t)&&a.push(o.get(Qu)));break;case"set":_i(t)&&a.push(o.get(kr));break}if(a.length===1)a[0]&&Ju(a[0]);else{const c=[];for(const u of a)u&&c.push(...u);Ju(lh(c))}}function Ju(t,e){const n=Z(t)?t:[...t];for(const r of n)r.computed&&pf(r);for(const r of n)r.computed||pf(r)}function pf(t,e){(t!==qt||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}function _I(t,e){var n;return(n=Ia.get(t))==null?void 0:n.get(e)}const yI=rh("__proto__,__v_isRef,__isVue"),Ig=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(oh)),vI=dh(),wI=dh(!1,!0),EI=dh(!0),mf=II();function II(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const r=fe(this);for(let s=0,o=this.length;s<o;s++)Rt(r,"get",s+"");const i=r[e](...n);return i===-1||i===!1?r[e](...n.map(fe)):i}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){Ki();const r=fe(this)[e].apply(this,n);return zi(),r}}),t}function TI(t){const e=fe(this);return Rt(e,"has",t),e.hasOwnProperty(t)}function dh(t=!1,e=!1){return function(r,i,s){if(i==="__v_isReactive")return!t;if(i==="__v_isReadonly")return t;if(i==="__v_isShallow")return e;if(i==="__v_raw"&&s===(t?e?BI:Rg:e?Sg:Ag).get(r))return r;const o=Z(r);if(!t){if(o&&pe(mf,i))return Reflect.get(mf,i,s);if(i==="hasOwnProperty")return TI}const a=Reflect.get(r,i,s);return(oh(i)?Ig.has(i):yI(i))||(t||Rt(r,"get",i),e)?a:qe(a)?o&&ah(i)?a:a.value:Ve(a)?t?Cg(a):Yr(a):a}}const bI=Tg(),AI=Tg(!0);function Tg(t=!1){return function(n,r,i,s){let o=n[r];if(bi(o)&&qe(o)&&!qe(i))return!1;if(!t&&(!Ta(i)&&!bi(i)&&(o=fe(o),i=fe(i)),!Z(n)&&qe(o)&&!qe(i)))return o.value=i,!0;const a=Z(n)&&ah(r)?Number(r)<n.length:pe(n,r),c=Reflect.set(n,r,i,s);return n===fe(s)&&(a?Ls(i,o)&&vn(n,"set",r,i):vn(n,"add",r,i)),c}}function SI(t,e){const n=pe(t,e);t[e];const r=Reflect.deleteProperty(t,e);return r&&n&&vn(t,"delete",e,void 0),r}function RI(t,e){const n=Reflect.has(t,e);return(!oh(e)||!Ig.has(e))&&Rt(t,"has",e),n}function PI(t){return Rt(t,"iterate",Z(t)?"length":kr),Reflect.ownKeys(t)}const bg={get:vI,set:bI,deleteProperty:SI,has:RI,ownKeys:PI},CI={get:EI,set(t,e){return!0},deleteProperty(t,e){return!0}},xI=Ge({},bg,{get:wI,set:AI}),fh=t=>t,nc=t=>Reflect.getPrototypeOf(t);function Ko(t,e,n=!1,r=!1){t=t.__v_raw;const i=fe(t),s=fe(e);n||(e!==s&&Rt(i,"get",e),Rt(i,"get",s));const{has:o}=nc(i),a=r?fh:n?gh:Bs;if(o.call(i,e))return a(t.get(e));if(o.call(i,s))return a(t.get(s));t!==i&&t.get(e)}function zo(t,e=!1){const n=this.__v_raw,r=fe(n),i=fe(t);return e||(t!==i&&Rt(r,"has",t),Rt(r,"has",i)),t===i?n.has(t):n.has(t)||n.has(i)}function Go(t,e=!1){return t=t.__v_raw,!e&&Rt(fe(t),"iterate",kr),Reflect.get(t,"size",t)}function gf(t){t=fe(t);const e=fe(this);return nc(e).has.call(e,t)||(e.add(t),vn(e,"add",t,t)),this}function _f(t,e){e=fe(e);const n=fe(this),{has:r,get:i}=nc(n);let s=r.call(n,t);s||(t=fe(t),s=r.call(n,t));const o=i.call(n,t);return n.set(t,e),s?Ls(e,o)&&vn(n,"set",t,e):vn(n,"add",t,e),this}function yf(t){const e=fe(this),{has:n,get:r}=nc(e);let i=n.call(e,t);i||(t=fe(t),i=n.call(e,t)),r&&r.call(e,t);const s=e.delete(t);return i&&vn(e,"delete",t,void 0),s}function vf(){const t=fe(this),e=t.size!==0,n=t.clear();return e&&vn(t,"clear",void 0,void 0),n}function Ho(t,e){return function(r,i){const s=this,o=s.__v_raw,a=fe(o),c=e?fh:t?gh:Bs;return!t&&Rt(a,"iterate",kr),o.forEach((u,l)=>r.call(i,c(u),c(l),s))}}function Wo(t,e,n){return function(...r){const i=this.__v_raw,s=fe(i),o=_i(s),a=t==="entries"||t===Symbol.iterator&&o,c=t==="keys"&&o,u=i[t](...r),l=n?fh:e?gh:Bs;return!e&&Rt(s,"iterate",c?Qu:kr),{next(){const{value:h,done:d}=u.next();return d?{value:h,done:d}:{value:a?[l(h[0]),l(h[1])]:l(h),done:d}},[Symbol.iterator](){return this}}}}function Cn(t){return function(...e){return t==="delete"?!1:this}}function DI(){const t={get(s){return Ko(this,s)},get size(){return Go(this)},has:zo,add:gf,set:_f,delete:yf,clear:vf,forEach:Ho(!1,!1)},e={get(s){return Ko(this,s,!1,!0)},get size(){return Go(this)},has:zo,add:gf,set:_f,delete:yf,clear:vf,forEach:Ho(!1,!0)},n={get(s){return Ko(this,s,!0)},get size(){return Go(this,!0)},has(s){return zo.call(this,s,!0)},add:Cn("add"),set:Cn("set"),delete:Cn("delete"),clear:Cn("clear"),forEach:Ho(!0,!1)},r={get(s){return Ko(this,s,!0,!0)},get size(){return Go(this,!0)},has(s){return zo.call(this,s,!0)},add:Cn("add"),set:Cn("set"),delete:Cn("delete"),clear:Cn("clear"),forEach:Ho(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(s=>{t[s]=Wo(s,!1,!1),n[s]=Wo(s,!0,!1),e[s]=Wo(s,!1,!0),r[s]=Wo(s,!0,!0)}),[t,n,e,r]}const[VI,kI,NI,OI]=DI();function ph(t,e){const n=e?t?OI:NI:t?kI:VI;return(r,i,s)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?r:Reflect.get(pe(n,i)&&i in r?n:r,i,s)}const MI={get:ph(!1,!1)},FI={get:ph(!1,!0)},LI={get:ph(!0,!1)},Ag=new WeakMap,Sg=new WeakMap,Rg=new WeakMap,BI=new WeakMap;function $I(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function qI(t){return t.__v_skip||!Object.isExtensible(t)?0:$I(nI(t))}function Yr(t){return bi(t)?t:mh(t,!1,bg,MI,Ag)}function Pg(t){return mh(t,!1,xI,FI,Sg)}function Cg(t){return mh(t,!0,CI,LI,Rg)}function mh(t,e,n,r,i){if(!Ve(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const s=i.get(t);if(s)return s;const o=qI(t);if(o===0)return t;const a=new Proxy(t,o===2?r:n);return i.set(t,a),a}function Kn(t){return bi(t)?Kn(t.__v_raw):!!(t&&t.__v_isReactive)}function bi(t){return!!(t&&t.__v_isReadonly)}function Ta(t){return!!(t&&t.__v_isShallow)}function xg(t){return Kn(t)||bi(t)}function fe(t){const e=t&&t.__v_raw;return e?fe(e):t}function vo(t){return Ea(t,"__v_skip",!0),t}const Bs=t=>Ve(t)?Yr(t):t,gh=t=>Ve(t)?Cg(t):t;function Dg(t){jn&&qt&&(t=fe(t),Eg(t.dep||(t.dep=lh())))}function Vg(t,e){t=fe(t);const n=t.dep;n&&Ju(n)}function qe(t){return!!(t&&t.__v_isRef===!0)}function rc(t){return kg(t,!1)}function UI(t){return kg(t,!0)}function kg(t,e){return qe(t)?t:new jI(t,e)}class jI{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:fe(e),this._value=n?e:Bs(e)}get value(){return Dg(this),this._value}set value(e){const n=this.__v_isShallow||Ta(e)||bi(e);e=n?e:fe(e),Ls(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:Bs(e),Vg(this))}}function yi(t){return qe(t)?t.value:t}const KI={get:(t,e,n)=>yi(Reflect.get(t,e,n)),set:(t,e,n,r)=>{const i=t[e];return qe(i)&&!qe(n)?(i.value=n,!0):Reflect.set(t,e,n,r)}};function Ng(t){return Kn(t)?t:new Proxy(t,KI)}function zI(t){const e=Z(t)?new Array(t.length):{};for(const n in t)e[n]=HI(t,n);return e}class GI{constructor(e,n,r){this._object=e,this._key=n,this._defaultValue=r,this.__v_isRef=!0}get value(){const e=this._object[this._key];return e===void 0?this._defaultValue:e}set value(e){this._object[this._key]=e}get dep(){return _I(fe(this._object),this._key)}}function HI(t,e,n){const r=t[e];return qe(r)?r:new GI(t,e,n)}class WI{constructor(e,n,r,i){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new hh(e,()=>{this._dirty||(this._dirty=!0,Vg(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!i,this.__v_isReadonly=r}get value(){const e=fe(this);return Dg(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function QI(t,e,n=!1){let r,i;const s=se(t);return s?(r=t,i=Kt):(r=t.get,i=t.set),new WI(r,i,s||!i,n)}function zn(t,e,n,r){let i;try{i=r?t(...r):t()}catch(s){ic(s,e,n)}return i}function Ft(t,e,n,r){if(se(t)){const s=zn(t,e,n,r);return s&&lg(s)&&s.catch(o=>{ic(o,e,n)}),s}const i=[];for(let s=0;s<t.length;s++)i.push(Ft(t[s],e,n,r));return i}function ic(t,e,n,r=!0){const i=e?e.vnode:null;if(e){let s=e.parent;const o=e.proxy,a=n;for(;s;){const u=s.ec;if(u){for(let l=0;l<u.length;l++)if(u[l](t,o,a)===!1)return}s=s.parent}const c=e.appContext.config.errorHandler;if(c){zn(c,null,10,[t,o,a]);return}}JI(t,n,i,r)}function JI(t,e,n,r=!0){console.error(t)}let $s=!1,Yu=!1;const ft=[];let en=0;const vi=[];let pn=null,Ir=0;const Og=Promise.resolve();let _h=null;function yh(t){const e=_h||Og;return t?e.then(this?t.bind(this):t):e}function YI(t){let e=en+1,n=ft.length;for(;e<n;){const r=e+n>>>1;qs(ft[r])<t?e=r+1:n=r}return e}function vh(t){(!ft.length||!ft.includes(t,$s&&t.allowRecurse?en+1:en))&&(t.id==null?ft.push(t):ft.splice(YI(t.id),0,t),Mg())}function Mg(){!$s&&!Yu&&(Yu=!0,_h=Og.then(Lg))}function XI(t){const e=ft.indexOf(t);e>en&&ft.splice(e,1)}function ZI(t){Z(t)?vi.push(...t):(!pn||!pn.includes(t,t.allowRecurse?Ir+1:Ir))&&vi.push(t),Mg()}function wf(t,e=$s?en+1:0){for(;e<ft.length;e++){const n=ft[e];n&&n.pre&&(ft.splice(e,1),e--,n())}}function Fg(t){if(vi.length){const e=[...new Set(vi)];if(vi.length=0,pn){pn.push(...e);return}for(pn=e,pn.sort((n,r)=>qs(n)-qs(r)),Ir=0;Ir<pn.length;Ir++)pn[Ir]();pn=null,Ir=0}}const qs=t=>t.id==null?1/0:t.id,eT=(t,e)=>{const n=qs(t)-qs(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function Lg(t){Yu=!1,$s=!0,ft.sort(eT);const e=Kt;try{for(en=0;en<ft.length;en++){const n=ft[en];n&&n.active!==!1&&zn(n,null,14)}}finally{en=0,ft.length=0,Fg(),$s=!1,_h=null,(ft.length||vi.length)&&Lg()}}function tT(t,e,...n){if(t.isUnmounted)return;const r=t.vnode.props||Pe;let i=n;const s=e.startsWith("update:"),o=s&&e.slice(7);if(o&&o in r){const l=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:d}=r[l]||Pe;d&&(i=n.map(f=>He(f)?f.trim():f)),h&&(i=n.map(sI))}let a,c=r[a=nu(e)]||r[a=nu(ln(e))];!c&&s&&(c=r[a=nu(ji(e))]),c&&Ft(c,t,6,i);const u=r[a+"Once"];if(u){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,Ft(u,t,6,i)}}function Bg(t,e,n=!1){const r=e.emitsCache,i=r.get(t);if(i!==void 0)return i;const s=t.emits;let o={},a=!1;if(!se(t)){const c=u=>{const l=Bg(u,e,!0);l&&(a=!0,Ge(o,l))};!n&&e.mixins.length&&e.mixins.forEach(c),t.extends&&c(t.extends),t.mixins&&t.mixins.forEach(c)}return!s&&!a?(Ve(t)&&r.set(t,null),null):(Z(s)?s.forEach(c=>o[c]=null):Ge(o,s),Ve(t)&&r.set(t,o),o)}function sc(t,e){return!t||!Xa(e)?!1:(e=e.slice(2).replace(/Once$/,""),pe(t,e[0].toLowerCase()+e.slice(1))||pe(t,ji(e))||pe(t,e))}let Tt=null,$g=null;function ba(t){const e=Tt;return Tt=t,$g=t&&t.type.__scopeId||null,e}function nT(t,e=Tt,n){if(!e||t._n)return t;const r=(...i)=>{r._d&&Vf(-1);const s=ba(e);let o;try{o=t(...i)}finally{ba(s),r._d&&Vf(1)}return o};return r._n=!0,r._c=!0,r._d=!0,r}function iu(t){const{type:e,vnode:n,proxy:r,withProxy:i,props:s,propsOptions:[o],slots:a,attrs:c,emit:u,render:l,renderCache:h,data:d,setupState:f,ctx:g,inheritAttrs:v}=t;let E,b;const S=ba(t);try{if(n.shapeFlag&4){const V=i||r;E=Zt(l.call(V,V,h,s,f,d,g)),b=c}else{const V=e;E=Zt(V.length>1?V(s,{attrs:c,slots:a,emit:u}):V(s,null)),b=e.props?c:rT(c)}}catch(V){Rs.length=0,ic(V,t,1),E=xt(zt)}let D=E;if(b&&v!==!1){const V=Object.keys(b),{shapeFlag:j}=D;V.length&&j&7&&(o&&V.some(ih)&&(b=iT(b,o)),D=Jn(D,b))}return n.dirs&&(D=Jn(D),D.dirs=D.dirs?D.dirs.concat(n.dirs):n.dirs),n.transition&&(D.transition=n.transition),E=D,ba(S),E}const rT=t=>{let e;for(const n in t)(n==="class"||n==="style"||Xa(n))&&((e||(e={}))[n]=t[n]);return e},iT=(t,e)=>{const n={};for(const r in t)(!ih(r)||!(r.slice(9)in e))&&(n[r]=t[r]);return n};function sT(t,e,n){const{props:r,children:i,component:s}=t,{props:o,children:a,patchFlag:c}=e,u=s.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return r?Ef(r,o,u):!!o;if(c&8){const l=e.dynamicProps;for(let h=0;h<l.length;h++){const d=l[h];if(o[d]!==r[d]&&!sc(u,d))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:r===o?!1:r?o?Ef(r,o,u):!0:!!o;return!1}function Ef(t,e,n){const r=Object.keys(e);if(r.length!==Object.keys(t).length)return!0;for(let i=0;i<r.length;i++){const s=r[i];if(e[s]!==t[s]&&!sc(n,s))return!0}return!1}function oT({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const aT=t=>t.__isSuspense;function cT(t,e){e&&e.pendingBranch?Z(t)?e.effects.push(...t):e.effects.push(t):ZI(t)}const Qo={};function As(t,e,n){return qg(t,e,n)}function qg(t,e,{immediate:n,deep:r,flush:i,onTrack:s,onTrigger:o}=Pe){var a;const c=_g()===((a=Qe)==null?void 0:a.scope)?Qe:null;let u,l=!1,h=!1;if(qe(t)?(u=()=>t.value,l=Ta(t)):Kn(t)?(u=()=>t,r=!0):Z(t)?(h=!0,l=t.some(V=>Kn(V)||Ta(V)),u=()=>t.map(V=>{if(qe(V))return V.value;if(Kn(V))return Cr(V);if(se(V))return zn(V,c,2)})):se(t)?e?u=()=>zn(t,c,2):u=()=>{if(!(c&&c.isUnmounted))return d&&d(),Ft(t,c,3,[f])}:u=Kt,e&&r){const V=u;u=()=>Cr(V())}let d,f=V=>{d=S.onStop=()=>{zn(V,c,4)}},g;if(Ks)if(f=Kt,e?n&&Ft(e,c,3,[u(),h?[]:void 0,f]):u(),i==="sync"){const V=ob();g=V.__watcherHandles||(V.__watcherHandles=[])}else return Kt;let v=h?new Array(t.length).fill(Qo):Qo;const E=()=>{if(!!S.active)if(e){const V=S.run();(r||l||(h?V.some((j,X)=>Ls(j,v[X])):Ls(V,v)))&&(d&&d(),Ft(e,c,3,[V,v===Qo?void 0:h&&v[0]===Qo?[]:v,f]),v=V)}else S.run()};E.allowRecurse=!!e;let b;i==="sync"?b=E:i==="post"?b=()=>It(E,c&&c.suspense):(E.pre=!0,c&&(E.id=c.uid),b=()=>vh(E));const S=new hh(u,b);e?n?E():v=S.run():i==="post"?It(S.run.bind(S),c&&c.suspense):S.run();const D=()=>{S.stop(),c&&c.scope&&sh(c.scope.effects,S)};return g&&g.push(D),D}function uT(t,e,n){const r=this.proxy,i=He(t)?t.includes(".")?Ug(r,t):()=>r[t]:t.bind(r,r);let s;se(e)?s=e:(s=e.handler,n=e);const o=Qe;Ai(this);const a=qg(i,s.bind(r),n);return o?Ai(o):Nr(),a}function Ug(t,e){const n=e.split(".");return()=>{let r=t;for(let i=0;i<n.length&&r;i++)r=r[n[i]];return r}}function Cr(t,e){if(!Ve(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),qe(t))Cr(t.value,e);else if(Z(t))for(let n=0;n<t.length;n++)Cr(t[n],e);else if(ug(t)||_i(t))t.forEach(n=>{Cr(n,e)});else if(dg(t))for(const n in t)Cr(t[n],e);return t}function xk(t,e){const n=Tt;if(n===null)return t;const r=lc(n)||n.proxy,i=t.dirs||(t.dirs=[]);for(let s=0;s<e.length;s++){let[o,a,c,u=Pe]=e[s];o&&(se(o)&&(o={mounted:o,updated:o}),o.deep&&Cr(a),i.push({dir:o,instance:r,value:a,oldValue:void 0,arg:c,modifiers:u}))}return t}function mr(t,e,n,r){const i=t.dirs,s=e&&e.dirs;for(let o=0;o<i.length;o++){const a=i[o];s&&(a.oldValue=s[o].value);let c=a.dir[r];c&&(Ki(),Ft(c,n,8,[t.el,a,t,e]),zi())}}function lT(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Hg(()=>{t.isMounted=!0}),Wg(()=>{t.isUnmounting=!0}),t}const kt=[Function,Array],jg={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:kt,onEnter:kt,onAfterEnter:kt,onEnterCancelled:kt,onBeforeLeave:kt,onLeave:kt,onAfterLeave:kt,onLeaveCancelled:kt,onBeforeAppear:kt,onAppear:kt,onAfterAppear:kt,onAppearCancelled:kt},hT={name:"BaseTransition",props:jg,setup(t,{slots:e}){const n=XT(),r=lT();let i;return()=>{const s=e.default&&zg(e.default(),!0);if(!s||!s.length)return;let o=s[0];if(s.length>1){for(const v of s)if(v.type!==zt){o=v;break}}const a=fe(t),{mode:c}=a;if(r.isLeaving)return su(o);const u=If(o);if(!u)return su(o);const l=Xu(u,a,r,n);Zu(u,l);const h=n.subTree,d=h&&If(h);let f=!1;const{getTransitionKey:g}=u.type;if(g){const v=g();i===void 0?i=v:v!==i&&(i=v,f=!0)}if(d&&d.type!==zt&&(!Tr(u,d)||f)){const v=Xu(d,a,r,n);if(Zu(d,v),c==="out-in")return r.isLeaving=!0,v.afterLeave=()=>{r.isLeaving=!1,n.update.active!==!1&&n.update()},su(o);c==="in-out"&&u.type!==zt&&(v.delayLeave=(E,b,S)=>{const D=Kg(r,d);D[String(d.key)]=d,E._leaveCb=()=>{b(),E._leaveCb=void 0,delete l.delayedLeave},l.delayedLeave=S})}return o}}},dT=hT;function Kg(t,e){const{leavingVNodes:n}=t;let r=n.get(e.type);return r||(r=Object.create(null),n.set(e.type,r)),r}function Xu(t,e,n,r){const{appear:i,mode:s,persisted:o=!1,onBeforeEnter:a,onEnter:c,onAfterEnter:u,onEnterCancelled:l,onBeforeLeave:h,onLeave:d,onAfterLeave:f,onLeaveCancelled:g,onBeforeAppear:v,onAppear:E,onAfterAppear:b,onAppearCancelled:S}=e,D=String(t.key),V=Kg(n,t),j=(B,Q)=>{B&&Ft(B,r,9,Q)},X=(B,Q)=>{const re=Q[1];j(B,Q),Z(B)?B.every(Te=>Te.length<=1)&&re():B.length<=1&&re()},oe={mode:s,persisted:o,beforeEnter(B){let Q=a;if(!n.isMounted)if(i)Q=v||a;else return;B._leaveCb&&B._leaveCb(!0);const re=V[D];re&&Tr(t,re)&&re.el._leaveCb&&re.el._leaveCb(),j(Q,[B])},enter(B){let Q=c,re=u,Te=l;if(!n.isMounted)if(i)Q=E||c,re=b||u,Te=S||l;else return;let K=!1;const me=B._enterCb=rt=>{K||(K=!0,rt?j(Te,[B]):j(re,[B]),oe.delayedLeave&&oe.delayedLeave(),B._enterCb=void 0)};Q?X(Q,[B,me]):me()},leave(B,Q){const re=String(t.key);if(B._enterCb&&B._enterCb(!0),n.isUnmounting)return Q();j(h,[B]);let Te=!1;const K=B._leaveCb=me=>{Te||(Te=!0,Q(),me?j(g,[B]):j(f,[B]),B._leaveCb=void 0,V[re]===t&&delete V[re])};V[re]=t,d?X(d,[B,K]):K()},clone(B){return Xu(B,e,n,r)}};return oe}function su(t){if(oc(t))return t=Jn(t),t.children=null,t}function If(t){return oc(t)?t.children?t.children[0]:void 0:t}function Zu(t,e){t.shapeFlag&6&&t.component?Zu(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function zg(t,e=!1,n){let r=[],i=0;for(let s=0;s<t.length;s++){let o=t[s];const a=n==null?o.key:String(n)+String(o.key!=null?o.key:s);o.type===Xt?(o.patchFlag&128&&i++,r=r.concat(zg(o.children,e,a))):(e||o.type!==zt)&&r.push(a!=null?Jn(o,{key:a}):o)}if(i>1)for(let s=0;s<r.length;s++)r[s].patchFlag=-2;return r}function wh(t,e){return se(t)?(()=>Ge({name:t.name},e,{setup:t}))():t}const ua=t=>!!t.type.__asyncLoader,oc=t=>t.type.__isKeepAlive;function fT(t,e){Gg(t,"a",e)}function pT(t,e){Gg(t,"da",e)}function Gg(t,e,n=Qe){const r=t.__wdc||(t.__wdc=()=>{let i=n;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(ac(e,r,n),n){let i=n.parent;for(;i&&i.parent;)oc(i.parent.vnode)&&mT(r,e,n,i),i=i.parent}}function mT(t,e,n,r){const i=ac(e,t,r,!0);Qg(()=>{sh(r[e],i)},n)}function ac(t,e,n=Qe,r=!1){if(n){const i=n[t]||(n[t]=[]),s=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;Ki(),Ai(n);const a=Ft(e,n,t,o);return Nr(),zi(),a});return r?i.unshift(s):i.push(s),s}}const Tn=t=>(e,n=Qe)=>(!Ks||t==="sp")&&ac(t,(...r)=>e(...r),n),gT=Tn("bm"),Hg=Tn("m"),_T=Tn("bu"),yT=Tn("u"),Wg=Tn("bum"),Qg=Tn("um"),vT=Tn("sp"),wT=Tn("rtg"),ET=Tn("rtc");function IT(t,e=Qe){ac("ec",t,e)}const Jg="components";function TT(t,e){return AT(Jg,t,!0,e)||t}const bT=Symbol.for("v-ndc");function AT(t,e,n=!0,r=!1){const i=Tt||Qe;if(i){const s=i.type;if(t===Jg){const a=rb(s,!1);if(a&&(a===e||a===ln(e)||a===tc(ln(e))))return s}const o=Tf(i[t]||s[t],e)||Tf(i.appContext[t],e);return!o&&r?s:o}}function Tf(t,e){return t&&(t[e]||t[ln(e)]||t[tc(ln(e))])}function Dk(t,e,n,r){let i;const s=n&&n[r];if(Z(t)||He(t)){i=new Array(t.length);for(let o=0,a=t.length;o<a;o++)i[o]=e(t[o],o,void 0,s&&s[o])}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,s&&s[o])}else if(Ve(t))if(t[Symbol.iterator])i=Array.from(t,(o,a)=>e(o,a,void 0,s&&s[a]));else{const o=Object.keys(t);i=new Array(o.length);for(let a=0,c=o.length;a<c;a++){const u=o[a];i[a]=e(t[u],u,a,s&&s[a])}}else i=[];return n&&(n[r]=i),i}const el=t=>t?l_(t)?lc(t)||t.proxy:el(t.parent):null,Ss=Ge(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>el(t.parent),$root:t=>el(t.root),$emit:t=>t.emit,$options:t=>Eh(t),$forceUpdate:t=>t.f||(t.f=()=>vh(t.update)),$nextTick:t=>t.n||(t.n=yh.bind(t.proxy)),$watch:t=>uT.bind(t)}),ou=(t,e)=>t!==Pe&&!t.__isScriptSetup&&pe(t,e),ST={get({_:t},e){const{ctx:n,setupState:r,data:i,props:s,accessCache:o,type:a,appContext:c}=t;let u;if(e[0]!=="$"){const f=o[e];if(f!==void 0)switch(f){case 1:return r[e];case 2:return i[e];case 4:return n[e];case 3:return s[e]}else{if(ou(r,e))return o[e]=1,r[e];if(i!==Pe&&pe(i,e))return o[e]=2,i[e];if((u=t.propsOptions[0])&&pe(u,e))return o[e]=3,s[e];if(n!==Pe&&pe(n,e))return o[e]=4,n[e];tl&&(o[e]=0)}}const l=Ss[e];let h,d;if(l)return e==="$attrs"&&Rt(t,"get",e),l(t);if((h=a.__cssModules)&&(h=h[e]))return h;if(n!==Pe&&pe(n,e))return o[e]=4,n[e];if(d=c.config.globalProperties,pe(d,e))return d[e]},set({_:t},e,n){const{data:r,setupState:i,ctx:s}=t;return ou(i,e)?(i[e]=n,!0):r!==Pe&&pe(r,e)?(r[e]=n,!0):pe(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(s[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:r,appContext:i,propsOptions:s}},o){let a;return!!n[o]||t!==Pe&&pe(t,o)||ou(e,o)||(a=s[0])&&pe(a,o)||pe(r,o)||pe(Ss,o)||pe(i.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:pe(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function bf(t){return Z(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let tl=!0;function RT(t){const e=Eh(t),n=t.proxy,r=t.ctx;tl=!1,e.beforeCreate&&Af(e.beforeCreate,t,"bc");const{data:i,computed:s,methods:o,watch:a,provide:c,inject:u,created:l,beforeMount:h,mounted:d,beforeUpdate:f,updated:g,activated:v,deactivated:E,beforeDestroy:b,beforeUnmount:S,destroyed:D,unmounted:V,render:j,renderTracked:X,renderTriggered:oe,errorCaptured:B,serverPrefetch:Q,expose:re,inheritAttrs:Te,components:K,directives:me,filters:rt}=e;if(u&&PT(u,r,null),o)for(const be in o){const _e=o[be];se(_e)&&(r[be]=_e.bind(n))}if(i){const be=i.call(n,n);Ve(be)&&(t.data=Yr(be))}if(tl=!0,s)for(const be in s){const _e=s[be],dn=se(_e)?_e.bind(n,n):se(_e.get)?_e.get.bind(n,n):Kt,Pn=!se(_e)&&se(_e.set)?_e.set.bind(n):Kt,Qt=Nt({get:dn,set:Pn});Object.defineProperty(r,be,{enumerable:!0,configurable:!0,get:()=>Qt.value,set:Et=>Qt.value=Et})}if(a)for(const be in a)Yg(a[be],r,n,be);if(c){const be=se(c)?c.call(n):c;Reflect.ownKeys(be).forEach(_e=>{la(_e,be[_e])})}l&&Af(l,t,"c");function le(be,_e){Z(_e)?_e.forEach(dn=>be(dn.bind(n))):_e&&be(_e.bind(n))}if(le(gT,h),le(Hg,d),le(_T,f),le(yT,g),le(fT,v),le(pT,E),le(IT,B),le(ET,X),le(wT,oe),le(Wg,S),le(Qg,V),le(vT,Q),Z(re))if(re.length){const be=t.exposed||(t.exposed={});re.forEach(_e=>{Object.defineProperty(be,_e,{get:()=>n[_e],set:dn=>n[_e]=dn})})}else t.exposed||(t.exposed={});j&&t.render===Kt&&(t.render=j),Te!=null&&(t.inheritAttrs=Te),K&&(t.components=K),me&&(t.directives=me)}function PT(t,e,n=Kt){Z(t)&&(t=nl(t));for(const r in t){const i=t[r];let s;Ve(i)?"default"in i?s=an(i.from||r,i.default,!0):s=an(i.from||r):s=an(i),qe(s)?Object.defineProperty(e,r,{enumerable:!0,configurable:!0,get:()=>s.value,set:o=>s.value=o}):e[r]=s}}function Af(t,e,n){Ft(Z(t)?t.map(r=>r.bind(e.proxy)):t.bind(e.proxy),e,n)}function Yg(t,e,n,r){const i=r.includes(".")?Ug(n,r):()=>n[r];if(He(t)){const s=e[t];se(s)&&As(i,s)}else if(se(t))As(i,t.bind(n));else if(Ve(t))if(Z(t))t.forEach(s=>Yg(s,e,n,r));else{const s=se(t.handler)?t.handler.bind(n):e[t.handler];se(s)&&As(i,s,t)}}function Eh(t){const e=t.type,{mixins:n,extends:r}=e,{mixins:i,optionsCache:s,config:{optionMergeStrategies:o}}=t.appContext,a=s.get(e);let c;return a?c=a:!i.length&&!n&&!r?c=e:(c={},i.length&&i.forEach(u=>Aa(c,u,o,!0)),Aa(c,e,o)),Ve(e)&&s.set(e,c),c}function Aa(t,e,n,r=!1){const{mixins:i,extends:s}=e;s&&Aa(t,s,n,!0),i&&i.forEach(o=>Aa(t,o,n,!0));for(const o in e)if(!(r&&o==="expose")){const a=CT[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const CT={data:Sf,props:Rf,emits:Rf,methods:vs,computed:vs,beforeCreate:yt,created:yt,beforeMount:yt,mounted:yt,beforeUpdate:yt,updated:yt,beforeDestroy:yt,beforeUnmount:yt,destroyed:yt,unmounted:yt,activated:yt,deactivated:yt,errorCaptured:yt,serverPrefetch:yt,components:vs,directives:vs,watch:DT,provide:Sf,inject:xT};function Sf(t,e){return e?t?function(){return Ge(se(t)?t.call(this,this):t,se(e)?e.call(this,this):e)}:e:t}function xT(t,e){return vs(nl(t),nl(e))}function nl(t){if(Z(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function yt(t,e){return t?[...new Set([].concat(t,e))]:e}function vs(t,e){return t?Ge(Object.create(null),t,e):e}function Rf(t,e){return t?Z(t)&&Z(e)?[...new Set([...t,...e])]:Ge(Object.create(null),bf(t),bf(e!=null?e:{})):e}function DT(t,e){if(!t)return e;if(!e)return t;const n=Ge(Object.create(null),t);for(const r in e)n[r]=yt(t[r],e[r]);return n}function Xg(){return{app:null,config:{isNativeTag:ZE,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let VT=0;function kT(t,e){return function(r,i=null){se(r)||(r=Ge({},r)),i!=null&&!Ve(i)&&(i=null);const s=Xg(),o=new Set;let a=!1;const c=s.app={_uid:VT++,_component:r,_props:i,_container:null,_context:s,_instance:null,version:ab,get config(){return s.config},set config(u){},use(u,...l){return o.has(u)||(u&&se(u.install)?(o.add(u),u.install(c,...l)):se(u)&&(o.add(u),u(c,...l))),c},mixin(u){return s.mixins.includes(u)||s.mixins.push(u),c},component(u,l){return l?(s.components[u]=l,c):s.components[u]},directive(u,l){return l?(s.directives[u]=l,c):s.directives[u]},mount(u,l,h){if(!a){const d=xt(r,i);return d.appContext=s,l&&e?e(d,u):t(d,u,h),a=!0,c._container=u,u.__vue_app__=c,lc(d.component)||d.component.proxy}},unmount(){a&&(t(null,c._container),delete c._container.__vue_app__)},provide(u,l){return s.provides[u]=l,c},runWithContext(u){Us=c;try{return u()}finally{Us=null}}};return c}}let Us=null;function la(t,e){if(Qe){let n=Qe.provides;const r=Qe.parent&&Qe.parent.provides;r===n&&(n=Qe.provides=Object.create(r)),n[t]=e}}function an(t,e,n=!1){const r=Qe||Tt;if(r||Us){const i=r?r.parent==null?r.vnode.appContext&&r.vnode.appContext.provides:r.parent.provides:Us._context.provides;if(i&&t in i)return i[t];if(arguments.length>1)return n&&se(e)?e.call(r&&r.proxy):e}}function NT(){return!!(Qe||Tt||Us)}function OT(t,e,n,r=!1){const i={},s={};Ea(s,uc,1),t.propsDefaults=Object.create(null),Zg(t,e,i,s);for(const o in t.propsOptions[0])o in i||(i[o]=void 0);n?t.props=r?i:Pg(i):t.type.props?t.props=i:t.props=s,t.attrs=s}function MT(t,e,n,r){const{props:i,attrs:s,vnode:{patchFlag:o}}=t,a=fe(i),[c]=t.propsOptions;let u=!1;if((r||o>0)&&!(o&16)){if(o&8){const l=t.vnode.dynamicProps;for(let h=0;h<l.length;h++){let d=l[h];if(sc(t.emitsOptions,d))continue;const f=e[d];if(c)if(pe(s,d))f!==s[d]&&(s[d]=f,u=!0);else{const g=ln(d);i[g]=rl(c,a,g,f,t,!1)}else f!==s[d]&&(s[d]=f,u=!0)}}}else{Zg(t,e,i,s)&&(u=!0);let l;for(const h in a)(!e||!pe(e,h)&&((l=ji(h))===h||!pe(e,l)))&&(c?n&&(n[h]!==void 0||n[l]!==void 0)&&(i[h]=rl(c,a,h,void 0,t,!0)):delete i[h]);if(s!==a)for(const h in s)(!e||!pe(e,h)&&!0)&&(delete s[h],u=!0)}u&&vn(t,"set","$attrs")}function Zg(t,e,n,r){const[i,s]=t.propsOptions;let o=!1,a;if(e)for(let c in e){if(ca(c))continue;const u=e[c];let l;i&&pe(i,l=ln(c))?!s||!s.includes(l)?n[l]=u:(a||(a={}))[l]=u:sc(t.emitsOptions,c)||(!(c in r)||u!==r[c])&&(r[c]=u,o=!0)}if(s){const c=fe(n),u=a||Pe;for(let l=0;l<s.length;l++){const h=s[l];n[h]=rl(i,c,h,u[h],t,!pe(u,h))}}return o}function rl(t,e,n,r,i,s){const o=t[n];if(o!=null){const a=pe(o,"default");if(a&&r===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&se(c)){const{propsDefaults:u}=i;n in u?r=u[n]:(Ai(i),r=u[n]=c.call(null,e),Nr())}else r=c}o[0]&&(s&&!a?r=!1:o[1]&&(r===""||r===ji(n))&&(r=!0))}return r}function e_(t,e,n=!1){const r=e.propsCache,i=r.get(t);if(i)return i;const s=t.props,o={},a=[];let c=!1;if(!se(t)){const l=h=>{c=!0;const[d,f]=e_(h,e,!0);Ge(o,d),f&&a.push(...f)};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}if(!s&&!c)return Ve(t)&&r.set(t,gi),gi;if(Z(s))for(let l=0;l<s.length;l++){const h=ln(s[l]);Pf(h)&&(o[h]=Pe)}else if(s)for(const l in s){const h=ln(l);if(Pf(h)){const d=s[l],f=o[h]=Z(d)||se(d)?{type:d}:Ge({},d);if(f){const g=Df(Boolean,f.type),v=Df(String,f.type);f[0]=g>-1,f[1]=v<0||g<v,(g>-1||pe(f,"default"))&&a.push(h)}}}const u=[o,a];return Ve(t)&&r.set(t,u),u}function Pf(t){return t[0]!=="$"}function Cf(t){const e=t&&t.toString().match(/^\s*(function|class) (\w+)/);return e?e[2]:t===null?"null":""}function xf(t,e){return Cf(t)===Cf(e)}function Df(t,e){return Z(e)?e.findIndex(n=>xf(n,t)):se(e)&&xf(e,t)?0:-1}const t_=t=>t[0]==="_"||t==="$stable",Ih=t=>Z(t)?t.map(Zt):[Zt(t)],FT=(t,e,n)=>{if(e._n)return e;const r=nT((...i)=>Ih(e(...i)),n);return r._c=!1,r},n_=(t,e,n)=>{const r=t._ctx;for(const i in t){if(t_(i))continue;const s=t[i];if(se(s))e[i]=FT(i,s,r);else if(s!=null){const o=Ih(s);e[i]=()=>o}}},r_=(t,e)=>{const n=Ih(e);t.slots.default=()=>n},LT=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=fe(e),Ea(e,"_",n)):n_(e,t.slots={})}else t.slots={},e&&r_(t,e);Ea(t.slots,uc,1)},BT=(t,e,n)=>{const{vnode:r,slots:i}=t;let s=!0,o=Pe;if(r.shapeFlag&32){const a=e._;a?n&&a===1?s=!1:(Ge(i,e),!n&&a===1&&delete i._):(s=!e.$stable,n_(e,i)),o=e}else e&&(r_(t,e),o={default:1});if(s)for(const a in i)!t_(a)&&!(a in o)&&delete i[a]};function il(t,e,n,r,i=!1){if(Z(t)){t.forEach((d,f)=>il(d,e&&(Z(e)?e[f]:e),n,r,i));return}if(ua(r)&&!i)return;const s=r.shapeFlag&4?lc(r.component)||r.component.proxy:r.el,o=i?null:s,{i:a,r:c}=t,u=e&&e.r,l=a.refs===Pe?a.refs={}:a.refs,h=a.setupState;if(u!=null&&u!==c&&(He(u)?(l[u]=null,pe(h,u)&&(h[u]=null)):qe(u)&&(u.value=null)),se(c))zn(c,a,12,[o,l]);else{const d=He(c),f=qe(c);if(d||f){const g=()=>{if(t.f){const v=d?pe(h,c)?h[c]:l[c]:c.value;i?Z(v)&&sh(v,s):Z(v)?v.includes(s)||v.push(s):d?(l[c]=[s],pe(h,c)&&(h[c]=l[c])):(c.value=[s],t.k&&(l[t.k]=c.value))}else d?(l[c]=o,pe(h,c)&&(h[c]=o)):f&&(c.value=o,t.k&&(l[t.k]=o))};o?(g.id=-1,It(g,n)):g()}}}const It=cT;function $T(t){return qT(t)}function qT(t,e){const n=Hu();n.__VUE__=!0;const{insert:r,remove:i,patchProp:s,createElement:o,createText:a,createComment:c,setText:u,setElementText:l,parentNode:h,nextSibling:d,setScopeId:f=Kt,insertStaticContent:g}=t,v=(p,m,_,I=null,R=null,C=null,$=!1,k=null,O=!!m.dynamicChildren)=>{if(p===m)return;p&&!Tr(p,m)&&(I=T(p),Et(p,R,C,!0),p=null),m.patchFlag===-2&&(O=!1,m.dynamicChildren=null);const{type:x,ref:J,shapeFlag:z}=m;switch(x){case cc:E(p,m,_,I);break;case zt:b(p,m,_,I);break;case au:p==null&&S(m,_,I,$);break;case Xt:K(p,m,_,I,R,C,$,k,O);break;default:z&1?j(p,m,_,I,R,C,$,k,O):z&6?me(p,m,_,I,R,C,$,k,O):(z&64||z&128)&&x.process(p,m,_,I,R,C,$,k,O,F)}J!=null&&R&&il(J,p&&p.ref,C,m||p,!m)},E=(p,m,_,I)=>{if(p==null)r(m.el=a(m.children),_,I);else{const R=m.el=p.el;m.children!==p.children&&u(R,m.children)}},b=(p,m,_,I)=>{p==null?r(m.el=c(m.children||""),_,I):m.el=p.el},S=(p,m,_,I)=>{[p.el,p.anchor]=g(p.children,m,_,I,p.el,p.anchor)},D=({el:p,anchor:m},_,I)=>{let R;for(;p&&p!==m;)R=d(p),r(p,_,I),p=R;r(m,_,I)},V=({el:p,anchor:m})=>{let _;for(;p&&p!==m;)_=d(p),i(p),p=_;i(m)},j=(p,m,_,I,R,C,$,k,O)=>{$=$||m.type==="svg",p==null?X(m,_,I,R,C,$,k,O):Q(p,m,R,C,$,k,O)},X=(p,m,_,I,R,C,$,k)=>{let O,x;const{type:J,props:z,shapeFlag:Y,transition:ne,dirs:ae}=p;if(O=p.el=o(p.type,C,z&&z.is,z),Y&8?l(O,p.children):Y&16&&B(p.children,O,null,I,R,C&&J!=="foreignObject",$,k),ae&&mr(p,null,I,"created"),oe(O,p,p.scopeId,$,I),z){for(const Ie in z)Ie!=="value"&&!ca(Ie)&&s(O,Ie,null,z[Ie],C,p.children,I,R,ut);"value"in z&&s(O,"value",null,z.value),(x=z.onVnodeBeforeMount)&&Yt(x,I,p)}ae&&mr(p,null,I,"beforeMount");const Ae=(!R||R&&!R.pendingBranch)&&ne&&!ne.persisted;Ae&&ne.beforeEnter(O),r(O,m,_),((x=z&&z.onVnodeMounted)||Ae||ae)&&It(()=>{x&&Yt(x,I,p),Ae&&ne.enter(O),ae&&mr(p,null,I,"mounted")},R)},oe=(p,m,_,I,R)=>{if(_&&f(p,_),I)for(let C=0;C<I.length;C++)f(p,I[C]);if(R){let C=R.subTree;if(m===C){const $=R.vnode;oe(p,$,$.scopeId,$.slotScopeIds,R.parent)}}},B=(p,m,_,I,R,C,$,k,O=0)=>{for(let x=O;x<p.length;x++){const J=p[x]=k?Mn(p[x]):Zt(p[x]);v(null,J,m,_,I,R,C,$,k)}},Q=(p,m,_,I,R,C,$)=>{const k=m.el=p.el;let{patchFlag:O,dynamicChildren:x,dirs:J}=m;O|=p.patchFlag&16;const z=p.props||Pe,Y=m.props||Pe;let ne;_&&gr(_,!1),(ne=Y.onVnodeBeforeUpdate)&&Yt(ne,_,m,p),J&&mr(m,p,_,"beforeUpdate"),_&&gr(_,!0);const ae=R&&m.type!=="foreignObject";if(x?re(p.dynamicChildren,x,k,_,I,ae,C):$||_e(p,m,k,null,_,I,ae,C,!1),O>0){if(O&16)Te(k,m,z,Y,_,I,R);else if(O&2&&z.class!==Y.class&&s(k,"class",null,Y.class,R),O&4&&s(k,"style",z.style,Y.style,R),O&8){const Ae=m.dynamicProps;for(let Ie=0;Ie<Ae.length;Ie++){const Ke=Ae[Ie],Bt=z[Ke],si=Y[Ke];(si!==Bt||Ke==="value")&&s(k,Ke,Bt,si,R,p.children,_,I,ut)}}O&1&&p.children!==m.children&&l(k,m.children)}else!$&&x==null&&Te(k,m,z,Y,_,I,R);((ne=Y.onVnodeUpdated)||J)&&It(()=>{ne&&Yt(ne,_,m,p),J&&mr(m,p,_,"updated")},I)},re=(p,m,_,I,R,C,$)=>{for(let k=0;k<m.length;k++){const O=p[k],x=m[k],J=O.el&&(O.type===Xt||!Tr(O,x)||O.shapeFlag&70)?h(O.el):_;v(O,x,J,null,I,R,C,$,!0)}},Te=(p,m,_,I,R,C,$)=>{if(_!==I){if(_!==Pe)for(const k in _)!ca(k)&&!(k in I)&&s(p,k,_[k],null,$,m.children,R,C,ut);for(const k in I){if(ca(k))continue;const O=I[k],x=_[k];O!==x&&k!=="value"&&s(p,k,x,O,$,m.children,R,C,ut)}"value"in I&&s(p,"value",_.value,I.value)}},K=(p,m,_,I,R,C,$,k,O)=>{const x=m.el=p?p.el:a(""),J=m.anchor=p?p.anchor:a("");let{patchFlag:z,dynamicChildren:Y,slotScopeIds:ne}=m;ne&&(k=k?k.concat(ne):ne),p==null?(r(x,_,I),r(J,_,I),B(m.children,_,J,R,C,$,k,O)):z>0&&z&64&&Y&&p.dynamicChildren?(re(p.dynamicChildren,Y,_,R,C,$,k),(m.key!=null||R&&m===R.subTree)&&i_(p,m,!0)):_e(p,m,_,J,R,C,$,k,O)},me=(p,m,_,I,R,C,$,k,O)=>{m.slotScopeIds=k,p==null?m.shapeFlag&512?R.ctx.activate(m,_,I,$,O):rt(m,_,I,R,C,$,O):_t(p,m,O)},rt=(p,m,_,I,R,C,$)=>{const k=p.component=YT(p,I,R);if(oc(p)&&(k.ctx.renderer=F),ZT(k),k.asyncDep){if(R&&R.registerDep(k,le),!p.el){const O=k.subTree=xt(zt);b(null,O,m,_)}return}le(k,p,m,_,R,C,$)},_t=(p,m,_)=>{const I=m.component=p.component;if(sT(p,m,_))if(I.asyncDep&&!I.asyncResolved){be(I,m,_);return}else I.next=m,XI(I.update),I.update();else m.el=p.el,I.vnode=m},le=(p,m,_,I,R,C,$)=>{const k=()=>{if(p.isMounted){let{next:J,bu:z,u:Y,parent:ne,vnode:ae}=p,Ae=J,Ie;gr(p,!1),J?(J.el=ae.el,be(p,J,$)):J=ae,z&&ru(z),(Ie=J.props&&J.props.onVnodeBeforeUpdate)&&Yt(Ie,ne,J,ae),gr(p,!0);const Ke=iu(p),Bt=p.subTree;p.subTree=Ke,v(Bt,Ke,h(Bt.el),T(Bt),p,R,C),J.el=Ke.el,Ae===null&&oT(p,Ke.el),Y&&It(Y,R),(Ie=J.props&&J.props.onVnodeUpdated)&&It(()=>Yt(Ie,ne,J,ae),R)}else{let J;const{el:z,props:Y}=m,{bm:ne,m:ae,parent:Ae}=p,Ie=ua(m);if(gr(p,!1),ne&&ru(ne),!Ie&&(J=Y&&Y.onVnodeBeforeMount)&&Yt(J,Ae,m),gr(p,!0),z&&ye){const Ke=()=>{p.subTree=iu(p),ye(z,p.subTree,p,R,null)};Ie?m.type.__asyncLoader().then(()=>!p.isUnmounted&&Ke()):Ke()}else{const Ke=p.subTree=iu(p);v(null,Ke,_,I,p,R,C),m.el=Ke.el}if(ae&&It(ae,R),!Ie&&(J=Y&&Y.onVnodeMounted)){const Ke=m;It(()=>Yt(J,Ae,Ke),R)}(m.shapeFlag&256||Ae&&ua(Ae.vnode)&&Ae.vnode.shapeFlag&256)&&p.a&&It(p.a,R),p.isMounted=!0,m=_=I=null}},O=p.effect=new hh(k,()=>vh(x),p.scope),x=p.update=()=>O.run();x.id=p.uid,gr(p,!0),x()},be=(p,m,_)=>{m.component=p;const I=p.vnode.props;p.vnode=m,p.next=null,MT(p,m.props,I,_),BT(p,m.children,_),Ki(),wf(),zi()},_e=(p,m,_,I,R,C,$,k,O=!1)=>{const x=p&&p.children,J=p?p.shapeFlag:0,z=m.children,{patchFlag:Y,shapeFlag:ne}=m;if(Y>0){if(Y&128){Pn(x,z,_,I,R,C,$,k,O);return}else if(Y&256){dn(x,z,_,I,R,C,$,k,O);return}}ne&8?(J&16&&ut(x,R,C),z!==x&&l(_,z)):J&16?ne&16?Pn(x,z,_,I,R,C,$,k,O):ut(x,R,C,!0):(J&8&&l(_,""),ne&16&&B(z,_,I,R,C,$,k,O))},dn=(p,m,_,I,R,C,$,k,O)=>{p=p||gi,m=m||gi;const x=p.length,J=m.length,z=Math.min(x,J);let Y;for(Y=0;Y<z;Y++){const ne=m[Y]=O?Mn(m[Y]):Zt(m[Y]);v(p[Y],ne,_,null,R,C,$,k,O)}x>J?ut(p,R,C,!0,!1,z):B(m,_,I,R,C,$,k,O,z)},Pn=(p,m,_,I,R,C,$,k,O)=>{let x=0;const J=m.length;let z=p.length-1,Y=J-1;for(;x<=z&&x<=Y;){const ne=p[x],ae=m[x]=O?Mn(m[x]):Zt(m[x]);if(Tr(ne,ae))v(ne,ae,_,null,R,C,$,k,O);else break;x++}for(;x<=z&&x<=Y;){const ne=p[z],ae=m[Y]=O?Mn(m[Y]):Zt(m[Y]);if(Tr(ne,ae))v(ne,ae,_,null,R,C,$,k,O);else break;z--,Y--}if(x>z){if(x<=Y){const ne=Y+1,ae=ne<J?m[ne].el:I;for(;x<=Y;)v(null,m[x]=O?Mn(m[x]):Zt(m[x]),_,ae,R,C,$,k,O),x++}}else if(x>Y)for(;x<=z;)Et(p[x],R,C,!0),x++;else{const ne=x,ae=x,Ae=new Map;for(x=ae;x<=Y;x++){const Pt=m[x]=O?Mn(m[x]):Zt(m[x]);Pt.key!=null&&Ae.set(Pt.key,x)}let Ie,Ke=0;const Bt=Y-ae+1;let si=!1,cf=0;const as=new Array(Bt);for(x=0;x<Bt;x++)as[x]=0;for(x=ne;x<=z;x++){const Pt=p[x];if(Ke>=Bt){Et(Pt,R,C,!0);continue}let Jt;if(Pt.key!=null)Jt=Ae.get(Pt.key);else for(Ie=ae;Ie<=Y;Ie++)if(as[Ie-ae]===0&&Tr(Pt,m[Ie])){Jt=Ie;break}Jt===void 0?Et(Pt,R,C,!0):(as[Jt-ae]=x+1,Jt>=cf?cf=Jt:si=!0,v(Pt,m[Jt],_,null,R,C,$,k,O),Ke++)}const uf=si?UT(as):gi;for(Ie=uf.length-1,x=Bt-1;x>=0;x--){const Pt=ae+x,Jt=m[Pt],lf=Pt+1<J?m[Pt+1].el:I;as[x]===0?v(null,Jt,_,lf,R,C,$,k,O):si&&(Ie<0||x!==uf[Ie]?Qt(Jt,_,lf,2):Ie--)}}},Qt=(p,m,_,I,R=null)=>{const{el:C,type:$,transition:k,children:O,shapeFlag:x}=p;if(x&6){Qt(p.component.subTree,m,_,I);return}if(x&128){p.suspense.move(m,_,I);return}if(x&64){$.move(p,m,_,F);return}if($===Xt){r(C,m,_);for(let z=0;z<O.length;z++)Qt(O[z],m,_,I);r(p.anchor,m,_);return}if($===au){D(p,m,_);return}if(I!==2&&x&1&&k)if(I===0)k.beforeEnter(C),r(C,m,_),It(()=>k.enter(C),R);else{const{leave:z,delayLeave:Y,afterLeave:ne}=k,ae=()=>r(C,m,_),Ae=()=>{z(C,()=>{ae(),ne&&ne()})};Y?Y(C,ae,Ae):Ae()}else r(C,m,_)},Et=(p,m,_,I=!1,R=!1)=>{const{type:C,props:$,ref:k,children:O,dynamicChildren:x,shapeFlag:J,patchFlag:z,dirs:Y}=p;if(k!=null&&il(k,null,_,p,!0),J&256){m.ctx.deactivate(p);return}const ne=J&1&&Y,ae=!ua(p);let Ae;if(ae&&(Ae=$&&$.onVnodeBeforeUnmount)&&Yt(Ae,m,p),J&6)jo(p.component,_,I);else{if(J&128){p.suspense.unmount(_,I);return}ne&&mr(p,null,m,"beforeUnmount"),J&64?p.type.remove(p,m,_,R,F,I):x&&(C!==Xt||z>0&&z&64)?ut(x,m,_,!1,!0):(C===Xt&&z&384||!R&&J&16)&&ut(O,m,_),I&&ri(p)}(ae&&(Ae=$&&$.onVnodeUnmounted)||ne)&&It(()=>{Ae&&Yt(Ae,m,p),ne&&mr(p,null,m,"unmounted")},_)},ri=p=>{const{type:m,el:_,anchor:I,transition:R}=p;if(m===Xt){ii(_,I);return}if(m===au){V(p);return}const C=()=>{i(_),R&&!R.persisted&&R.afterLeave&&R.afterLeave()};if(p.shapeFlag&1&&R&&!R.persisted){const{leave:$,delayLeave:k}=R,O=()=>$(_,C);k?k(p.el,C,O):O()}else C()},ii=(p,m)=>{let _;for(;p!==m;)_=d(p),i(p),p=_;i(m)},jo=(p,m,_)=>{const{bum:I,scope:R,update:C,subTree:$,um:k}=p;I&&ru(I),R.stop(),C&&(C.active=!1,Et($,p,m,_)),k&&It(k,m),It(()=>{p.isUnmounted=!0},m),m&&m.pendingBranch&&!m.isUnmounted&&p.asyncDep&&!p.asyncResolved&&p.suspenseId===m.pendingId&&(m.deps--,m.deps===0&&m.resolve())},ut=(p,m,_,I=!1,R=!1,C=0)=>{for(let $=C;$<p.length;$++)Et(p[$],m,_,I,R)},T=p=>p.shapeFlag&6?T(p.component.subTree):p.shapeFlag&128?p.suspense.next():d(p.anchor||p.el),U=(p,m,_)=>{p==null?m._vnode&&Et(m._vnode,null,null,!0):v(m._vnode||null,p,m,null,null,null,_),wf(),Fg(),m._vnode=p},F={p:v,um:Et,m:Qt,r:ri,mt:rt,mc:B,pc:_e,pbc:re,n:T,o:t};let W,ye;return e&&([W,ye]=e(F)),{render:U,hydrate:W,createApp:kT(U,W)}}function gr({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function i_(t,e,n=!1){const r=t.children,i=e.children;if(Z(r)&&Z(i))for(let s=0;s<r.length;s++){const o=r[s];let a=i[s];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[s]=Mn(i[s]),a.el=o.el),n||i_(o,a)),a.type===cc&&(a.el=o.el)}}function UT(t){const e=t.slice(),n=[0];let r,i,s,o,a;const c=t.length;for(r=0;r<c;r++){const u=t[r];if(u!==0){if(i=n[n.length-1],t[i]<u){e[r]=i,n.push(r);continue}for(s=0,o=n.length-1;s<o;)a=s+o>>1,t[n[a]]<u?s=a+1:o=a;u<t[n[s]]&&(s>0&&(e[r]=n[s-1]),n[s]=r)}}for(s=n.length,o=n[s-1];s-- >0;)n[s]=o,o=e[o];return n}const jT=t=>t.__isTeleport,Xt=Symbol.for("v-fgt"),cc=Symbol.for("v-txt"),zt=Symbol.for("v-cmt"),au=Symbol.for("v-stc"),Rs=[];let Ut=null;function s_(t=!1){Rs.push(Ut=t?null:[])}function KT(){Rs.pop(),Ut=Rs[Rs.length-1]||null}let js=1;function Vf(t){js+=t}function o_(t){return t.dynamicChildren=js>0?Ut||gi:null,KT(),js>0&&Ut&&Ut.push(t),t}function Vk(t,e,n,r,i,s){return o_(u_(t,e,n,r,i,s,!0))}function a_(t,e,n,r,i){return o_(xt(t,e,n,r,i,!0))}function sl(t){return t?t.__v_isVNode===!0:!1}function Tr(t,e){return t.type===e.type&&t.key===e.key}const uc="__vInternal",c_=({key:t})=>t!=null?t:null,ha=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?He(t)||qe(t)||se(t)?{i:Tt,r:t,k:e,f:!!n}:t:null);function u_(t,e=null,n=null,r=0,i=null,s=t===Xt?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&c_(e),ref:e&&ha(e),scopeId:$g,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:r,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:Tt};return a?(Th(c,n),s&128&&t.normalize(c)):n&&(c.shapeFlag|=He(n)?8:16),js>0&&!o&&Ut&&(c.patchFlag>0||s&6)&&c.patchFlag!==32&&Ut.push(c),c}const xt=zT;function zT(t,e=null,n=null,r=0,i=null,s=!1){if((!t||t===bT)&&(t=zt),sl(t)){const a=Jn(t,e,!0);return n&&Th(a,n),js>0&&!s&&Ut&&(a.shapeFlag&6?Ut[Ut.indexOf(t)]=a:Ut.push(a)),a.patchFlag|=-2,a}if(ib(t)&&(t=t.__vccOpts),e){e=GT(e);let{class:a,style:c}=e;a&&!He(a)&&(e.class=uh(a)),Ve(c)&&(xg(c)&&!Z(c)&&(c=Ge({},c)),e.style=ch(c))}const o=He(t)?1:aT(t)?128:jT(t)?64:Ve(t)?4:se(t)?2:0;return u_(t,e,n,r,i,o,s,!0)}function GT(t){return t?xg(t)||uc in t?Ge({},t):t:null}function Jn(t,e,n=!1){const{props:r,ref:i,patchFlag:s,children:o}=t,a=e?WT(r||{},e):r;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&c_(a),ref:e&&e.ref?n&&i?Z(i)?i.concat(ha(e)):[i,ha(e)]:ha(e):i,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Xt?s===-1?16:s|16:s,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&Jn(t.ssContent),ssFallback:t.ssFallback&&Jn(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce}}function HT(t=" ",e=0){return xt(cc,null,t,e)}function kk(t="",e=!1){return e?(s_(),a_(zt,null,t)):xt(zt,null,t)}function Zt(t){return t==null||typeof t=="boolean"?xt(zt):Z(t)?xt(Xt,null,t.slice()):typeof t=="object"?Mn(t):xt(cc,null,String(t))}function Mn(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:Jn(t)}function Th(t,e){let n=0;const{shapeFlag:r}=t;if(e==null)e=null;else if(Z(e))n=16;else if(typeof e=="object")if(r&65){const i=e.default;i&&(i._c&&(i._d=!1),Th(t,i()),i._c&&(i._d=!0));return}else{n=32;const i=e._;!i&&!(uc in e)?e._ctx=Tt:i===3&&Tt&&(Tt.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else se(e)?(e={default:e,_ctx:Tt},n=32):(e=String(e),r&64?(n=16,e=[HT(e)]):n=8);t.children=e,t.shapeFlag|=n}function WT(...t){const e={};for(let n=0;n<t.length;n++){const r=t[n];for(const i in r)if(i==="class")e.class!==r.class&&(e.class=uh([e.class,r.class]));else if(i==="style")e.style=ch([e.style,r.style]);else if(Xa(i)){const s=e[i],o=r[i];o&&s!==o&&!(Z(s)&&s.includes(o))&&(e[i]=s?[].concat(s,o):o)}else i!==""&&(e[i]=r[i])}return e}function Yt(t,e,n,r=null){Ft(t,e,7,[n,r])}const QT=Xg();let JT=0;function YT(t,e,n){const r=t.type,i=(e?e.appContext:t.appContext)||QT,s={uid:JT++,vnode:t,type:r,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,scope:new mg(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:e_(r,i),emitsOptions:Bg(r,i),emit:null,emitted:null,propsDefaults:Pe,inheritAttrs:r.inheritAttrs,ctx:Pe,data:Pe,props:Pe,attrs:Pe,slots:Pe,refs:Pe,setupState:Pe,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=e?e.root:s,s.emit=tT.bind(null,s),t.ce&&t.ce(s),s}let Qe=null;const XT=()=>Qe||Tt;let bh,oi,kf="__VUE_INSTANCE_SETTERS__";(oi=Hu()[kf])||(oi=Hu()[kf]=[]),oi.push(t=>Qe=t),bh=t=>{oi.length>1?oi.forEach(e=>e(t)):oi[0](t)};const Ai=t=>{bh(t),t.scope.on()},Nr=()=>{Qe&&Qe.scope.off(),bh(null)};function l_(t){return t.vnode.shapeFlag&4}let Ks=!1;function ZT(t,e=!1){Ks=e;const{props:n,children:r}=t.vnode,i=l_(t);OT(t,n,i,e),LT(t,r);const s=i?eb(t,e):void 0;return Ks=!1,s}function eb(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=vo(new Proxy(t.ctx,ST));const{setup:r}=n;if(r){const i=t.setupContext=r.length>1?nb(t):null;Ai(t),Ki();const s=zn(r,t,0,[t.props,i]);if(zi(),Nr(),lg(s)){if(s.then(Nr,Nr),e)return s.then(o=>{Nf(t,o,e)}).catch(o=>{ic(o,t,0)});t.asyncDep=s}else Nf(t,s,e)}else h_(t,e)}function Nf(t,e,n){se(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Ve(e)&&(t.setupState=Ng(e)),h_(t,n)}let Of;function h_(t,e,n){const r=t.type;if(!t.render){if(!e&&Of&&!r.render){const i=r.template||Eh(t).template;if(i){const{isCustomElement:s,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:c}=r,u=Ge(Ge({isCustomElement:s,delimiters:a},o),c);r.render=Of(i,u)}}t.render=r.render||Kt}Ai(t),Ki(),RT(t),zi(),Nr()}function tb(t){return t.attrsProxy||(t.attrsProxy=new Proxy(t.attrs,{get(e,n){return Rt(t,"get","$attrs"),e[n]}}))}function nb(t){const e=n=>{t.exposed=n||{}};return{get attrs(){return tb(t)},slots:t.slots,emit:t.emit,expose:e}}function lc(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(Ng(vo(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in Ss)return Ss[n](t)},has(e,n){return n in e||n in Ss}}))}function rb(t,e=!0){return se(t)?t.displayName||t.name:t.name||e&&t.__name}function ib(t){return se(t)&&"__vccOpts"in t}const Nt=(t,e)=>QI(t,e,Ks);function Ah(t,e,n){const r=arguments.length;return r===2?Ve(e)&&!Z(e)?sl(e)?xt(t,null,[e]):xt(t,e):xt(t,null,e):(r>3?n=Array.prototype.slice.call(arguments,2):r===3&&sl(n)&&(n=[n]),xt(t,e,n))}const sb=Symbol.for("v-scx"),ob=()=>an(sb),ab="3.3.4",cb="http://www.w3.org/2000/svg",br=typeof document!="undefined"?document:null,Mf=br&&br.createElement("template"),ub={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,r)=>{const i=e?br.createElementNS(cb,t):br.createElement(t,n?{is:n}:void 0);return t==="select"&&r&&r.multiple!=null&&i.setAttribute("multiple",r.multiple),i},createText:t=>br.createTextNode(t),createComment:t=>br.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>br.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,r,i,s){const o=n?n.previousSibling:e.lastChild;if(i&&(i===s||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),n),!(i===s||!(i=i.nextSibling)););else{Mf.innerHTML=r?`<svg>${t}</svg>`:t;const a=Mf.content;if(r){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function lb(t,e,n){const r=t._vtc;r&&(e=(e?[e,...r]:[...r]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function hb(t,e,n){const r=t.style,i=He(n);if(n&&!i){if(e&&!He(e))for(const s in e)n[s]==null&&ol(r,s,"");for(const s in n)ol(r,s,n[s])}else{const s=r.display;i?e!==n&&(r.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(r.display=s)}}const Ff=/\s*!important$/;function ol(t,e,n){if(Z(n))n.forEach(r=>ol(t,e,r));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const r=db(t,e);Ff.test(n)?t.setProperty(ji(r),n.replace(Ff,""),"important"):t[r]=n}}const Lf=["Webkit","Moz","ms"],cu={};function db(t,e){const n=cu[e];if(n)return n;let r=ln(e);if(r!=="filter"&&r in t)return cu[e]=r;r=tc(r);for(let i=0;i<Lf.length;i++){const s=Lf[i]+r;if(s in t)return cu[e]=s}return e}const Bf="http://www.w3.org/1999/xlink";function fb(t,e,n,r,i){if(r&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(Bf,e.slice(6,e.length)):t.setAttributeNS(Bf,e,n);else{const s=dI(e);n==null||s&&!fg(n)?t.removeAttribute(e):t.setAttribute(e,s?"":n)}}function pb(t,e,n,r,i,s,o){if(e==="innerHTML"||e==="textContent"){r&&o(r,i,s),t[e]=n==null?"":n;return}const a=t.tagName;if(e==="value"&&a!=="PROGRESS"&&!a.includes("-")){t._value=n;const u=a==="OPTION"?t.getAttribute("value"):t.value,l=n==null?"":n;u!==l&&(t.value=l),n==null&&t.removeAttribute(e);return}let c=!1;if(n===""||n==null){const u=typeof t[e];u==="boolean"?n=fg(n):n==null&&u==="string"?(n="",c=!0):u==="number"&&(n=0,c=!0)}try{t[e]=n}catch{}c&&t.removeAttribute(e)}function mb(t,e,n,r){t.addEventListener(e,n,r)}function gb(t,e,n,r){t.removeEventListener(e,n,r)}function _b(t,e,n,r,i=null){const s=t._vei||(t._vei={}),o=s[e];if(r&&o)o.value=r;else{const[a,c]=yb(e);if(r){const u=s[e]=Eb(r,i);mb(t,a,u,c)}else o&&(gb(t,a,o,c),s[e]=void 0)}}const $f=/(?:Once|Passive|Capture)$/;function yb(t){let e;if($f.test(t)){e={};let r;for(;r=t.match($f);)t=t.slice(0,t.length-r[0].length),e[r[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):ji(t.slice(2)),e]}let uu=0;const vb=Promise.resolve(),wb=()=>uu||(vb.then(()=>uu=0),uu=Date.now());function Eb(t,e){const n=r=>{if(!r._vts)r._vts=Date.now();else if(r._vts<=n.attached)return;Ft(Ib(r,n.value),e,5,[r])};return n.value=t,n.attached=wb(),n}function Ib(t,e){if(Z(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(r=>i=>!i._stopped&&r&&r(i))}else return e}const qf=/^on[a-z]/,Tb=(t,e,n,r,i=!1,s,o,a,c)=>{e==="class"?lb(t,r,i):e==="style"?hb(t,n,r):Xa(e)?ih(e)||_b(t,e,n,r,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):bb(t,e,r,i))?pb(t,e,r,s,o,a,c):(e==="true-value"?t._trueValue=r:e==="false-value"&&(t._falseValue=r),fb(t,e,r,i))};function bb(t,e,n,r){return r?!!(e==="innerHTML"||e==="textContent"||e in t&&qf.test(e)&&se(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||qf.test(e)&&He(n)?!1:e in t}const xn="transition",cs="animation",d_=(t,{slots:e})=>Ah(dT,Ab(t),e);d_.displayName="Transition";const f_={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};d_.props=Ge({},jg,f_);const _r=(t,e=[])=>{Z(t)?t.forEach(n=>n(...e)):t&&t(...e)},Uf=t=>t?Z(t)?t.some(e=>e.length>1):t.length>1:!1;function Ab(t){const e={};for(const K in t)K in f_||(e[K]=t[K]);if(t.css===!1)return e;const{name:n="v",type:r,duration:i,enterFromClass:s=`${n}-enter-from`,enterActiveClass:o=`${n}-enter-active`,enterToClass:a=`${n}-enter-to`,appearFromClass:c=s,appearActiveClass:u=o,appearToClass:l=a,leaveFromClass:h=`${n}-leave-from`,leaveActiveClass:d=`${n}-leave-active`,leaveToClass:f=`${n}-leave-to`}=t,g=Sb(i),v=g&&g[0],E=g&&g[1],{onBeforeEnter:b,onEnter:S,onEnterCancelled:D,onLeave:V,onLeaveCancelled:j,onBeforeAppear:X=b,onAppear:oe=S,onAppearCancelled:B=D}=e,Q=(K,me,rt)=>{yr(K,me?l:a),yr(K,me?u:o),rt&&rt()},re=(K,me)=>{K._isLeaving=!1,yr(K,h),yr(K,f),yr(K,d),me&&me()},Te=K=>(me,rt)=>{const _t=K?oe:S,le=()=>Q(me,K,rt);_r(_t,[me,le]),jf(()=>{yr(me,K?c:s),Dn(me,K?l:a),Uf(_t)||Kf(me,r,v,le)})};return Ge(e,{onBeforeEnter(K){_r(b,[K]),Dn(K,s),Dn(K,o)},onBeforeAppear(K){_r(X,[K]),Dn(K,c),Dn(K,u)},onEnter:Te(!1),onAppear:Te(!0),onLeave(K,me){K._isLeaving=!0;const rt=()=>re(K,me);Dn(K,h),Cb(),Dn(K,d),jf(()=>{!K._isLeaving||(yr(K,h),Dn(K,f),Uf(V)||Kf(K,r,E,rt))}),_r(V,[K,rt])},onEnterCancelled(K){Q(K,!1),_r(D,[K])},onAppearCancelled(K){Q(K,!0),_r(B,[K])},onLeaveCancelled(K){re(K),_r(j,[K])}})}function Sb(t){if(t==null)return null;if(Ve(t))return[lu(t.enter),lu(t.leave)];{const e=lu(t);return[e,e]}}function lu(t){return oI(t)}function Dn(t,e){e.split(/\s+/).forEach(n=>n&&t.classList.add(n)),(t._vtc||(t._vtc=new Set)).add(e)}function yr(t,e){e.split(/\s+/).forEach(r=>r&&t.classList.remove(r));const{_vtc:n}=t;n&&(n.delete(e),n.size||(t._vtc=void 0))}function jf(t){requestAnimationFrame(()=>{requestAnimationFrame(t)})}let Rb=0;function Kf(t,e,n,r){const i=t._endId=++Rb,s=()=>{i===t._endId&&r()};if(n)return setTimeout(s,n);const{type:o,timeout:a,propCount:c}=Pb(t,e);if(!o)return r();const u=o+"end";let l=0;const h=()=>{t.removeEventListener(u,d),s()},d=f=>{f.target===t&&++l>=c&&h()};setTimeout(()=>{l<c&&h()},a+1),t.addEventListener(u,d)}function Pb(t,e){const n=window.getComputedStyle(t),r=g=>(n[g]||"").split(", "),i=r(`${xn}Delay`),s=r(`${xn}Duration`),o=zf(i,s),a=r(`${cs}Delay`),c=r(`${cs}Duration`),u=zf(a,c);let l=null,h=0,d=0;e===xn?o>0&&(l=xn,h=o,d=s.length):e===cs?u>0&&(l=cs,h=u,d=c.length):(h=Math.max(o,u),l=h>0?o>u?xn:cs:null,d=l?l===xn?s.length:c.length:0);const f=l===xn&&/\b(transform|all)(,|$)/.test(r(`${xn}Property`).toString());return{type:l,timeout:h,propCount:d,hasTransform:f}}function zf(t,e){for(;t.length<e.length;)t=t.concat(t);return Math.max(...e.map((n,r)=>Gf(n)+Gf(t[r])))}function Gf(t){return Number(t.slice(0,-1).replace(",","."))*1e3}function Cb(){return document.body.offsetHeight}const xb=Ge({patchProp:Tb},ub);let Hf;function Db(){return Hf||(Hf=$T(xb))}const Vb=(...t)=>{const e=Db().createApp(...t),{mount:n}=e;return e.mount=r=>{const i=kb(r);if(!i)return;const s=e._component;!se(s)&&!s.render&&!s.template&&(s.template=i.innerHTML),i.innerHTML="";const o=n(i,!1,i instanceof SVGElement);return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},e};function kb(t){return He(t)?document.querySelector(t):t}function Sh(t,e,n,r){return Object.defineProperty(t,e,{get:n,set:r,enumerable:!0}),t}const Fr=rc(!1);let hc;function Nb(t,e){const n=/(edg|edge|edga|edgios)\/([\w.]+)/.exec(t)||/(opr)[\/]([\w.]+)/.exec(t)||/(vivaldi)[\/]([\w.]+)/.exec(t)||/(chrome|crios)[\/]([\w.]+)/.exec(t)||/(version)(applewebkit)[\/]([\w.]+).*(safari)[\/]([\w.]+)/.exec(t)||/(webkit)[\/]([\w.]+).*(version)[\/]([\w.]+).*(safari)[\/]([\w.]+)/.exec(t)||/(firefox|fxios)[\/]([\w.]+)/.exec(t)||/(webkit)[\/]([\w.]+)/.exec(t)||/(opera)(?:.*version|)[\/]([\w.]+)/.exec(t)||[];return{browser:n[5]||n[3]||n[1]||"",version:n[2]||n[4]||"0",versionNumber:n[4]||n[2]||"0",platform:e[0]||""}}function Ob(t){return/(ipad)/.exec(t)||/(ipod)/.exec(t)||/(windows phone)/.exec(t)||/(iphone)/.exec(t)||/(kindle)/.exec(t)||/(silk)/.exec(t)||/(android)/.exec(t)||/(win)/.exec(t)||/(mac)/.exec(t)||/(linux)/.exec(t)||/(cros)/.exec(t)||/(playbook)/.exec(t)||/(bb)/.exec(t)||/(blackberry)/.exec(t)||[]}const p_="ontouchstart"in window||window.navigator.maxTouchPoints>0;function Mb(t){hc={is:{...t}},delete t.mac,delete t.desktop;const e=Math.min(window.innerHeight,window.innerWidth)>414?"ipad":"iphone";Object.assign(t,{mobile:!0,ios:!0,platform:e,[e]:!0})}function Fb(t){const e=t.toLowerCase(),n=Ob(e),r=Nb(e,n),i={};r.browser&&(i[r.browser]=!0,i.version=r.version,i.versionNumber=parseInt(r.versionNumber,10)),r.platform&&(i[r.platform]=!0);const s=i.android||i.ios||i.bb||i.blackberry||i.ipad||i.iphone||i.ipod||i.kindle||i.playbook||i.silk||i["windows phone"];return s===!0||e.indexOf("mobile")>-1?(i.mobile=!0,i.edga||i.edgios?(i.edge=!0,r.browser="edge"):i.crios?(i.chrome=!0,r.browser="chrome"):i.fxios&&(i.firefox=!0,r.browser="firefox")):i.desktop=!0,(i.ipod||i.ipad||i.iphone)&&(i.ios=!0),i["windows phone"]&&(i.winphone=!0,delete i["windows phone"]),(i.chrome||i.opr||i.safari||i.vivaldi||i.mobile===!0&&i.ios!==!0&&s!==!0)&&(i.webkit=!0),i.edg&&(r.browser="edgechromium",i.edgeChromium=!0),(i.safari&&i.blackberry||i.bb)&&(r.browser="blackberry",i.blackberry=!0),i.safari&&i.playbook&&(r.browser="playbook",i.playbook=!0),i.opr&&(r.browser="opera",i.opera=!0),i.safari&&i.android&&(r.browser="android",i.android=!0),i.safari&&i.kindle&&(r.browser="kindle",i.kindle=!0),i.safari&&i.silk&&(r.browser="silk",i.silk=!0),i.vivaldi&&(r.browser="vivaldi",i.vivaldi=!0),i.name=r.browser,i.platform=r.platform,e.indexOf("electron")>-1?i.electron=!0:document.location.href.indexOf("-extension://")>-1?i.bex=!0:(window.Capacitor!==void 0?(i.capacitor=!0,i.nativeMobile=!0,i.nativeMobileWrapper="capacitor"):(window._cordovaNative!==void 0||window.cordova!==void 0)&&(i.cordova=!0,i.nativeMobile=!0,i.nativeMobileWrapper="cordova"),p_===!0&&i.mac===!0&&(i.desktop===!0&&i.safari===!0||i.nativeMobile===!0&&i.android!==!0&&i.ios!==!0&&i.ipad!==!0)&&Mb(i)),i}const Wf=navigator.userAgent||navigator.vendor||window.opera,Lb={has:{touch:!1,webStorage:!1},within:{iframe:!1}},Mt={userAgent:Wf,is:Fb(Wf),has:{touch:p_},within:{iframe:window.self!==window.top}},al={install(t){const{$q:e}=t;Fr.value===!0?(t.onSSRHydrated.push(()=>{Object.assign(e.platform,Mt),Fr.value=!1,hc=void 0}),e.platform=Yr(this)):e.platform=this}};{let t;Sh(Mt.has,"webStorage",()=>{if(t!==void 0)return t;try{if(window.localStorage)return t=!0,!0}catch{}return t=!1,!1}),Mt.is.ios===!0&&window.navigator.vendor.toLowerCase().indexOf("apple"),Fr.value===!0?Object.assign(al,Mt,hc,Lb):Object.assign(al,Mt)}var dc=(t,e)=>{const n=Yr(t);for(const r in t)Sh(e,r,()=>n[r],i=>{n[r]=i});return e};const Si={hasPassive:!1,passiveCapture:!0,notPassiveCapture:!0};try{const t=Object.defineProperty({},"passive",{get(){Object.assign(Si,{hasPassive:!0,passive:{passive:!0},notPassive:{passive:!1},passiveCapture:{passive:!0,capture:!0},notPassiveCapture:{passive:!1,capture:!0}})}});window.addEventListener("qtest",null,t),window.removeEventListener("qtest",null,t)}catch{}function zs(){}function Nk(t){return t.button===0}function Ok(t){return t.touches&&t.touches[0]?t=t.touches[0]:t.changedTouches&&t.changedTouches[0]?t=t.changedTouches[0]:t.targetTouches&&t.targetTouches[0]&&(t=t.targetTouches[0]),{top:t.clientY,left:t.clientX}}function Mk(t){if(t.path)return t.path;if(t.composedPath)return t.composedPath();const e=[];let n=t.target;for(;n;){if(e.push(n),n.tagName==="HTML")return e.push(document),e.push(window),e;n=n.parentElement}}function Fk(t){t.stopPropagation()}function Qf(t){t.cancelable!==!1&&t.preventDefault()}function Lk(t){t.cancelable!==!1&&t.preventDefault(),t.stopPropagation()}function Bk(t,e){if(t===void 0||e===!0&&t.__dragPrevented===!0)return;const n=e===!0?r=>{r.__dragPrevented=!0,r.addEventListener("dragstart",Qf,Si.notPassiveCapture)}:r=>{delete r.__dragPrevented,r.removeEventListener("dragstart",Qf,Si.notPassiveCapture)};t.querySelectorAll("a, img").forEach(n)}function $k(t,e,n){const r=`__q_${e}_evt`;t[r]=t[r]!==void 0?t[r].concat(n):n,n.forEach(i=>{i[0].addEventListener(i[1],t[i[2]],Si[i[3]])})}function qk(t,e){const n=`__q_${e}_evt`;t[n]!==void 0&&(t[n].forEach(r=>{r[0].removeEventListener(r[1],t[r[2]],Si[r[3]])}),t[n]=void 0)}function Bb(t,e=250,n){let r=null;function i(){const s=arguments,o=()=>{r=null,n!==!0&&t.apply(this,s)};r!==null?clearTimeout(r):n===!0&&t.apply(this,s),r=setTimeout(o,e)}return i.cancel=()=>{r!==null&&clearTimeout(r)},i}const hu=["sm","md","lg","xl"],{passive:Jf}=Si;var $b=dc({width:0,height:0,name:"xs",sizes:{sm:600,md:1024,lg:1440,xl:1920},lt:{sm:!0,md:!0,lg:!0,xl:!0},gt:{xs:!1,sm:!1,md:!1,lg:!1},xs:!0,sm:!1,md:!1,lg:!1,xl:!1},{setSizes:zs,setDebounce:zs,install({$q:t,onSSRHydrated:e}){if(t.screen=this,this.__installed===!0){t.config.screen!==void 0&&(t.config.screen.bodyClasses===!1?document.body.classList.remove(`screen--${this.name}`):this.__update(!0));return}const{visualViewport:n}=window,r=n||window,i=document.scrollingElement||document.documentElement,s=n===void 0||Mt.is.mobile===!0?()=>[Math.max(window.innerWidth,i.clientWidth),Math.max(window.innerHeight,i.clientHeight)]:()=>[n.width*n.scale+window.innerWidth-i.clientWidth,n.height*n.scale+window.innerHeight-i.clientHeight],o=t.config.screen!==void 0&&t.config.screen.bodyClasses===!0;this.__update=h=>{const[d,f]=s();if(f!==this.height&&(this.height=f),d!==this.width)this.width=d;else if(h!==!0)return;let g=this.sizes;this.gt.xs=d>=g.sm,this.gt.sm=d>=g.md,this.gt.md=d>=g.lg,this.gt.lg=d>=g.xl,this.lt.sm=d<g.sm,this.lt.md=d<g.md,this.lt.lg=d<g.lg,this.lt.xl=d<g.xl,this.xs=this.lt.sm,this.sm=this.gt.xs===!0&&this.lt.md===!0,this.md=this.gt.sm===!0&&this.lt.lg===!0,this.lg=this.gt.md===!0&&this.lt.xl===!0,this.xl=this.gt.lg,g=this.xs===!0&&"xs"||this.sm===!0&&"sm"||this.md===!0&&"md"||this.lg===!0&&"lg"||"xl",g!==this.name&&(o===!0&&(document.body.classList.remove(`screen--${this.name}`),document.body.classList.add(`screen--${g}`)),this.name=g)};let a,c={},u=16;this.setSizes=h=>{hu.forEach(d=>{h[d]!==void 0&&(c[d]=h[d])})},this.setDebounce=h=>{u=h};const l=()=>{const h=getComputedStyle(document.body);h.getPropertyValue("--q-size-sm")&&hu.forEach(d=>{this.sizes[d]=parseInt(h.getPropertyValue(`--q-size-${d}`),10)}),this.setSizes=d=>{hu.forEach(f=>{d[f]&&(this.sizes[f]=d[f])}),this.__update(!0)},this.setDebounce=d=>{a!==void 0&&r.removeEventListener("resize",a,Jf),a=d>0?Bb(this.__update,d):this.__update,r.addEventListener("resize",a,Jf)},this.setDebounce(u),Object.keys(c).length!==0?(this.setSizes(c),c=void 0):this.__update(),o===!0&&this.name==="xs"&&document.body.classList.add("screen--xs")};Fr.value===!0?e.push(l):l()}});const ht=dc({isActive:!1,mode:!1},{__media:void 0,set(t){ht.mode=t,t==="auto"?(ht.__media===void 0&&(ht.__media=window.matchMedia("(prefers-color-scheme: dark)"),ht.__updateMedia=()=>{ht.set("auto")},ht.__media.addListener(ht.__updateMedia)),t=ht.__media.matches):ht.__media!==void 0&&(ht.__media.removeListener(ht.__updateMedia),ht.__media=void 0),ht.isActive=t===!0,document.body.classList.remove(`body--${t===!0?"light":"dark"}`),document.body.classList.add(`body--${t===!0?"dark":"light"}`)},toggle(){ht.set(ht.isActive===!1)},install({$q:t,onSSRHydrated:e,ssrContext:n}){const{dark:r}=t.config;if(t.dark=this,this.__installed===!0&&r===void 0)return;this.isActive=r===!0;const i=r!==void 0?r:!1;if(Fr.value===!0){const s=a=>{this.__fromSSR=a},o=this.set;this.set=s,s(i),e.push(()=>{this.set=o,this.set(this.__fromSSR)})}else this.set(i)}}),m_=()=>!0;function qb(t){return typeof t=="string"&&t!==""&&t!=="/"&&t!=="#/"}function Ub(t){return t.startsWith("#")===!0&&(t=t.substring(1)),t.startsWith("/")===!1&&(t="/"+t),t.endsWith("/")===!0&&(t=t.substring(0,t.length-1)),"#"+t}function jb(t){if(t.backButtonExit===!1)return()=>!1;if(t.backButtonExit==="*")return m_;const e=["#/"];return Array.isArray(t.backButtonExit)===!0&&e.push(...t.backButtonExit.filter(qb).map(Ub)),()=>e.includes(window.location.hash)}var Kb={__history:[],add:zs,remove:zs,install({$q:t}){if(this.__installed===!0)return;const{cordova:e,capacitor:n}=Mt.is;if(e!==!0&&n!==!0)return;const r=t.config[e===!0?"cordova":"capacitor"];if(r!==void 0&&r.backButton===!1||n===!0&&(window.Capacitor===void 0||window.Capacitor.Plugins.App===void 0))return;this.add=o=>{o.condition===void 0&&(o.condition=m_),this.__history.push(o)},this.remove=o=>{const a=this.__history.indexOf(o);a>=0&&this.__history.splice(a,1)};const i=jb(Object.assign({backButtonExit:!0},r)),s=()=>{if(this.__history.length){const o=this.__history[this.__history.length-1];o.condition()===!0&&(this.__history.pop(),o.handler())}else i()===!0?navigator.app.exitApp():window.history.back()};e===!0?document.addEventListener("deviceready",()=>{document.addEventListener("backbutton",s,!1)}):window.Capacitor.Plugins.App.addListener("backButton",s)}},Yf={isoName:"en-US",nativeName:"English (US)",label:{clear:"Clear",ok:"OK",cancel:"Cancel",close:"Close",set:"Set",select:"Select",reset:"Reset",remove:"Remove",update:"Update",create:"Create",search:"Search",filter:"Filter",refresh:"Refresh",expand:t=>t?`Expand "${t}"`:"Expand",collapse:t=>t?`Collapse "${t}"`:"Collapse"},date:{days:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),daysShort:"Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),monthsShort:"Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),firstDayOfWeek:0,format24h:!1,pluralDay:"days"},table:{noData:"No data available",noResults:"No matching records found",loading:"Loading...",selectedRecords:t=>t===1?"1 record selected.":(t===0?"No":t)+" records selected.",recordsPerPage:"Records per page:",allRows:"All",pagination:(t,e,n)=>t+"-"+e+" of "+n,columns:"Columns"},editor:{url:"URL",bold:"Bold",italic:"Italic",strikethrough:"Strikethrough",underline:"Underline",unorderedList:"Unordered List",orderedList:"Ordered List",subscript:"Subscript",superscript:"Superscript",hyperlink:"Hyperlink",toggleFullscreen:"Toggle Fullscreen",quote:"Quote",left:"Left align",center:"Center align",right:"Right align",justify:"Justify align",print:"Print",outdent:"Decrease indentation",indent:"Increase indentation",removeFormat:"Remove formatting",formatting:"Formatting",fontSize:"Font Size",align:"Align",hr:"Insert Horizontal Rule",undo:"Undo",redo:"Redo",heading1:"Heading 1",heading2:"Heading 2",heading3:"Heading 3",heading4:"Heading 4",heading5:"Heading 5",heading6:"Heading 6",paragraph:"Paragraph",code:"Code",size1:"Very small",size2:"A bit small",size3:"Normal",size4:"Medium-large",size5:"Big",size6:"Very big",size7:"Maximum",defaultFont:"Default Font",viewSource:"View Source"},tree:{noNodes:"No nodes available",noResults:"No matching nodes found"}};function Xf(){const t=Array.isArray(navigator.languages)===!0&&navigator.languages.length!==0?navigator.languages[0]:navigator.language;if(typeof t=="string")return t.split(/[-_]/).map((e,n)=>n===0?e.toLowerCase():n>1||e.length<4?e.toUpperCase():e[0].toUpperCase()+e.slice(1).toLowerCase()).join("-")}const $t=dc({__langPack:{}},{getLocale:Xf,set(t=Yf,e){const n={...t,rtl:t.rtl===!0,getLocale:Xf};{if(n.set=$t.set,$t.__langConfig===void 0||$t.__langConfig.noHtmlAttrs!==!0){const r=document.documentElement;r.setAttribute("dir",n.rtl===!0?"rtl":"ltr"),r.setAttribute("lang",n.isoName)}Object.assign($t.__langPack,n),$t.props=n,$t.isoName=n.isoName,$t.nativeName=n.nativeName}},install({$q:t,lang:e,ssrContext:n}){t.lang=$t.__langPack,$t.__langConfig=t.config.lang,this.__installed===!0?e!==void 0&&this.set(e):this.set(e||Yf)}});function zb(t,e,n=document.body){if(typeof t!="string")throw new TypeError("Expected a string as propName");if(typeof e!="string")throw new TypeError("Expected a string as value");if(!(n instanceof Element))throw new TypeError("Expected a DOM element");n.style.setProperty(`--q-${t}`,e)}let g_=!1;function Gb(t){g_=t.isComposing===!0}function Hb(t){return g_===!0||t!==Object(t)||t.isComposing===!0||t.qKeyEvent===!0}function Uk(t,e){return Hb(t)===!0?!1:[].concat(e).includes(t.keyCode)}function __(t){if(t.ios===!0)return"ios";if(t.android===!0)return"android"}function Wb({is:t,has:e,within:n},r){const i=[t.desktop===!0?"desktop":"mobile",`${e.touch===!1?"no-":""}touch`];if(t.mobile===!0){const s=__(t);s!==void 0&&i.push("platform-"+s)}if(t.nativeMobile===!0){const s=t.nativeMobileWrapper;i.push(s),i.push("native-mobile"),t.ios===!0&&(r[s]===void 0||r[s].iosStatusBarPadding!==!1)&&i.push("q-ios-padding")}else t.electron===!0?i.push("electron"):t.bex===!0&&i.push("bex");return n.iframe===!0&&i.push("within-iframe"),i}function Qb(){const{is:t}=Mt,e=document.body.className,n=new Set(e.replace(/ {2}/g," ").split(" "));if(hc!==void 0)n.delete("desktop"),n.add("platform-ios"),n.add("mobile");else if(t.nativeMobile!==!0&&t.electron!==!0&&t.bex!==!0){if(t.desktop===!0)n.delete("mobile"),n.delete("platform-ios"),n.delete("platform-android"),n.add("desktop");else if(t.mobile===!0){n.delete("desktop"),n.add("mobile");const i=__(t);i!==void 0?(n.add(`platform-${i}`),n.delete(`platform-${i==="ios"?"android":"ios"}`)):(n.delete("platform-ios"),n.delete("platform-android"))}}Mt.has.touch===!0&&(n.delete("no-touch"),n.add("touch")),Mt.within.iframe===!0&&n.add("within-iframe");const r=Array.from(n).join(" ");e!==r&&(document.body.className=r)}function Jb(t){for(const e in t)zb(e,t[e])}var Yb={install(t){if(this.__installed!==!0){if(Fr.value===!0)Qb();else{const{$q:e}=t;e.config.brand!==void 0&&Jb(e.config.brand);const n=Wb(Mt,e.config);document.body.classList.add.apply(document.body.classList,n)}Mt.is.ios===!0&&document.body.addEventListener("touchstart",zs),window.addEventListener("keydown",Gb,!0)}}},Xb={name:"material-icons",type:{positive:"check_circle",negative:"warning",info:"info",warning:"priority_high"},arrow:{up:"arrow_upward",right:"arrow_forward",down:"arrow_downward",left:"arrow_back",dropdown:"arrow_drop_down"},chevron:{left:"chevron_left",right:"chevron_right"},colorPicker:{spectrum:"gradient",tune:"tune",palette:"style"},pullToRefresh:{icon:"refresh"},carousel:{left:"chevron_left",right:"chevron_right",up:"keyboard_arrow_up",down:"keyboard_arrow_down",navigationIcon:"lens"},chip:{remove:"cancel",selected:"check"},datetime:{arrowLeft:"chevron_left",arrowRight:"chevron_right",now:"access_time",today:"today"},editor:{bold:"format_bold",italic:"format_italic",strikethrough:"strikethrough_s",underline:"format_underlined",unorderedList:"format_list_bulleted",orderedList:"format_list_numbered",subscript:"vertical_align_bottom",superscript:"vertical_align_top",hyperlink:"link",toggleFullscreen:"fullscreen",quote:"format_quote",left:"format_align_left",center:"format_align_center",right:"format_align_right",justify:"format_align_justify",print:"print",outdent:"format_indent_decrease",indent:"format_indent_increase",removeFormat:"format_clear",formatting:"text_format",fontSize:"format_size",align:"format_align_left",hr:"remove",undo:"undo",redo:"redo",heading:"format_size",code:"code",size:"format_size",font:"font_download",viewSource:"code"},expansionItem:{icon:"keyboard_arrow_down",denseIcon:"arrow_drop_down"},fab:{icon:"add",activeIcon:"close"},field:{clear:"cancel",error:"error"},pagination:{first:"first_page",prev:"keyboard_arrow_left",next:"keyboard_arrow_right",last:"last_page"},rating:{icon:"grade"},stepper:{done:"check",active:"edit",error:"warning"},tabs:{left:"chevron_left",right:"chevron_right",up:"keyboard_arrow_up",down:"keyboard_arrow_down"},table:{arrowUp:"arrow_upward",warning:"warning",firstPage:"first_page",prevPage:"chevron_left",nextPage:"chevron_right",lastPage:"last_page"},tree:{icon:"play_arrow"},uploader:{done:"done",clear:"clear",add:"add_box",upload:"cloud_upload",removeQueue:"clear_all",removeUploaded:"done_all"}};const Sa=dc({iconMapFn:null,__icons:{}},{set(t,e){const n={...t,rtl:t.rtl===!0};n.set=Sa.set,Object.assign(Sa.__icons,n)},install({$q:t,iconSet:e,ssrContext:n}){t.config.iconMapFn!==void 0&&(this.iconMapFn=t.config.iconMapFn),t.iconSet=this.__icons,Sh(t,"iconMapFn",()=>this.iconMapFn,r=>{this.iconMapFn=r}),this.__installed===!0?e!==void 0&&this.set(e):this.set(e||Xb)}}),Zb="_q_",jk="_q_l_",Kk="_q_pc_",zk=()=>{},Zf={};let y_=!1;function eA(){y_=!0}function ep(t){return t!==null&&typeof t=="object"&&Array.isArray(t)!==!0}const tp=[al,Yb,ht,$b,Kb,$t,Sa];function np(t,e){e.forEach(n=>{n.install(t),n.__installed=!0})}function tA(t,e,n){t.config.globalProperties.$q=n.$q,t.provide(Zb,n.$q),np(n,tp),e.components!==void 0&&Object.values(e.components).forEach(r=>{ep(r)===!0&&r.name!==void 0&&t.component(r.name,r)}),e.directives!==void 0&&Object.values(e.directives).forEach(r=>{ep(r)===!0&&r.name!==void 0&&t.directive(r.name,r)}),e.plugins!==void 0&&np(n,Object.values(e.plugins).filter(r=>typeof r.install=="function"&&tp.includes(r)===!1)),Fr.value===!0&&(n.$q.onSSRHydrated=()=>{n.onSSRHydrated.forEach(r=>{r()}),n.$q.onSSRHydrated=()=>{}})}var nA=function(t,e={}){const n={version:"2.12.3"};y_===!1?(e.config!==void 0&&Object.assign(Zf,e.config),n.config={...Zf},eA()):n.config=e.config||{},tA(t,e,{parentApp:t,$q:n,lang:e.lang,iconSet:e.iconSet,onSSRHydrated:[]})},rA={version:"2.12.3",install:nA,lang:$t,iconSet:Sa},iA=(t,e)=>{const n=t.__vccOpts||t;for(const[r,i]of e)n[r]=i;return n};const sA=wh({name:"App"});function oA(t,e,n,r,i,s){const o=TT("router-view");return s_(),a_(o)}var aA=iA(sA,[["render",oA]]);function Gk(t){return t}var cA=!1;/*!
  * pinia v2.1.4
  * (c) 2023 Eduardo San Martin Morote
  * @license MIT
  */let v_;const fc=t=>v_=t,w_=Symbol();function cl(t){return t&&typeof t=="object"&&Object.prototype.toString.call(t)==="[object Object]"&&typeof t.toJSON!="function"}var Ps;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(Ps||(Ps={}));function uA(){const t=gg(!0),e=t.run(()=>rc({}));let n=[],r=[];const i=vo({install(s){fc(i),i._a=s,s.provide(w_,i),s.config.globalProperties.$pinia=i,r.forEach(o=>n.push(o)),r=[]},use(s){return!this._a&&!cA?r.push(s):n.push(s),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return i}const E_=()=>{};function rp(t,e,n,r=E_){t.push(e);const i=()=>{const s=t.indexOf(e);s>-1&&(t.splice(s,1),r())};return!n&&_g()&&pI(i),i}function ai(t,...e){t.slice().forEach(n=>{n(...e)})}const lA=t=>t();function ul(t,e){t instanceof Map&&e instanceof Map&&e.forEach((n,r)=>t.set(r,n)),t instanceof Set&&e instanceof Set&&e.forEach(t.add,t);for(const n in e){if(!e.hasOwnProperty(n))continue;const r=e[n],i=t[n];cl(i)&&cl(r)&&t.hasOwnProperty(n)&&!qe(r)&&!Kn(r)?t[n]=ul(i,r):t[n]=r}return t}const hA=Symbol();function dA(t){return!cl(t)||!t.hasOwnProperty(hA)}const{assign:On}=Object;function fA(t){return!!(qe(t)&&t.effect)}function pA(t,e,n,r){const{state:i,actions:s,getters:o}=e,a=n.state.value[t];let c;function u(){a||(n.state.value[t]=i?i():{});const l=zI(n.state.value[t]);return On(l,s,Object.keys(o||{}).reduce((h,d)=>(h[d]=vo(Nt(()=>{fc(n);const f=n._s.get(t);return o[d].call(f,f)})),h),{}))}return c=I_(t,u,e,n,r,!0),c}function I_(t,e,n={},r,i,s){let o;const a=On({actions:{}},n),c={deep:!0};let u,l,h=[],d=[],f;const g=r.state.value[t];!s&&!g&&(r.state.value[t]={}),rc({});let v;function E(B){let Q;u=l=!1,typeof B=="function"?(B(r.state.value[t]),Q={type:Ps.patchFunction,storeId:t,events:f}):(ul(r.state.value[t],B),Q={type:Ps.patchObject,payload:B,storeId:t,events:f});const re=v=Symbol();yh().then(()=>{v===re&&(u=!0)}),l=!0,ai(h,Q,r.state.value[t])}const b=s?function(){const{state:Q}=n,re=Q?Q():{};this.$patch(Te=>{On(Te,re)})}:E_;function S(){o.stop(),h=[],d=[],r._s.delete(t)}function D(B,Q){return function(){fc(r);const re=Array.from(arguments),Te=[],K=[];function me(le){Te.push(le)}function rt(le){K.push(le)}ai(d,{args:re,name:B,store:j,after:me,onError:rt});let _t;try{_t=Q.apply(this&&this.$id===t?this:j,re)}catch(le){throw ai(K,le),le}return _t instanceof Promise?_t.then(le=>(ai(Te,le),le)).catch(le=>(ai(K,le),Promise.reject(le))):(ai(Te,_t),_t)}}const V={_p:r,$id:t,$onAction:rp.bind(null,d),$patch:E,$reset:b,$subscribe(B,Q={}){const re=rp(h,B,Q.detached,()=>Te()),Te=o.run(()=>As(()=>r.state.value[t],K=>{(Q.flush==="sync"?l:u)&&B({storeId:t,type:Ps.direct,events:f},K)},On({},c,Q)));return re},$dispose:S},j=Yr(V);r._s.set(t,j);const X=r._a&&r._a.runWithContext||lA,oe=r._e.run(()=>(o=gg(),X(()=>o.run(e))));for(const B in oe){const Q=oe[B];if(qe(Q)&&!fA(Q)||Kn(Q))s||(g&&dA(Q)&&(qe(Q)?Q.value=g[B]:ul(Q,g[B])),r.state.value[t][B]=Q);else if(typeof Q=="function"){const re=D(B,Q);oe[B]=re,a.actions[B]=Q}}return On(j,oe),On(fe(j),oe),Object.defineProperty(j,"$state",{get:()=>r.state.value[t],set:B=>{E(Q=>{On(Q,B)})}}),r._p.forEach(B=>{On(j,o.run(()=>B({store:j,app:r._a,pinia:r,options:a})))}),g&&s&&n.hydrate&&n.hydrate(j.$state,g),u=!0,l=!0,j}function Hk(t,e,n){let r,i;const s=typeof e=="function";typeof t=="string"?(r=t,i=s?n:e):(i=t,r=t.id);function o(a,c){const u=NT();return a=a||(u?an(w_,null):null),a&&fc(a),a=v_,a._s.has(r)||(s?I_(r,e,i,a):pA(r,i,a)),a._s.get(r)}return o.$id=r,o}var du=()=>uA();/*!
  * vue-router v4.2.4
  * (c) 2023 Eduardo San Martin Morote
  * @license MIT
  */const hi=typeof window!="undefined";function mA(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const ve=Object.assign;function fu(t,e){const n={};for(const r in e){const i=e[r];n[r]=Ht(i)?i.map(t):t(i)}return n}const Cs=()=>{},Ht=Array.isArray,gA=/\/$/,_A=t=>t.replace(gA,"");function pu(t,e,n="/"){let r,i={},s="",o="";const a=e.indexOf("#");let c=e.indexOf("?");return a<c&&a>=0&&(c=-1),c>-1&&(r=e.slice(0,c),s=e.slice(c+1,a>-1?a:e.length),i=t(s)),a>-1&&(r=r||e.slice(0,a),o=e.slice(a,e.length)),r=EA(r!=null?r:e,n),{fullPath:r+(s&&"?")+s+o,path:r,query:i,hash:o}}function yA(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function ip(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function vA(t,e,n){const r=e.matched.length-1,i=n.matched.length-1;return r>-1&&r===i&&Ri(e.matched[r],n.matched[i])&&T_(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Ri(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function T_(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!wA(t[n],e[n]))return!1;return!0}function wA(t,e){return Ht(t)?sp(t,e):Ht(e)?sp(e,t):t===e}function sp(t,e){return Ht(e)?t.length===e.length&&t.every((n,r)=>n===e[r]):t.length===1&&t[0]===e}function EA(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),r=t.split("/"),i=r[r.length-1];(i===".."||i===".")&&r.push("");let s=n.length-1,o,a;for(o=0;o<r.length;o++)if(a=r[o],a!==".")if(a==="..")s>1&&s--;else break;return n.slice(0,s).join("/")+"/"+r.slice(o-(o===r.length?1:0)).join("/")}var Gs;(function(t){t.pop="pop",t.push="push"})(Gs||(Gs={}));var xs;(function(t){t.back="back",t.forward="forward",t.unknown=""})(xs||(xs={}));function IA(t){if(!t)if(hi){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),_A(t)}const TA=/^[^#]+#/;function bA(t,e){return t.replace(TA,"#")+e}function AA(t,e){const n=document.documentElement.getBoundingClientRect(),r=t.getBoundingClientRect();return{behavior:e.behavior,left:r.left-n.left-(e.left||0),top:r.top-n.top-(e.top||0)}}const pc=()=>({left:window.pageXOffset,top:window.pageYOffset});function SA(t){let e;if("el"in t){const n=t.el,r=typeof n=="string"&&n.startsWith("#"),i=typeof n=="string"?r?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!i)return;e=AA(i,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function op(t,e){return(history.state?history.state.position-e:-1)+t}const ll=new Map;function RA(t,e){ll.set(t,e)}function PA(t){const e=ll.get(t);return ll.delete(t),e}let CA=()=>location.protocol+"//"+location.host;function b_(t,e){const{pathname:n,search:r,hash:i}=e,s=t.indexOf("#");if(s>-1){let a=i.includes(t.slice(s))?t.slice(s).length:1,c=i.slice(a);return c[0]!=="/"&&(c="/"+c),ip(c,"")}return ip(n,t)+r+i}function xA(t,e,n,r){let i=[],s=[],o=null;const a=({state:d})=>{const f=b_(t,location),g=n.value,v=e.value;let E=0;if(d){if(n.value=f,e.value=d,o&&o===g){o=null;return}E=v?d.position-v.position:0}else r(f);i.forEach(b=>{b(n.value,g,{delta:E,type:Gs.pop,direction:E?E>0?xs.forward:xs.back:xs.unknown})})};function c(){o=n.value}function u(d){i.push(d);const f=()=>{const g=i.indexOf(d);g>-1&&i.splice(g,1)};return s.push(f),f}function l(){const{history:d}=window;!d.state||d.replaceState(ve({},d.state,{scroll:pc()}),"")}function h(){for(const d of s)d();s=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",l)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",l,{passive:!0}),{pauseListeners:c,listen:u,destroy:h}}function ap(t,e,n,r=!1,i=!1){return{back:t,current:e,forward:n,replaced:r,position:window.history.length,scroll:i?pc():null}}function DA(t){const{history:e,location:n}=window,r={value:b_(t,n)},i={value:e.state};i.value||s(r.value,{back:null,current:r.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function s(c,u,l){const h=t.indexOf("#"),d=h>-1?(n.host&&document.querySelector("base")?t:t.slice(h))+c:CA()+t+c;try{e[l?"replaceState":"pushState"](u,"",d),i.value=u}catch(f){console.error(f),n[l?"replace":"assign"](d)}}function o(c,u){const l=ve({},e.state,ap(i.value.back,c,i.value.forward,!0),u,{position:i.value.position});s(c,l,!0),r.value=c}function a(c,u){const l=ve({},i.value,e.state,{forward:c,scroll:pc()});s(l.current,l,!0);const h=ve({},ap(r.value,c,null),{position:l.position+1},u);s(c,h,!1),r.value=c}return{location:r,state:i,push:a,replace:o}}function VA(t){t=IA(t);const e=DA(t),n=xA(t,e.state,e.location,e.replace);function r(s,o=!0){o||n.pauseListeners(),history.go(s)}const i=ve({location:"",base:t,go:r,createHref:bA.bind(null,t)},e,n);return Object.defineProperty(i,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(i,"state",{enumerable:!0,get:()=>e.state.value}),i}function kA(t){return t=location.host?t||location.pathname+location.search:"",t.includes("#")||(t+="#"),VA(t)}function NA(t){return typeof t=="string"||t&&typeof t=="object"}function A_(t){return typeof t=="string"||typeof t=="symbol"}const Vn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},S_=Symbol("");var cp;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(cp||(cp={}));function Pi(t,e){return ve(new Error,{type:t,[S_]:!0},e)}function fn(t,e){return t instanceof Error&&S_ in t&&(e==null||!!(t.type&e))}const up="[^/]+?",OA={sensitive:!1,strict:!1,start:!0,end:!0},MA=/[.+*?^${}()[\]/\\]/g;function FA(t,e){const n=ve({},OA,e),r=[];let i=n.start?"^":"";const s=[];for(const u of t){const l=u.length?[]:[90];n.strict&&!u.length&&(i+="/");for(let h=0;h<u.length;h++){const d=u[h];let f=40+(n.sensitive?.25:0);if(d.type===0)h||(i+="/"),i+=d.value.replace(MA,"\\$&"),f+=40;else if(d.type===1){const{value:g,repeatable:v,optional:E,regexp:b}=d;s.push({name:g,repeatable:v,optional:E});const S=b||up;if(S!==up){f+=10;try{new RegExp(`(${S})`)}catch(V){throw new Error(`Invalid custom RegExp for param "${g}" (${S}): `+V.message)}}let D=v?`((?:${S})(?:/(?:${S}))*)`:`(${S})`;h||(D=E&&u.length<2?`(?:/${D})`:"/"+D),E&&(D+="?"),i+=D,f+=20,E&&(f+=-8),v&&(f+=-20),S===".*"&&(f+=-50)}l.push(f)}r.push(l)}if(n.strict&&n.end){const u=r.length-1;r[u][r[u].length-1]+=.7000000000000001}n.strict||(i+="/?"),n.end?i+="$":n.strict&&(i+="(?:/|$)");const o=new RegExp(i,n.sensitive?"":"i");function a(u){const l=u.match(o),h={};if(!l)return null;for(let d=1;d<l.length;d++){const f=l[d]||"",g=s[d-1];h[g.name]=f&&g.repeatable?f.split("/"):f}return h}function c(u){let l="",h=!1;for(const d of t){(!h||!l.endsWith("/"))&&(l+="/"),h=!1;for(const f of d)if(f.type===0)l+=f.value;else if(f.type===1){const{value:g,repeatable:v,optional:E}=f,b=g in u?u[g]:"";if(Ht(b)&&!v)throw new Error(`Provided param "${g}" is an array but it is not repeatable (* or + modifiers)`);const S=Ht(b)?b.join("/"):b;if(!S)if(E)d.length<2&&(l.endsWith("/")?l=l.slice(0,-1):h=!0);else throw new Error(`Missing required param "${g}"`);l+=S}}return l||"/"}return{re:o,score:r,keys:s,parse:a,stringify:c}}function LA(t,e){let n=0;for(;n<t.length&&n<e.length;){const r=e[n]-t[n];if(r)return r;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function BA(t,e){let n=0;const r=t.score,i=e.score;for(;n<r.length&&n<i.length;){const s=LA(r[n],i[n]);if(s)return s;n++}if(Math.abs(i.length-r.length)===1){if(lp(r))return 1;if(lp(i))return-1}return i.length-r.length}function lp(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const $A={type:0,value:""},qA=/[a-zA-Z0-9_]/;function UA(t){if(!t)return[[]];if(t==="/")return[[$A]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(f){throw new Error(`ERR (${n})/"${u}": ${f}`)}let n=0,r=n;const i=[];let s;function o(){s&&i.push(s),s=[]}let a=0,c,u="",l="";function h(){!u||(n===0?s.push({type:0,value:u}):n===1||n===2||n===3?(s.length>1&&(c==="*"||c==="+")&&e(`A repeatable param (${u}) must be alone in its segment. eg: '/:ids+.`),s.push({type:1,value:u,regexp:l,repeatable:c==="*"||c==="+",optional:c==="*"||c==="?"})):e("Invalid state to consume buffer"),u="")}function d(){u+=c}for(;a<t.length;){if(c=t[a++],c==="\\"&&n!==2){r=n,n=4;continue}switch(n){case 0:c==="/"?(u&&h(),o()):c===":"?(h(),n=1):d();break;case 4:d(),n=r;break;case 1:c==="("?n=2:qA.test(c)?d():(h(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&a--);break;case 2:c===")"?l[l.length-1]=="\\"?l=l.slice(0,-1)+c:n=3:l+=c;break;case 3:h(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&a--,l="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${u}"`),h(),o(),i}function jA(t,e,n){const r=FA(UA(t.path),n),i=ve(r,{record:t,parent:e,children:[],alias:[]});return e&&!i.record.aliasOf==!e.record.aliasOf&&e.children.push(i),i}function KA(t,e){const n=[],r=new Map;e=fp({strict:!1,end:!0,sensitive:!1},e);function i(l){return r.get(l)}function s(l,h,d){const f=!d,g=zA(l);g.aliasOf=d&&d.record;const v=fp(e,l),E=[g];if("alias"in l){const D=typeof l.alias=="string"?[l.alias]:l.alias;for(const V of D)E.push(ve({},g,{components:d?d.record.components:g.components,path:V,aliasOf:d?d.record:g}))}let b,S;for(const D of E){const{path:V}=D;if(h&&V[0]!=="/"){const j=h.record.path,X=j[j.length-1]==="/"?"":"/";D.path=h.record.path+(V&&X+V)}if(b=jA(D,h,v),d?d.alias.push(b):(S=S||b,S!==b&&S.alias.push(b),f&&l.name&&!dp(b)&&o(l.name)),g.children){const j=g.children;for(let X=0;X<j.length;X++)s(j[X],b,d&&d.children[X])}d=d||b,(b.record.components&&Object.keys(b.record.components).length||b.record.name||b.record.redirect)&&c(b)}return S?()=>{o(S)}:Cs}function o(l){if(A_(l)){const h=r.get(l);h&&(r.delete(l),n.splice(n.indexOf(h),1),h.children.forEach(o),h.alias.forEach(o))}else{const h=n.indexOf(l);h>-1&&(n.splice(h,1),l.record.name&&r.delete(l.record.name),l.children.forEach(o),l.alias.forEach(o))}}function a(){return n}function c(l){let h=0;for(;h<n.length&&BA(l,n[h])>=0&&(l.record.path!==n[h].record.path||!R_(l,n[h]));)h++;n.splice(h,0,l),l.record.name&&!dp(l)&&r.set(l.record.name,l)}function u(l,h){let d,f={},g,v;if("name"in l&&l.name){if(d=r.get(l.name),!d)throw Pi(1,{location:l});v=d.record.name,f=ve(hp(h.params,d.keys.filter(S=>!S.optional).map(S=>S.name)),l.params&&hp(l.params,d.keys.map(S=>S.name))),g=d.stringify(f)}else if("path"in l)g=l.path,d=n.find(S=>S.re.test(g)),d&&(f=d.parse(g),v=d.record.name);else{if(d=h.name?r.get(h.name):n.find(S=>S.re.test(h.path)),!d)throw Pi(1,{location:l,currentLocation:h});v=d.record.name,f=ve({},h.params,l.params),g=d.stringify(f)}const E=[];let b=d;for(;b;)E.unshift(b.record),b=b.parent;return{name:v,path:g,params:f,matched:E,meta:HA(E)}}return t.forEach(l=>s(l)),{addRoute:s,resolve:u,removeRoute:o,getRoutes:a,getRecordMatcher:i}}function hp(t,e){const n={};for(const r of e)r in t&&(n[r]=t[r]);return n}function zA(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:GA(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function GA(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const r in t.components)e[r]=typeof n=="object"?n[r]:n;return e}function dp(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function HA(t){return t.reduce((e,n)=>ve(e,n.meta),{})}function fp(t,e){const n={};for(const r in t)n[r]=r in e?e[r]:t[r];return n}function R_(t,e){return e.children.some(n=>n===t||R_(t,n))}const P_=/#/g,WA=/&/g,QA=/\//g,JA=/=/g,YA=/\?/g,C_=/\+/g,XA=/%5B/g,ZA=/%5D/g,x_=/%5E/g,e0=/%60/g,D_=/%7B/g,t0=/%7C/g,V_=/%7D/g,n0=/%20/g;function Rh(t){return encodeURI(""+t).replace(t0,"|").replace(XA,"[").replace(ZA,"]")}function r0(t){return Rh(t).replace(D_,"{").replace(V_,"}").replace(x_,"^")}function hl(t){return Rh(t).replace(C_,"%2B").replace(n0,"+").replace(P_,"%23").replace(WA,"%26").replace(e0,"`").replace(D_,"{").replace(V_,"}").replace(x_,"^")}function i0(t){return hl(t).replace(JA,"%3D")}function s0(t){return Rh(t).replace(P_,"%23").replace(YA,"%3F")}function o0(t){return t==null?"":s0(t).replace(QA,"%2F")}function Ra(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function a0(t){const e={};if(t===""||t==="?")return e;const r=(t[0]==="?"?t.slice(1):t).split("&");for(let i=0;i<r.length;++i){const s=r[i].replace(C_," "),o=s.indexOf("="),a=Ra(o<0?s:s.slice(0,o)),c=o<0?null:Ra(s.slice(o+1));if(a in e){let u=e[a];Ht(u)||(u=e[a]=[u]),u.push(c)}else e[a]=c}return e}function pp(t){let e="";for(let n in t){const r=t[n];if(n=i0(n),r==null){r!==void 0&&(e+=(e.length?"&":"")+n);continue}(Ht(r)?r.map(s=>s&&hl(s)):[r&&hl(r)]).forEach(s=>{s!==void 0&&(e+=(e.length?"&":"")+n,s!=null&&(e+="="+s))})}return e}function c0(t){const e={};for(const n in t){const r=t[n];r!==void 0&&(e[n]=Ht(r)?r.map(i=>i==null?null:""+i):r==null?r:""+r)}return e}const u0=Symbol(""),mp=Symbol(""),Ph=Symbol(""),k_=Symbol(""),dl=Symbol("");function us(){let t=[];function e(r){return t.push(r),()=>{const i=t.indexOf(r);i>-1&&t.splice(i,1)}}function n(){t=[]}return{add:e,list:()=>t.slice(),reset:n}}function Fn(t,e,n,r,i){const s=r&&(r.enterCallbacks[i]=r.enterCallbacks[i]||[]);return()=>new Promise((o,a)=>{const c=h=>{h===!1?a(Pi(4,{from:n,to:e})):h instanceof Error?a(h):NA(h)?a(Pi(2,{from:e,to:h})):(s&&r.enterCallbacks[i]===s&&typeof h=="function"&&s.push(h),o())},u=t.call(r&&r.instances[i],e,n,c);let l=Promise.resolve(u);t.length<3&&(l=l.then(c)),l.catch(h=>a(h))})}function mu(t,e,n,r){const i=[];for(const s of t)for(const o in s.components){let a=s.components[o];if(!(e!=="beforeRouteEnter"&&!s.instances[o]))if(l0(a)){const u=(a.__vccOpts||a)[e];u&&i.push(Fn(u,n,r,s,o))}else{let c=a();i.push(()=>c.then(u=>{if(!u)return Promise.reject(new Error(`Couldn't resolve component "${o}" at "${s.path}"`));const l=mA(u)?u.default:u;s.components[o]=l;const d=(l.__vccOpts||l)[e];return d&&Fn(d,n,r,s,o)()}))}}return i}function l0(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function gp(t){const e=an(Ph),n=an(k_),r=Nt(()=>e.resolve(yi(t.to))),i=Nt(()=>{const{matched:c}=r.value,{length:u}=c,l=c[u-1],h=n.matched;if(!l||!h.length)return-1;const d=h.findIndex(Ri.bind(null,l));if(d>-1)return d;const f=_p(c[u-2]);return u>1&&_p(l)===f&&h[h.length-1].path!==f?h.findIndex(Ri.bind(null,c[u-2])):d}),s=Nt(()=>i.value>-1&&p0(n.params,r.value.params)),o=Nt(()=>i.value>-1&&i.value===n.matched.length-1&&T_(n.params,r.value.params));function a(c={}){return f0(c)?e[yi(t.replace)?"replace":"push"](yi(t.to)).catch(Cs):Promise.resolve()}return{route:r,href:Nt(()=>r.value.href),isActive:s,isExactActive:o,navigate:a}}const h0=wh({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:gp,setup(t,{slots:e}){const n=Yr(gp(t)),{options:r}=an(Ph),i=Nt(()=>({[yp(t.activeClass,r.linkActiveClass,"router-link-active")]:n.isActive,[yp(t.exactActiveClass,r.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const s=e.default&&e.default(n);return t.custom?s:Ah("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:i.value},s)}}}),d0=h0;function f0(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function p0(t,e){for(const n in e){const r=e[n],i=t[n];if(typeof r=="string"){if(r!==i)return!1}else if(!Ht(i)||i.length!==r.length||r.some((s,o)=>s!==i[o]))return!1}return!0}function _p(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const yp=(t,e,n)=>t!=null?t:e!=null?e:n,m0=wh({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const r=an(dl),i=Nt(()=>t.route||r.value),s=an(mp,0),o=Nt(()=>{let u=yi(s);const{matched:l}=i.value;let h;for(;(h=l[u])&&!h.components;)u++;return u}),a=Nt(()=>i.value.matched[o.value]);la(mp,Nt(()=>o.value+1)),la(u0,a),la(dl,i);const c=rc();return As(()=>[c.value,a.value,t.name],([u,l,h],[d,f,g])=>{l&&(l.instances[h]=u,f&&f!==l&&u&&u===d&&(l.leaveGuards.size||(l.leaveGuards=f.leaveGuards),l.updateGuards.size||(l.updateGuards=f.updateGuards))),u&&l&&(!f||!Ri(l,f)||!d)&&(l.enterCallbacks[h]||[]).forEach(v=>v(u))},{flush:"post"}),()=>{const u=i.value,l=t.name,h=a.value,d=h&&h.components[l];if(!d)return vp(n.default,{Component:d,route:u});const f=h.props[l],g=f?f===!0?u.params:typeof f=="function"?f(u):f:null,E=Ah(d,ve({},g,e,{onVnodeUnmounted:b=>{b.component.isUnmounted&&(h.instances[l]=null)},ref:c}));return vp(n.default,{Component:E,route:u})||E}}});function vp(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const g0=m0;function _0(t){const e=KA(t.routes,t),n=t.parseQuery||a0,r=t.stringifyQuery||pp,i=t.history,s=us(),o=us(),a=us(),c=UI(Vn);let u=Vn;hi&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const l=fu.bind(null,T=>""+T),h=fu.bind(null,o0),d=fu.bind(null,Ra);function f(T,U){let F,W;return A_(T)?(F=e.getRecordMatcher(T),W=U):W=T,e.addRoute(W,F)}function g(T){const U=e.getRecordMatcher(T);U&&e.removeRoute(U)}function v(){return e.getRoutes().map(T=>T.record)}function E(T){return!!e.getRecordMatcher(T)}function b(T,U){if(U=ve({},U||c.value),typeof T=="string"){const _=pu(n,T,U.path),I=e.resolve({path:_.path},U),R=i.createHref(_.fullPath);return ve(_,I,{params:d(I.params),hash:Ra(_.hash),redirectedFrom:void 0,href:R})}let F;if("path"in T)F=ve({},T,{path:pu(n,T.path,U.path).path});else{const _=ve({},T.params);for(const I in _)_[I]==null&&delete _[I];F=ve({},T,{params:h(_)}),U.params=h(U.params)}const W=e.resolve(F,U),ye=T.hash||"";W.params=l(d(W.params));const p=yA(r,ve({},T,{hash:r0(ye),path:W.path})),m=i.createHref(p);return ve({fullPath:p,hash:ye,query:r===pp?c0(T.query):T.query||{}},W,{redirectedFrom:void 0,href:m})}function S(T){return typeof T=="string"?pu(n,T,c.value.path):ve({},T)}function D(T,U){if(u!==T)return Pi(8,{from:U,to:T})}function V(T){return oe(T)}function j(T){return V(ve(S(T),{replace:!0}))}function X(T){const U=T.matched[T.matched.length-1];if(U&&U.redirect){const{redirect:F}=U;let W=typeof F=="function"?F(T):F;return typeof W=="string"&&(W=W.includes("?")||W.includes("#")?W=S(W):{path:W},W.params={}),ve({query:T.query,hash:T.hash,params:"path"in W?{}:T.params},W)}}function oe(T,U){const F=u=b(T),W=c.value,ye=T.state,p=T.force,m=T.replace===!0,_=X(F);if(_)return oe(ve(S(_),{state:typeof _=="object"?ve({},ye,_.state):ye,force:p,replace:m}),U||F);const I=F;I.redirectedFrom=U;let R;return!p&&vA(r,W,F)&&(R=Pi(16,{to:I,from:W}),Qt(W,W,!0,!1)),(R?Promise.resolve(R):re(I,W)).catch(C=>fn(C)?fn(C,2)?C:Pn(C):_e(C,I,W)).then(C=>{if(C){if(fn(C,2))return oe(ve({replace:m},S(C.to),{state:typeof C.to=="object"?ve({},ye,C.to.state):ye,force:p}),U||I)}else C=K(I,W,!0,m,ye);return Te(I,W,C),C})}function B(T,U){const F=D(T,U);return F?Promise.reject(F):Promise.resolve()}function Q(T){const U=ii.values().next().value;return U&&typeof U.runWithContext=="function"?U.runWithContext(T):T()}function re(T,U){let F;const[W,ye,p]=y0(T,U);F=mu(W.reverse(),"beforeRouteLeave",T,U);for(const _ of W)_.leaveGuards.forEach(I=>{F.push(Fn(I,T,U))});const m=B.bind(null,T,U);return F.push(m),ut(F).then(()=>{F=[];for(const _ of s.list())F.push(Fn(_,T,U));return F.push(m),ut(F)}).then(()=>{F=mu(ye,"beforeRouteUpdate",T,U);for(const _ of ye)_.updateGuards.forEach(I=>{F.push(Fn(I,T,U))});return F.push(m),ut(F)}).then(()=>{F=[];for(const _ of p)if(_.beforeEnter)if(Ht(_.beforeEnter))for(const I of _.beforeEnter)F.push(Fn(I,T,U));else F.push(Fn(_.beforeEnter,T,U));return F.push(m),ut(F)}).then(()=>(T.matched.forEach(_=>_.enterCallbacks={}),F=mu(p,"beforeRouteEnter",T,U),F.push(m),ut(F))).then(()=>{F=[];for(const _ of o.list())F.push(Fn(_,T,U));return F.push(m),ut(F)}).catch(_=>fn(_,8)?_:Promise.reject(_))}function Te(T,U,F){a.list().forEach(W=>Q(()=>W(T,U,F)))}function K(T,U,F,W,ye){const p=D(T,U);if(p)return p;const m=U===Vn,_=hi?history.state:{};F&&(W||m?i.replace(T.fullPath,ve({scroll:m&&_&&_.scroll},ye)):i.push(T.fullPath,ye)),c.value=T,Qt(T,U,F,m),Pn()}let me;function rt(){me||(me=i.listen((T,U,F)=>{if(!jo.listening)return;const W=b(T),ye=X(W);if(ye){oe(ve(ye,{replace:!0}),W).catch(Cs);return}u=W;const p=c.value;hi&&RA(op(p.fullPath,F.delta),pc()),re(W,p).catch(m=>fn(m,12)?m:fn(m,2)?(oe(m.to,W).then(_=>{fn(_,20)&&!F.delta&&F.type===Gs.pop&&i.go(-1,!1)}).catch(Cs),Promise.reject()):(F.delta&&i.go(-F.delta,!1),_e(m,W,p))).then(m=>{m=m||K(W,p,!1),m&&(F.delta&&!fn(m,8)?i.go(-F.delta,!1):F.type===Gs.pop&&fn(m,20)&&i.go(-1,!1)),Te(W,p,m)}).catch(Cs)}))}let _t=us(),le=us(),be;function _e(T,U,F){Pn(T);const W=le.list();return W.length?W.forEach(ye=>ye(T,U,F)):console.error(T),Promise.reject(T)}function dn(){return be&&c.value!==Vn?Promise.resolve():new Promise((T,U)=>{_t.add([T,U])})}function Pn(T){return be||(be=!T,rt(),_t.list().forEach(([U,F])=>T?F(T):U()),_t.reset()),T}function Qt(T,U,F,W){const{scrollBehavior:ye}=t;if(!hi||!ye)return Promise.resolve();const p=!F&&PA(op(T.fullPath,0))||(W||!F)&&history.state&&history.state.scroll||null;return yh().then(()=>ye(T,U,p)).then(m=>m&&SA(m)).catch(m=>_e(m,T,U))}const Et=T=>i.go(T);let ri;const ii=new Set,jo={currentRoute:c,listening:!0,addRoute:f,removeRoute:g,hasRoute:E,getRoutes:v,resolve:b,options:t,push:V,replace:j,go:Et,back:()=>Et(-1),forward:()=>Et(1),beforeEach:s.add,beforeResolve:o.add,afterEach:a.add,onError:le.add,isReady:dn,install(T){const U=this;T.component("RouterLink",d0),T.component("RouterView",g0),T.config.globalProperties.$router=U,Object.defineProperty(T.config.globalProperties,"$route",{enumerable:!0,get:()=>yi(c)}),hi&&!ri&&c.value===Vn&&(ri=!0,V(i.location).catch(ye=>{}));const F={};for(const ye in Vn)Object.defineProperty(F,ye,{get:()=>c.value[ye],enumerable:!0});T.provide(Ph,U),T.provide(k_,Pg(F)),T.provide(dl,c);const W=T.unmount;ii.add(T),T.unmount=function(){ii.delete(T),ii.size<1&&(u=Vn,me&&me(),me=null,c.value=Vn,ri=!1,be=!1),W()}}};function ut(T){return T.reduce((U,F)=>U.then(()=>Q(F)),Promise.resolve())}return jo}function y0(t,e){const n=[],r=[],i=[],s=Math.max(e.matched.length,t.matched.length);for(let o=0;o<s;o++){const a=e.matched[o];a&&(t.matched.find(u=>Ri(u,a))?r.push(a):n.push(a));const c=t.matched[o];c&&(e.matched.find(u=>Ri(u,c))||i.push(c))}return[n,r,i]}const v0=[{path:"/",component:()=>mi(()=>import("./MainLayout.f1d2e891.js"),["assets/MainLayout.f1d2e891.js","assets/QBtn.e8367431.js","assets/use-router-link.71c56db4.js","assets/QItem.2ccc68bc.js"]),children:[{path:"",component:()=>mi(()=>import("./IndexPage.925b7357.js"),["assets/IndexPage.925b7357.js","assets/use-router-link.71c56db4.js","assets/QItem.2ccc68bc.js","assets/index.cf7752d6.js"])}]},{path:"/:catchAll(.*)*",component:()=>mi(()=>import("./ErrorNotFound.1e39cdca.js"),["assets/ErrorNotFound.1e39cdca.js","assets/QBtn.e8367431.js","assets/use-router-link.71c56db4.js"])}];var gu=function(){return _0({scrollBehavior:()=>({left:0,top:0}),routes:v0,history:kA("/")})};async function w0(t,e){const n=t(aA);n.use(rA,e);const r=typeof du=="function"?await du({}):du;n.use(r);const i=vo(typeof gu=="function"?await gu({store:r}):gu);return r.use(({store:s})=>{s.router=i}),{app:n,store:r,router:i}}var E0={config:{}},I0=function(){return Boolean(window.location.hostname==="localhost"||window.location.hostname==="[::1]"||window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/))},fl;typeof window!="undefined"&&(typeof Promise!="undefined"?fl=new Promise(function(t){return window.addEventListener("load",t)}):fl={then:function(t){return window.addEventListener("load",t)}});function T0(t,e){e===void 0&&(e={});var n=e.registrationOptions;n===void 0&&(n={}),delete e.registrationOptions;var r=function(i){for(var s=[],o=arguments.length-1;o-- >0;)s[o]=arguments[o+1];e&&e[i]&&e[i].apply(e,s)};"serviceWorker"in navigator&&fl.then(function(){I0()?(b0(t,r,n),navigator.serviceWorker.ready.then(function(i){r("ready",i)}).catch(function(i){return Hs(r,i)})):(N_(t,r,n),navigator.serviceWorker.ready.then(function(i){r("ready",i)}).catch(function(i){return Hs(r,i)}))})}function Hs(t,e){navigator.onLine||t("offline"),t("error",e)}function N_(t,e,n){navigator.serviceWorker.register(t,n).then(function(r){if(e("registered",r),r.waiting){e("updated",r);return}r.onupdatefound=function(){e("updatefound",r);var i=r.installing;i.onstatechange=function(){i.state==="installed"&&(navigator.serviceWorker.controller?e("updated",r):e("cached",r))}}}).catch(function(r){return Hs(e,r)})}function b0(t,e,n){fetch(t).then(function(r){r.status===404?(e("error",new Error("Service worker not found at "+t)),wp()):r.headers.get("content-type").indexOf("javascript")===-1?(e("error",new Error("Expected "+t+" to have javascript content-type, but received "+r.headers.get("content-type"))),wp()):N_(t,e,n)}).catch(function(r){return Hs(e,r)})}function wp(){"serviceWorker"in navigator&&navigator.serviceWorker.ready.then(function(t){t.unregister()}).catch(function(t){return Hs(emit,t)})}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A0=function(t,e){if(!t)throw S0(e)},S0=function(t){return new Error("Firebase Database ("+O_.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const M_=function(t){const e=[];let n=0;for(let r=0;r<t.length;r++){let i=t.charCodeAt(r);i<128?e[n++]=i:i<2048?(e[n++]=i>>6|192,e[n++]=i&63|128):(i&64512)===55296&&r+1<t.length&&(t.charCodeAt(r+1)&64512)===56320?(i=65536+((i&1023)<<10)+(t.charCodeAt(++r)&1023),e[n++]=i>>18|240,e[n++]=i>>12&63|128,e[n++]=i>>6&63|128,e[n++]=i&63|128):(e[n++]=i>>12|224,e[n++]=i>>6&63|128,e[n++]=i&63|128)}return e},R0=function(t){const e=[];let n=0,r=0;for(;n<t.length;){const i=t[n++];if(i<128)e[r++]=String.fromCharCode(i);else if(i>191&&i<224){const s=t[n++];e[r++]=String.fromCharCode((i&31)<<6|s&63)}else if(i>239&&i<365){const s=t[n++],o=t[n++],a=t[n++],c=((i&7)<<18|(s&63)<<12|(o&63)<<6|a&63)-65536;e[r++]=String.fromCharCode(55296+(c>>10)),e[r++]=String.fromCharCode(56320+(c&1023))}else{const s=t[n++],o=t[n++];e[r++]=String.fromCharCode((i&15)<<12|(s&63)<<6|o&63)}}return e.join("")},F_={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(t,e){if(!Array.isArray(t))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let i=0;i<t.length;i+=3){const s=t[i],o=i+1<t.length,a=o?t[i+1]:0,c=i+2<t.length,u=c?t[i+2]:0,l=s>>2,h=(s&3)<<4|a>>4;let d=(a&15)<<2|u>>6,f=u&63;c||(f=64,o||(d=64)),r.push(n[l],n[h],n[d],n[f])}return r.join("")},encodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(t):this.encodeByteArray(M_(t),e)},decodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(t):R0(this.decodeStringToByteArray(t,e))},decodeStringToByteArray(t,e){this.init_();const n=e?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let i=0;i<t.length;){const s=n[t.charAt(i++)],a=i<t.length?n[t.charAt(i)]:0;++i;const u=i<t.length?n[t.charAt(i)]:64;++i;const h=i<t.length?n[t.charAt(i)]:64;if(++i,s==null||a==null||u==null||h==null)throw new P0;const d=s<<2|a>>4;if(r.push(d),u!==64){const f=a<<4&240|u>>2;if(r.push(f),h!==64){const g=u<<6&192|h;r.push(g)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let t=0;t<this.ENCODED_VALS.length;t++)this.byteToCharMap_[t]=this.ENCODED_VALS.charAt(t),this.charToByteMap_[this.byteToCharMap_[t]]=t,this.byteToCharMapWebSafe_[t]=this.ENCODED_VALS_WEBSAFE.charAt(t),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[t]]=t,t>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(t)]=t,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(t)]=t)}}};class P0 extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const C0=function(t){const e=M_(t);return F_.encodeByteArray(e,!0)},Pa=function(t){return C0(t).replace(/\./g,"")},pl=function(t){try{return F_.decodeString(t,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wk(t){return L_(void 0,t)}function L_(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const n=e;return new Date(n.getTime());case Object:t===void 0&&(t={});break;case Array:t=[];break;default:return e}for(const n in e)!e.hasOwnProperty(n)||!x0(n)||(t[n]=L_(t[n],e[n]));return t}function x0(t){return t!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function D0(){if(typeof self!="undefined")return self;if(typeof window!="undefined")return window;if(typeof global!="undefined")return global;throw new Error("Unable to locate global object.")}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(){return typeof navigator!="undefined"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Jk(){return typeof window!="undefined"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Ws())}function B0(){var t;const e=(t=mc())===null||t===void 0?void 0:t.forceEnvironment;if(e==="node")return!0;if(e==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function Yk(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function Xk(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Zk(){const t=Ws();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function eN(){return O_.NODE_ADMIN===!0}function $0(){return!B0()&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function Ch(){try{return typeof indexedDB=="object"}catch{return!1}}function $_(){return new Promise((t,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(r),t(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var s;e(((s=i.error)===null||s===void 0?void 0:s.message)||"")}}catch(n){e(n)}})}function q0(){return!(typeof navigator=="undefined"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const U0="FirebaseError";class Xr extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=U0,Object.setPrototypeOf(this,Xr.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,gc.prototype.create)}}class gc{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},i=`${this.service}/${e}`,s=this.errors[e],o=s?j0(s,r):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new Xr(i,a,r)}}function j0(t,e){return t.replace(K0,(n,r)=>{const i=e[r];return i!=null?String(i):`<${r}?>`})}const K0=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H0{constructor(e,n){this.name=e,this.container=n,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const n=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(n)){const r=new F0;if(this.instancesDeferred.set(n,r),this.isInitialized(n)||this.shouldAutoInitialize())try{const i=this.getOrInitializeService({instanceIdentifier:n});i&&r.resolve(i)}catch{}}return this.instancesDeferred.get(n).promise}getImmediate(e){var n;const r=this.normalizeInstanceIdentifier(e==null?void 0:e.identifier),i=(n=e==null?void 0:e.optional)!==null&&n!==void 0?n:!1;if(this.isInitialized(r)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:r})}catch(s){if(i)return null;throw s}else{if(i)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(Q0(e))try{this.getOrInitializeService({instanceIdentifier:wr})}catch{}for(const[n,r]of this.instancesDeferred.entries()){const i=this.normalizeInstanceIdentifier(n);try{const s=this.getOrInitializeService({instanceIdentifier:i});r.resolve(s)}catch{}}}}clearInstance(e=wr){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(n=>"INTERNAL"in n).map(n=>n.INTERNAL.delete()),...e.filter(n=>"_delete"in n).map(n=>n._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=wr){return this.instances.has(e)}getOptions(e=wr){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:n={}}=e,r=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const i=this.getOrInitializeService({instanceIdentifier:r,options:n});for(const[s,o]of this.instancesDeferred.entries()){const a=this.normalizeInstanceIdentifier(s);r===a&&o.resolve(i)}return i}onInit(e,n){var r;const i=this.normalizeInstanceIdentifier(n),s=(r=this.onInitCallbacks.get(i))!==null&&r!==void 0?r:new Set;s.add(e),this.onInitCallbacks.set(i,s);const o=this.instances.get(i);return o&&e(o,i),()=>{s.delete(e)}}invokeOnInitCallbacks(e,n){const r=this.onInitCallbacks.get(n);if(!!r)for(const i of r)try{i(e,n)}catch{}}getOrInitializeService({instanceIdentifier:e,options:n={}}){let r=this.instances.get(e);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:W0(e),options:n}),this.instances.set(e,r),this.instancesOptions.set(e,n),this.invokeOnInitCallbacks(r,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,r)}catch{}return r||null}normalizeInstanceIdentifier(e=wr){return this.component?this.component.multipleInstances?e:wr:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function W0(t){return t===wr?void 0:t}function Q0(t){return t.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ge;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(ge||(ge={}));const Y0={debug:ge.DEBUG,verbose:ge.VERBOSE,info:ge.INFO,warn:ge.WARN,error:ge.ERROR,silent:ge.SILENT},X0=ge.INFO,Z0={[ge.DEBUG]:"log",[ge.VERBOSE]:"log",[ge.INFO]:"info",[ge.WARN]:"warn",[ge.ERROR]:"error"},eS=(t,e,...n)=>{if(e<t.logLevel)return;const r=new Date().toISOString(),i=Z0[e];if(i)console[i](`[${r}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class U_{constructor(e){this.name=e,this._logLevel=X0,this._logHandler=eS,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ge))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Y0[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ge.DEBUG,...e),this._logHandler(this,ge.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ge.VERBOSE,...e),this._logHandler(this,ge.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ge.INFO,...e),this._logHandler(this,ge.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ge.WARN,...e),this._logHandler(this,ge.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ge.ERROR,...e),this._logHandler(this,ge.ERROR,...e)}}const tS=(t,e)=>e.some(n=>t instanceof n);let Tp,bp;function nS(){return Tp||(Tp=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function rS(){return bp||(bp=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const j_=new WeakMap,ml=new WeakMap,K_=new WeakMap,yu=new WeakMap,xh=new WeakMap;function iS(t){const e=new Promise((n,r)=>{const i=()=>{t.removeEventListener("success",s),t.removeEventListener("error",o)},s=()=>{n(Gn(t.result)),i()},o=()=>{r(t.error),i()};t.addEventListener("success",s),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&j_.set(n,t)}).catch(()=>{}),xh.set(e,t),e}function sS(t){if(ml.has(t))return;const e=new Promise((n,r)=>{const i=()=>{t.removeEventListener("complete",s),t.removeEventListener("error",o),t.removeEventListener("abort",o)},s=()=>{n(),i()},o=()=>{r(t.error||new DOMException("AbortError","AbortError")),i()};t.addEventListener("complete",s),t.addEventListener("error",o),t.addEventListener("abort",o)});ml.set(t,e)}let gl={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return ml.get(t);if(e==="objectStoreNames")return t.objectStoreNames||K_.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return Gn(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function oS(t){gl=t(gl)}function aS(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const r=t.call(vu(this),e,...n);return K_.set(r,e.sort?e.sort():[e]),Gn(r)}:rS().includes(t)?function(...e){return t.apply(vu(this),e),Gn(j_.get(this))}:function(...e){return Gn(t.apply(vu(this),e))}}function cS(t){return typeof t=="function"?aS(t):(t instanceof IDBTransaction&&sS(t),tS(t,nS())?new Proxy(t,gl):t)}function Gn(t){if(t instanceof IDBRequest)return iS(t);if(yu.has(t))return yu.get(t);const e=cS(t);return e!==t&&(yu.set(t,e),xh.set(e,t)),e}const vu=t=>xh.get(t);function uS(t,e,{blocked:n,upgrade:r,blocking:i,terminated:s}={}){const o=indexedDB.open(t,e),a=Gn(o);return r&&o.addEventListener("upgradeneeded",c=>{r(Gn(o.result),c.oldVersion,c.newVersion,Gn(o.transaction),c)}),n&&o.addEventListener("blocked",c=>n(c.oldVersion,c.newVersion,c)),a.then(c=>{s&&c.addEventListener("close",()=>s()),i&&c.addEventListener("versionchange",u=>i(u.oldVersion,u.newVersion,u))}).catch(()=>{}),a}const lS=["get","getKey","getAll","getAllKeys","count"],hS=["put","add","delete","clear"],wu=new Map;function Ap(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(wu.get(e))return wu.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,i=hS.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||lS.includes(n)))return;const s=async function(o,...a){const c=this.transaction(o,i?"readwrite":"readonly");let u=c.store;return r&&(u=u.index(a.shift())),(await Promise.all([u[n](...a),i&&c.done]))[0]};return wu.set(e,s),s}oS(t=>({...t,get:(e,n,r)=>Ap(e,n)||t.get(e,n,r),has:(e,n)=>!!Ap(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dS{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(fS(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function fS(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const _l="@firebase/app",Sp="0.9.15";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lr=new U_("@firebase/app"),pS="@firebase/app-compat",mS="@firebase/analytics-compat",gS="@firebase/analytics",_S="@firebase/app-check-compat",yS="@firebase/app-check",vS="@firebase/auth",wS="@firebase/auth-compat",ES="@firebase/database",IS="@firebase/database-compat",TS="@firebase/functions",bS="@firebase/functions-compat",AS="@firebase/installations",SS="@firebase/installations-compat",RS="@firebase/messaging",PS="@firebase/messaging-compat",CS="@firebase/performance",xS="@firebase/performance-compat",DS="@firebase/remote-config",VS="@firebase/remote-config-compat",kS="@firebase/storage",NS="@firebase/storage-compat",OS="@firebase/firestore",MS="@firebase/firestore-compat",FS="firebase",LS="10.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ca="[DEFAULT]",BS={[_l]:"fire-core",[pS]:"fire-core-compat",[gS]:"fire-analytics",[mS]:"fire-analytics-compat",[yS]:"fire-app-check",[_S]:"fire-app-check-compat",[vS]:"fire-auth",[wS]:"fire-auth-compat",[ES]:"fire-rtdb",[IS]:"fire-rtdb-compat",[TS]:"fire-fn",[bS]:"fire-fn-compat",[AS]:"fire-iid",[SS]:"fire-iid-compat",[RS]:"fire-fcm",[PS]:"fire-fcm-compat",[CS]:"fire-perf",[xS]:"fire-perf-compat",[DS]:"fire-rc",[VS]:"fire-rc-compat",[kS]:"fire-gcs",[NS]:"fire-gcs-compat",[OS]:"fire-fst",[MS]:"fire-fst-compat","fire-js":"fire-js",[FS]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xa=new Map,yl=new Map;function $S(t,e){try{t.container.addComponent(e)}catch(n){Lr.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Yn(t){const e=t.name;if(yl.has(e))return Lr.debug(`There were multiple attempts to register component ${e}.`),!1;yl.set(e,t);for(const n of xa.values())$S(n,t);return!0}function Gi(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}function qS(t,e,n=Ca){Gi(t,e).clearInstance(n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const US={["no-app"]:"No Firebase App '{$appName}' has been created - call initializeApp() first",["bad-app-name"]:"Illegal App name: '{$appName}",["duplicate-app"]:"Firebase App named '{$appName}' already exists with different options or config",["app-deleted"]:"Firebase App named '{$appName}' already deleted",["no-options"]:"Need to provide options, when not being deployed to hosting via source.",["invalid-app-argument"]:"firebase.{$appName}() takes either no argument or a Firebase App instance.",["invalid-log-argument"]:"First argument to `onLog` must be null or a function.",["idb-open"]:"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.",["idb-get"]:"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.",["idb-set"]:"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.",["idb-delete"]:"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},Hn=new gc("app","Firebase",US);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KS=LS;function z_(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Ca,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw Hn.create("bad-app-name",{appName:String(i)});if(n||(n=B_()),!n)throw Hn.create("no-options");const s=xa.get(i);if(s){if(Qs(n,s.options)&&Qs(r,s.config))return s;throw Hn.create("duplicate-app",{appName:i})}const o=new J0(i);for(const c of yl.values())o.addComponent(c);const a=new jS(n,r,o);return xa.set(i,a),a}function G_(t=Ca){const e=xa.get(t);if(!e&&t===Ca&&B_())return z_();if(!e)throw Hn.create("no-app",{appName:t});return e}function cn(t,e,n){var r;let i=(r=BS[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Lr.warn(a.join(" "));return}Yn(new wn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const WS=1024,QS=30*24*60*60*1e3;class JS{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new XS(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=Pp();if(this._heartbeatsCache===null&&(this._heartbeatsCache=await this._heartbeatsCachePromise),!(this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(i=>i.date===r)))return this._heartbeatsCache.heartbeats.push({date:r,agent:n}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(i=>{const s=new Date(i.date).valueOf();return Date.now()-s<=QS}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache===null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Pp(),{heartbeatsToSend:n,unsentEntries:r}=YS(this._heartbeatsCache.heartbeats),i=Pa(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function Pp(){return new Date().toISOString().substring(0,10)}function YS(t,e=WS){const n=[];let r=t.slice();for(const i of t){const s=n.find(o=>o.agent===i.agent);if(s){if(s.dates.push(i.date),Cp(n)>e){s.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),Cp(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class XS{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Ch()?$_().then(()=>!0).catch(()=>!1):!1}async read(){return await this._canUseIndexedDBPromise?await HS(this.app)||{heartbeats:[]}:{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return Rp(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return Rp(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function Cp(t){return Pa(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZS(t){Yn(new wn("platform-logger",e=>new dS(e),"PRIVATE")),Yn(new wn("heartbeat",e=>new JS(e),"PRIVATE")),cn(_l,Sp,t),cn(_l,Sp,"esm2017"),cn("fire-js","")}ZS("");var eR="firebase",tR="10.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function q(t="Unexpected state"){const e=`FIRESTORE (${Qi}) INTERNAL ASSERTION FAILED: `+t;throw $e(e),new Error(e)}function G(t,e){t||q()}function lP(t,e){t||q()}function M(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yy{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class Xy{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(Xe.UNAUTHENTICATED))}shutdown(){}}class hP{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class dP{constructor(e){this.t=e,this.currentUser=Xe.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){let r=this.i;const i=c=>this.i!==r?(r=this.i,n(c)):Promise.resolve();let s=new Je;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new Je,e.enqueueRetryable(()=>i(this.currentUser))};const o=()=>{const c=s;e.enqueueRetryable(async()=>{await c.promise,await i(this.currentUser)})},a=c=>{P("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=c,this.auth.addAuthTokenListener(this.o),o()};this.t.onInit(c=>a(c)),setTimeout(()=>{if(!this.auth){const c=this.t.getImmediate({optional:!0});c?a(c):(P("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new Je)}},0),o()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(r=>this.i!==e?(P("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(G(typeof r.accessToken=="string"),new Yy(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return G(e===null||typeof e=="string"),new Xe(e)}}class fP{constructor(e,n,r){this.l=e,this.h=n,this.P=r,this.type="FirstParty",this.user=Xe.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class pP{constructor(e,n,r){this.l=e,this.h=n,this.P=r}getToken(){return Promise.resolve(new fP(this.l,this.h,this.P))}start(e,n){e.enqueueRetryable(()=>n(Xe.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Zy{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class mP{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,n){const r=s=>{s.error!=null&&P("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${s.error.message}`);const o=s.token!==this.R;return this.R=s.token,P("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?n(s.token):Promise.resolve()};this.o=s=>{e.enqueueRetryable(()=>r(s))};const i=s=>{P("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=s,this.appCheck.addTokenListener(this.o)};this.A.onInit(s=>i(s)),setTimeout(()=>{if(!this.appCheck){const s=this.A.getImmediate({optional:!0});s?i(s):P("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(G(typeof n.token=="string"),this.R=n.token,new Zy(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}class gP{getToken(){return Promise.resolve(new Zy(""))}invalidateToken(){}start(e,n){}shutdown(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _P(t){const e=typeof self!="undefined"&&(self.crypto||self.msCrypto),n=new Uint8Array(t);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(n);else for(let r=0;r<t;r++)n[r]=Math.floor(256*Math.random());return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class La{constructor(e,n,r,i){this.indexId=e,this.collectionGroup=n,this.fields=r,this.indexState=i}}function Vl(t){return t.fields.find(e=>e.kind===2)}function Er(t){return t.fields.filter(e=>e.kind!==2)}function vP(t,e){let n=ee(t.collectionGroup,e.collectionGroup);if(n!==0)return n;for(let r=0;r<Math.min(t.fields.length,e.fields.length);++r)if(n=wP(t.fields[r],e.fields[r]),n!==0)return n;return ee(t.fields.length,e.fields.length)}La.UNKNOWN_ID=-1;class da{constructor(e,n){this.fieldPath=e,this.kind=n}}function wP(t,e){const n=Me.comparator(t.fieldPath,e.fieldPath);return n!==0?n:ee(t.kind,e.kind)}class oo{constructor(e,n){this.sequenceNumber=e,this.offset=n}static empty(){return new oo(0,Vt.min())}}function nv(t,e){const n=t.toTimestamp().seconds,r=t.toTimestamp().nanoseconds+1,i=H.fromTimestamp(r===1e9?new Ne(n+1,0):new Ne(n,r));return new Vt(i,N.empty(),e)}function rv(t){return new Vt(t.readTime,t.key,-1)}class Vt{constructor(e,n,r){this.readTime=e,this.documentKey=n,this.largestBatchId=r}static min(){return new Vt(H.min(),N.empty(),-1)}static max(){return new Vt(H.max(),N.empty(),-1)}}function ed(t,e){let n=t.readTime.compareTo(e.readTime);return n!==0?n:(n=N.comparator(t.documentKey,e.documentKey),n!==0?n:ee(t.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gt(t){let e="";for(let n=0;n<t.length;n++)e.length>0&&(e=Gp(e)),e=AP(t.get(n),e);return Gp(e)}function AP(t,e){let n=e;const r=t.length;for(let i=0;i<r;i++){const s=t.charAt(i);switch(s){case"\0":n+="";break;case"":n+="";break;default:n+=s}}return n}function Gp(t){return t+""}function sn(t){const e=t.length;if(G(e>=2),e===2)return G(t.charAt(0)===""&&t.charAt(1)===""),de.emptyPath();const n=e-2,r=[];let i="";for(let s=0;s<e;){const o=t.indexOf("",s);switch((o<0||o>n)&&q(),t.charAt(o+1)){case"":const a=t.substring(s,o);let c;i.length===0?c=a:(i+=a,c=i,i=""),r.push(c);break;case"":i+=t.substring(s,o),i+="\0";break;case"":i+=t.substring(s,o+1);break;default:q()}s=o+2}return new de(r)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fa(t,e){return[t,gt(e)]}function av(t,e,n){return[t,gt(e),n]}const SP={},RP=["prefixPath","collectionGroup","readTime","documentId"],PP=["prefixPath","collectionGroup","documentId"],CP=["collectionGroup","readTime","prefixPath","documentId"],xP=["canonicalId","targetId"],DP=["targetId","path"],VP=["path","targetId"],kP=["collectionId","parent"],NP=["indexId","uid"],OP=["uid","sequenceNumber"],MP=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],FP=["indexId","uid","orderedDocumentKey"],LP=["userId","collectionPath","documentId"],BP=["userId","collectionPath","largestBatchId"],$P=["userId","collectionGroup","largestBatchId"],cv=["mutationQueues","mutations","documentMutations","remoteDocuments","targets","owner","targetGlobal","targetDocuments","clientMetadata","remoteDocumentGlobal","collectionParents","bundles","namedQueries"],qP=[...cv,"documentOverlays"],uv=["mutationQueues","mutations","documentMutations","remoteDocumentsV14","targets","owner","targetGlobal","targetDocuments","clientMetadata","remoteDocumentGlobal","collectionParents","bundles","namedQueries","documentOverlays"],lv=uv,UP=[...lv,"indexConfiguration","indexState","indexEntries"];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jP(){return typeof atob!="undefined"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class We{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(i){try{return atob(i)}catch(s){throw typeof DOMException!="undefined"&&s instanceof DOMException?new dv("Invalid base64 string: "+s):s}}(e);return new We(n)}static fromUint8Array(e){const n=function(i){let s="";for(let o=0;o<i.length;++o)s+=String.fromCharCode(i[o]);return s}(e);return new We(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const r=new Uint8Array(n.length);for(let i=0;i<n.length;i++)r[i]=n.charCodeAt(i);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return ee(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}We.EMPTY_BYTE_STRING=new We("");const KP=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Zn(t){if(G(!!t),typeof t=="string"){let e=0;const n=KP.exec(t);if(G(!!n),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),e=Number(i)}const r=new Date(t);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:Oe(t.seconds),nanos:Oe(t.nanos)}}function Oe(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function In(t){return typeof t=="string"?We.fromBase64String(t):We.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ii{constructor(e,n="asc"){this.field=e,this.dir=n}}function WP(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tC{constructor(e,n=null,r=[],i=[],s=null,o=null,a=null){this.path=e,this.collectionGroup=n,this.orderBy=r,this.filters=i,this.limit=s,this.startAt=o,this.endAt=a,this.he=null}}function Ll(t,e=null,n=[],r=[],i=null,s=null,o=null){return new tC(t,e,n,r,i,s,o)}function $r(t){const e=M(t);if(e.he===null){let n=e.path.canonicalString();e.collectionGroup!==null&&(n+="|cg:"+e.collectionGroup),n+="|f:",n+=e.filters.map(r=>Fl(r)).join(","),n+="|ob:",n+=e.orderBy.map(r=>function(s){return s.field.canonicalString()+s.dir}(r)).join(","),Co(e.limit)||(n+="|l:",n+=e.limit),e.startAt&&(n+="|lb:",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(r=>Di(r)).join(",")),e.endAt&&(n+="|ub:",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(r=>Di(r)).join(",")),e.he=n}return e.he}function xo(t,e){if(t.limit!==e.limit||t.orderBy.length!==e.orderBy.length)return!1;for(let n=0;n<t.orderBy.length;n++)if(!WP(t.orderBy[n],e.orderBy[n]))return!1;if(t.filters.length!==e.filters.length)return!1;for(let n=0;n<t.filters.length;n++)if(!_v(t.filters[n],e.filters[n]))return!1;return t.collectionGroup===e.collectionGroup&&!!t.path.isEqual(e.path)&&!!nm(t.startAt,e.startAt)&&nm(t.endAt,e.endAt)}function Ba(t){return N.isDocumentKey(t.path)&&t.collectionGroup===null&&t.filters.length===0}function $a(t,e){return t.filters.filter(n=>n instanceof ce&&n.field.isEqual(e))}function rm(t,e,n){let r=pa,i=!0;for(const s of $a(t,e)){let o=pa,a=!0;switch(s.op){case"<":case"<=":o=GP(s.value);break;case"==":case"in":case">=":o=s.value;break;case">":o=s.value,a=!1;break;case"!=":case"not-in":o=pa}Zp({value:r,inclusive:i},{value:o,inclusive:a})<0&&(r=o,i=a)}if(n!==null){for(let s=0;s<t.orderBy.length;++s)if(t.orderBy[s].field.isEqual(e)){const o=n.position[s];Zp({value:r,inclusive:i},{value:o,inclusive:n.inclusive})<0&&(r=o,i=n.inclusive);break}}return{value:r,inclusive:i}}function im(t,e,n){let r=qn,i=!0;for(const s of $a(t,e)){let o=qn,a=!0;switch(s.op){case">=":case">":o=HP(s.value),a=!1;break;case"==":case"in":case"<=":o=s.value;break;case"<":o=s.value,a=!1;break;case"!=":case"not-in":o=qn}em({value:r,inclusive:i},{value:o,inclusive:a})>0&&(r=o,i=a)}if(n!==null){for(let s=0;s<t.orderBy.length;++s)if(t.orderBy[s].field.isEqual(e)){const o=n.position[s];em({value:r,inclusive:i},{value:o,inclusive:n.inclusive})>0&&(r=o,i=n.inclusive);break}}return{value:r,inclusive:i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rC=new Se(N.comparator);function St(){return rC}const Sv=new Se(N.comparator);function Is(...t){let e=Sv;for(const n of t)e=e.insert(n.key,n);return e}function Rv(t){let e=Sv;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function on(){return Ns()}function Pv(){return Ns()}function Ns(){return new An(t=>t.toString(),(t,e)=>t.isEqual(e))}const iC=new Se(N.comparator),sC=new De(N.comparator);function ie(...t){let e=sC;for(const n of t)e=e.add(n);return e}const oC=new De(ee);function sd(){return oC}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fC{constructor(e,n,r){this.alias=e,this.Ee=n,this.fieldPath=r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rr{constructor(){}Pt(e,n){this.It(e,n),n.Tt()}It(e,n){if("nullValue"in e)this.Et(n,5);else if("booleanValue"in e)this.Et(n,10),n.dt(e.booleanValue?1:0);else if("integerValue"in e)this.Et(n,15),n.dt(Oe(e.integerValue));else if("doubleValue"in e){const r=Oe(e.doubleValue);isNaN(r)?this.Et(n,13):(this.Et(n,15),ao(r)?n.dt(0):n.dt(r))}else if("timestampValue"in e){const r=e.timestampValue;this.Et(n,20),typeof r=="string"?n.At(r):(n.At(`${r.seconds||""}`),n.dt(r.nanos||0))}else if("stringValue"in e)this.Rt(e.stringValue,n),this.Vt(n);else if("bytesValue"in e)this.Et(n,30),n.ft(In(e.bytesValue)),this.Vt(n);else if("referenceValue"in e)this.gt(e.referenceValue,n);else if("geoPointValue"in e){const r=e.geoPointValue;this.Et(n,45),n.dt(r.latitude||0),n.dt(r.longitude||0)}else"mapValue"in e?fv(e)?this.Et(n,Number.MAX_SAFE_INTEGER):(this.yt(e.mapValue,n),this.Vt(n)):"arrayValue"in e?(this.wt(e.arrayValue,n),this.Vt(n)):q()}Rt(e,n){this.Et(n,25),this.St(e,n)}St(e,n){n.At(e)}yt(e,n){const r=e.fields||{};this.Et(n,55);for(const i of Object.keys(r))this.Rt(i,n),this.It(r[i],n)}wt(e,n){const r=e.values||[];this.Et(n,50);for(const i of r)this.It(i,n)}gt(e,n){this.Et(n,37),N.fromName(e).path.forEach(r=>{this.Et(n,60),this.St(r,n)})}Et(e,n){e.dt(n)}Vt(e){e.dt(2)}}Rr.bt=new Rr;function VC(t){if(t===0)return 8;let e=0;return t>>4==0&&(e+=4,t<<=4),t>>6==0&&(e+=2,t<<=2),t>>7==0&&(e+=1),e}function Em(t){const e=64-function(r){let i=0;for(let s=0;s<8;++s){const o=VC(255&r[s]);if(i+=o,o!==8)break}return i}(t);return Math.ceil(e/8)}class kC{constructor(){this.buffer=new Uint8Array(1024),this.position=0}Dt(e){const n=e[Symbol.iterator]();let r=n.next();for(;!r.done;)this.vt(r.value),r=n.next();this.Ct()}Ft(e){const n=e[Symbol.iterator]();let r=n.next();for(;!r.done;)this.Mt(r.value),r=n.next();this.xt()}Ot(e){for(const n of e){const r=n.charCodeAt(0);if(r<128)this.vt(r);else if(r<2048)this.vt(960|r>>>6),this.vt(128|63&r);else if(n<"\uD800"||"\uDBFF"<n)this.vt(480|r>>>12),this.vt(128|63&r>>>6),this.vt(128|63&r);else{const i=n.codePointAt(0);this.vt(240|i>>>18),this.vt(128|63&i>>>12),this.vt(128|63&i>>>6),this.vt(128|63&i)}}this.Ct()}Nt(e){for(const n of e){const r=n.charCodeAt(0);if(r<128)this.Mt(r);else if(r<2048)this.Mt(960|r>>>6),this.Mt(128|63&r);else if(n<"\uD800"||"\uDBFF"<n)this.Mt(480|r>>>12),this.Mt(128|63&r>>>6),this.Mt(128|63&r);else{const i=n.codePointAt(0);this.Mt(240|i>>>18),this.Mt(128|63&i>>>12),this.Mt(128|63&i>>>6),this.Mt(128|63&i)}}this.xt()}Bt(e){const n=this.Lt(e),r=Em(n);this.kt(1+r),this.buffer[this.position++]=255&r;for(let i=n.length-r;i<n.length;++i)this.buffer[this.position++]=255&n[i]}qt(e){const n=this.Lt(e),r=Em(n);this.kt(1+r),this.buffer[this.position++]=~(255&r);for(let i=n.length-r;i<n.length;++i)this.buffer[this.position++]=~(255&n[i])}Qt(){this.Kt(255),this.Kt(255)}$t(){this.Ut(255),this.Ut(255)}reset(){this.position=0}seed(e){this.kt(e.length),this.buffer.set(e,this.position),this.position+=e.length}Wt(){return this.buffer.slice(0,this.position)}Lt(e){const n=function(s){const o=new DataView(new ArrayBuffer(8));return o.setFloat64(0,s,!1),new Uint8Array(o.buffer)}(e),r=(128&n[0])!=0;n[0]^=r?255:128;for(let i=1;i<n.length;++i)n[i]^=r?255:0;return n}vt(e){const n=255&e;n===0?(this.Kt(0),this.Kt(255)):n===255?(this.Kt(255),this.Kt(0)):this.Kt(n)}Mt(e){const n=255&e;n===0?(this.Ut(0),this.Ut(255)):n===255?(this.Ut(255),this.Ut(0)):this.Ut(e)}Ct(){this.Kt(0),this.Kt(1)}xt(){this.Ut(0),this.Ut(1)}Kt(e){this.kt(1),this.buffer[this.position++]=e}Ut(e){this.kt(1),this.buffer[this.position++]=~e}kt(e){const n=e+this.position;if(n<=this.buffer.length)return;let r=2*this.buffer.length;r<n&&(r=n);const i=new Uint8Array(r);i.set(this.buffer),this.buffer=i}}class NC{constructor(e){this.Gt=e}ft(e){this.Gt.Dt(e)}At(e){this.Gt.Ot(e)}dt(e){this.Gt.Bt(e)}Tt(){this.Gt.Qt()}}class OC{constructor(e){this.Gt=e}ft(e){this.Gt.Ft(e)}At(e){this.Gt.Nt(e)}dt(e){this.Gt.qt(e)}Tt(){this.Gt.$t()}}class fs{constructor(){this.Gt=new kC,this.zt=new NC(this.Gt),this.jt=new OC(this.Gt)}seed(e){this.Gt.seed(e)}Ht(e){return e===0?this.zt:this.jt}Wt(){return this.Gt.Wt()}reset(){this.Gt.reset()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mo(t){return new wC(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gx{constructor(e,n,r,i,s){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.g_=[],this.p_=new Map,this.y_=new Set,this.w_=[],this.S_=s,this.S_.Ys(o=>{r.enqueueAndForget(async()=>{hr(this)&&(P("RemoteStore","Restarting streams for network reachability change."),await async function(c){const u=M(c);u.y_.add(4),await Zi(u),u.b_.set("Unknown"),u.y_.delete(4),await Fo(u)}(this))})}),this.b_=new mx(r,i)}}async function Fo(t){if(hr(t))for(const e of t.w_)await e(!0)}async function Zi(t){for(const e of t.w_)await e(!1)}function Uc(t,e){const n=M(t);n.p_.has(e.targetId)||(n.p_.set(e.targetId,e),Ad(n)?bd(n):ts(n).Uo()&&Td(n,e))}function mo(t,e){const n=M(t),r=ts(n);n.p_.delete(e),r.Uo()&&Iw(n,e),n.p_.size===0&&(r.Uo()?r.zo():hr(n)&&n.b_.set("Unknown"))}function Td(t,e){if(t.D_.Be(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(H.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}ts(t).i_(e)}function Iw(t,e){t.D_.Be(e),ts(t).s_(e)}function bd(t){t.D_=new gC({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),ut:e=>t.p_.get(e)||null,rt:()=>t.datastore.serializer.databaseId}),ts(t).start(),t.b_.A_()}function Ad(t){return hr(t)&&!ts(t).$o()&&t.p_.size>0}function hr(t){return M(t).y_.size===0}function Tw(t){t.D_=void 0}async function _x(t){t.p_.forEach((e,n)=>{Td(t,e)})}async function yx(t,e){Tw(t),Ad(t)?(t.b_.m_(e),bd(t)):t.b_.set("Unknown")}async function vx(t,e,n){if(t.b_.set("Online"),e instanceof Uv&&e.state===2&&e.cause)try{await async function(i,s){const o=s.cause;for(const a of s.targetIds)i.p_.has(a)&&(await i.remoteSyncer.rejectListen(a,o),i.p_.delete(a),i.D_.removeTarget(a))}(t,e)}catch(r){P("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Qa(t,r)}else if(e instanceof ya?t.D_.We(e):e instanceof qv?t.D_.Ze(e):t.D_.je(e),!n.isEqual(H.min()))try{const r=await pw(t.localStore);n.compareTo(r)>=0&&await function(s,o){const a=s.D_.st(o);return a.targetChanges.forEach((c,u)=>{if(c.resumeToken.approximateByteSize()>0){const l=s.p_.get(u);l&&s.p_.set(u,l.withResumeToken(c.resumeToken,o))}}),a.targetMismatches.forEach((c,u)=>{const l=s.p_.get(c);if(!l)return;s.p_.set(c,l.withResumeToken(We.EMPTY_BYTE_STRING,l.snapshotVersion)),Iw(s,c);const h=new _n(l.target,c,u,l.sequenceNumber);Td(s,h)}),s.remoteSyncer.applyRemoteEvent(a)}(t,n)}catch(r){P("RemoteStore","Failed to raise snapshot:",r),await Qa(t,r)}}async function Qa(t,e,n){if(!ur(e))throw e;t.y_.add(1),await Zi(t),t.b_.set("Offline"),n||(n=()=>pw(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{P("RemoteStore","Retrying IndexedDB access"),await n(),t.y_.delete(1),await Fo(t)})}function bw(t,e){return e().catch(n=>Qa(t,n,e))}async function es(t){const e=M(t),n=ir(e);let r=e.g_.length>0?e.g_[e.g_.length-1].batchId:-1;for(;wx(e);)try{const i=await ix(e.localStore,r);if(i===null){e.g_.length===0&&n.zo();break}r=i.batchId,Ex(e,i)}catch(i){await Qa(e,i)}Aw(e)&&Sw(e)}function wx(t){return hr(t)&&t.g_.length<10}function Ex(t,e){t.g_.push(e);const n=ir(t);n.Uo()&&n.__&&n.a_(e.mutations)}function Aw(t){return hr(t)&&!ir(t).$o()&&t.g_.length>0}function Sw(t){ir(t).start()}async function Ix(t){ir(t).l_()}async function Tx(t){const e=ir(t);for(const n of t.g_)e.a_(n.mutations)}async function bx(t,e,n){const r=t.g_.shift(),i=cd.from(r,e,n);await bw(t,()=>t.remoteSyncer.applySuccessfulWrite(i)),await es(t)}async function Ax(t,e){e&&ir(t).__&&await async function(r,i){if(function(o){return Lv(o)&&o!==w.ABORTED}(i.code)){const s=r.g_.shift();ir(r).Go(),await bw(r,()=>r.remoteSyncer.rejectFailedWrite(s.batchId,i)),await es(r)}}(t,e),Aw(t)&&Sw(t)}async function Mm(t,e){const n=M(t);n.asyncQueue.verifyOperationInProgress(),P("RemoteStore","RemoteStore received new credentials");const r=hr(n);n.y_.add(3),await Zi(n),r&&n.b_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.y_.delete(3),await Fo(n)}async function Wl(t,e){const n=M(t);e?(n.y_.delete(2),await Fo(n)):e||(n.y_.add(2),await Zi(n),n.b_.set("Unknown"))}function ts(t){return t.v_||(t.v_=function(n,r,i){const s=M(n);return s.P_(),new hx(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(t.datastore,t.asyncQueue,{_o:_x.bind(null,t),uo:yx.bind(null,t),r_:vx.bind(null,t)}),t.w_.push(async e=>{e?(t.v_.Go(),Ad(t)?bd(t):t.b_.set("Unknown")):(await t.v_.stop(),Tw(t))})),t.v_}function ir(t){return t.C_||(t.C_=function(n,r,i){const s=M(n);return s.P_(),new dx(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(t.datastore,t.asyncQueue,{_o:Ix.bind(null,t),uo:Ax.bind(null,t),c_:Tx.bind(null,t),u_:bx.bind(null,t)}),t.w_.push(async e=>{e?(t.C_.Go(),await es(t)):(await t.C_.stop(),t.g_.length>0&&(P("RemoteStore",`Stopping write stream with ${t.g_.length} pending writes`),t.g_=[]))})),t.C_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sx{constructor(){this.x_=void 0,this.listeners=[]}}class Rx{constructor(){this.queries=new An(e=>Tv(e),Do),this.onlineState="Unknown",this.O_=new Set}}async function Rd(t,e){const n=M(t),r=e.query;let i=!1,s=n.queries.get(r);if(s||(i=!0,s=new Sx),i)try{s.x_=await n.onListen(r)}catch(o){const a=ns(o,`Initialization of query '${$l(e.query)}' failed`);return void e.onError(a)}n.queries.set(r,s),s.listeners.push(e),e.N_(n.onlineState),s.x_&&e.B_(s.x_)&&Cd(n)}async function Pd(t,e){const n=M(t),r=e.query;let i=!1;const s=n.queries.get(r);if(s){const o=s.listeners.indexOf(e);o>=0&&(s.listeners.splice(o,1),i=s.listeners.length===0)}if(i)return n.queries.delete(r),n.onUnlisten(r)}function Px(t,e){const n=M(t);let r=!1;for(const i of e){const s=i.query,o=n.queries.get(s);if(o){for(const a of o.listeners)a.B_(i)&&(r=!0);o.x_=i}}r&&Cd(n)}function Cx(t,e,n){const r=M(t),i=r.queries.get(e);if(i)for(const s of i.listeners)s.onError(n);r.queries.delete(e)}function Cd(t){t.O_.forEach(e=>{e.next()})}class xd{constructor(e,n,r){this.query=e,this.L_=n,this.k_=!1,this.q_=null,this.onlineState="Unknown",this.options=r||{}}B_(e){if(!this.options.includeMetadataChanges){const r=[];for(const i of e.docChanges)i.type!==3&&r.push(i);e=new Li(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let n=!1;return this.k_?this.Q_(e)&&(this.L_.next(e),n=!0):this.K_(e,this.onlineState)&&(this.U_(e),n=!0),this.q_=e,n}onError(e){this.L_.error(e)}N_(e){this.onlineState=e;let n=!1;return this.q_&&!this.k_&&this.K_(this.q_,e)&&(this.U_(this.q_),n=!0),n}K_(e,n){if(!e.fromCache)return!0;const r=n!=="Offline";return(!this.options.W_||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||n==="Offline")}Q_(e){if(e.docChanges.length>0)return!0;const n=this.q_&&this.q_.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}U_(e){e=Li.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.k_=!0,this.L_.next(e)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xx{constructor(e,n){this.G_=e,this.byteLength=n}z_(){return"metadata"in this.G_}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mD=-1;class Re extends Lo{constructor(e,n,r,i){super(e,n,r,i),this.type="firestore",this._queue=function(){return new pD}(),this._persistenceKey=(i==null?void 0:i.name)||"[DEFAULT]"}_terminate(){return this._firestoreClient||Qw(this),this._firestoreClient.terminate()}}function gD(t,e,n){n||(n="(default)");const r=Gi(t,"firestore");if(r.isInitialized(n)){const i=r.getImmediate({identifier:n}),s=r.getOptions(n);if(Qs(s,e))return i;throw new A(w.FAILED_PRECONDITION,"initializeFirestore() has already been called with different options. To avoid this error, call initializeFirestore() with the same options as when it was originally called, or call getFirestore() to return the already initialized instance.")}if(e.cacheSizeBytes!==void 0&&e.localCache!==void 0)throw new A(w.INVALID_ARGUMENT,"cache and cacheSizeBytes cannot be specified at the same time as cacheSizeBytes willbe deprecated. Instead, specify the cache size in the cache object");if(e.cacheSizeBytes!==void 0&&e.cacheSizeBytes!==-1&&e.cacheSizeBytes<1048576)throw new A(w.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");return r.initialize({options:e,instanceIdentifier:n})}function Ww(t,e){const n=typeof t=="object"?t:G_(),r=typeof t=="string"?t:e||"(default)",i=Gi(n,"firestore").getImmediate({identifier:r});if(!i._initialized){const s=M0("firestore");s&&Kw(i,...s)}return i}function je(t){return t._firestoreClient||Qw(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient}function Qw(t){var e,n,r;const i=t._freezeSettings(),s=function(a,c,u,l){return new zP(a,c,u,l.host,l.ssl,l.experimentalForceLongPolling,l.experimentalAutoDetectLongPolling,qw(l.experimentalLongPollingOptions),l.useFetchStreams)}(t._databaseId,((e=t._app)===null||e===void 0?void 0:e.options.appId)||"",t._persistenceKey,i);t._firestoreClient=new rD(t._authCredentials,t._appCheckCredentials,t._queue,s),((n=i.localCache)===null||n===void 0?void 0:n._offlineComponentProvider)&&((r=i.localCache)===null||r===void 0?void 0:r._onlineComponentProvider)&&(t._firestoreClient._uninitializedComponentsProvider={_offlineKind:i.localCache.kind,_offline:i.localCache._offlineComponentProvider,_online:i.localCache._onlineComponentProvider})}function _D(t,e){Yw(t=ue(t,Re));const n=je(t);if(n._uninitializedComponentsProvider)throw new A(w.FAILED_PRECONDITION,"SDK cache is already specified.");Lt("enableIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const r=t._freezeSettings(),i=new rs;return Jw(n,i,new Fd(i,r.cacheSizeBytes,e==null?void 0:e.forceOwnership))}function yD(t){Yw(t=ue(t,Re));const e=je(t);if(e._uninitializedComponentsProvider)throw new A(w.FAILED_PRECONDITION,"SDK cache is already specified.");Lt("enableMultiTabIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const n=t._freezeSettings(),r=new rs;return Jw(e,r,new Nw(r,n.cacheSizeBytes))}function Jw(t,e,n){const r=new Je;return t.asyncQueue.enqueue(async()=>{try{await wa(t,n),await Jl(t,e),r.resolve()}catch(i){const s=i;if(!Ow(s))throw s;Lt("Error enabling indexeddb cache. Falling back to memory cache: "+s),r.reject(s)}}).then(()=>r.promise)}function vD(t){if(t._initialized&&!t._terminated)throw new A(w.FAILED_PRECONDITION,"Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");const e=new Je;return t._queue.enqueueAndForgetEvenWhileRestricted(async()=>{try{await async function(r){if(!jt.v())return Promise.resolve();const i=r+"main";await jt.delete(i)}(vd(t._databaseId,t._persistenceKey)),e.resolve()}catch(n){e.reject(n)}}),e.promise}function wD(t){return function(n){const r=new Je;return n.asyncQueue.enqueueAndForget(async()=>qx(await Bd(n),r)),r.promise}(je(t=ue(t,Re)))}function ED(t){return iD(je(t=ue(t,Re)))}function ID(t){return sD(je(t=ue(t,Re)))}function TD(t){return qS(t.app,"firestore",t._databaseId.database),t._delete()}function bD(t,e){const n=je(t=ue(t,Re)),r=new Hw;return uD(n,t._databaseId,e,r),r}function AD(t,e){return lD(je(t=ue(t,Re)),e).then(n=>n?new et(t,null,n.query):null)}function Yw(t){if(t._initialized||t._terminated)throw new A(w.FAILED_PRECONDITION,"Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dr{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new A(w.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Me(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}function SD(){return new dr("__name__")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zc(t,e,n){let r;return r=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,r}class GD extends Hd{constructor(e){super(),this.firestore=e}convertBytes(e){return new sr(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Fe(this.firestore,null,n)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function HD(t){return new Ui("sum",go("sum",t))}function WD(t){return new Ui("avg",go("average",t))}function hE(){return new Ui("count")}function QD(t,e){var n,r;return t instanceof Ui&&e instanceof Ui&&t._aggregateType===e._aggregateType&&((n=t._internalFieldPath)===null||n===void 0?void 0:n.canonicalString())===((r=e._internalFieldPath)===null||r===void 0?void 0:r.canonicalString())}function JD(t,e){return qd(t.query,e.query)&&Qs(t.data(),e.data())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZD(t){t=ue(t,Fe);const e=ue(t.firestore,Re);return Bw(je(e),t._key).then(n=>Wd(e,t,n))}class pr extends Hd{constructor(e){super(),this.firestore=e}convertBytes(e){return new sr(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Fe(this.firestore,null,n)}}function eV(t){t=ue(t,Fe);const e=ue(t.firestore,Re),n=je(e),r=new pr(e);return oD(n,t._key).then(i=>new Gr(e,r,t._key,i,new Un(i!==null&&i.hasLocalMutations,!0),t.converter))}function tV(t){t=ue(t,Fe);const e=ue(t.firestore,Re);return Bw(je(e),t._key,{source:"server"}).then(n=>Wd(e,t,n))}function nV(t){t=ue(t,et);const e=ue(t.firestore,Re),n=je(e),r=new pr(e);return oE(t._query),$w(n,t._query).then(i=>new Hr(e,r,t,i))}function rV(t){t=ue(t,et);const e=ue(t.firestore,Re),n=je(e),r=new pr(e);return aD(n,t._query).then(i=>new Hr(e,r,t,i))}function iV(t){t=ue(t,et);const e=ue(t.firestore,Re),n=je(e),r=new pr(e);return $w(n,t._query,{source:"server"}).then(i=>new Hr(e,r,t,i))}function sV(t,e,n){t=ue(t,Fe);const r=ue(t.firestore,Re),i=Zc(t.converter,e,n);return os(r,[Qc(ei(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,ke.none())])}function oV(t,e,n,...r){t=ue(t,Fe);const i=ue(t.firestore,Re),s=ei(i);let o;return o=typeof(e=Le(e))=="string"||e instanceof dr?Kd(s,"updateDoc",t._key,e,n,r):jd(s,"updateDoc",t._key,e),os(i,[o.toMutation(t._key,ke.exists(!0))])}function aV(t){return os(ue(t.firestore,Re),[new Xi(t._key,ke.none())])}function cV(t,e){const n=ue(t.firestore,Re),r=Gw(t),i=Zc(t.converter,e);return os(n,[Qc(ei(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,ke.exists(!1))]).then(()=>r)}function uV(t,...e){var n,r,i;t=Le(t);let s={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||Yl(e[o])||(s=e[o],o++);const a={includeMetadataChanges:s.includeMetadataChanges};if(Yl(e[o])){const h=e[o];e[o]=(n=h.next)===null||n===void 0?void 0:n.bind(h),e[o+1]=(r=h.error)===null||r===void 0?void 0:r.bind(h),e[o+2]=(i=h.complete)===null||i===void 0?void 0:i.bind(h)}let c,u,l;if(t instanceof Fe)u=ue(t.firestore,Re),l=Ji(t._key.path),c={next:h=>{e[o]&&e[o](Wd(u,t,h))},error:e[o+1],complete:e[o+2]};else{const h=ue(t,et);u=ue(h.firestore,Re),l=h._query;const d=new pr(u);c={next:f=>{e[o]&&e[o](new Hr(u,d,h,f))},error:e[o+1],complete:e[o+2]},oE(t._query)}return function(d,f,g,v){const E=new jc(v),b=new xd(f,E,g);return d.asyncQueue.enqueueAndForget(async()=>Rd(await qi(d),b)),()=>{E.Ca(),d.asyncQueue.enqueueAndForget(async()=>Pd(await qi(d),b))}}(je(u),l,a,c)}function lV(t,e){return cD(je(t=ue(t,Re)),Yl(e)?e:{next:e})}function os(t,e){return function(r,i){const s=new Je;return r.asyncQueue.enqueueAndForget(async()=>Fx(await Bd(r),i,s)),s.promise}(je(t),e)}function Wd(t,e,n){const r=n.docs.get(e._key),i=new pr(t);return new Gr(t,i,e._key,r,new Un(n.hasPendingWrites,n.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hV(t){return dE(t,{count:hE()})}function dE(t,e){const n=ue(t.firestore,Re),r=je(n),i=function(o,a){const c=[];for(const u in o)Object.prototype.hasOwnProperty.call(o,u)&&c.push(a(o[u],u,o));return c}(e,(s,o)=>new fC(o,s._aggregateType,s._internalFieldPath));return function(o,a,c){const u=new Je;return o.asyncQueue.enqueueAndForget(async()=>{try{const l=await Lw(o);u.resolve(px(l,a,c))}catch(l){u.reject(l)}}),u.promise}(r,t._query,i).then(s=>function(a,c,u){const l=new pr(a);return new Xw(c,l,u)}(n,t,s))}class dV{constructor(e){this.kind="memory",this._onlineComponentProvider=new rs,e!=null&&e.garbageCollector?this._offlineComponentProvider=e.garbageCollector._offlineComponentProvider:this._offlineComponentProvider=new $i}toJSON(){return{kind:this.kind}}}class fV{constructor(e){let n;this.kind="persistent",e!=null&&e.tabManager?(e.tabManager._initialize(e),n=e.tabManager):(n=fE(void 0),n._initialize(e)),this._onlineComponentProvider=n._onlineComponentProvider,this._offlineComponentProvider=n._offlineComponentProvider}toJSON(){return{kind:this.kind}}}class pV{constructor(){this.kind="memoryEager",this._offlineComponentProvider=new $i}toJSON(){return{kind:this.kind}}}class mV{constructor(e){this.kind="memoryLru",this._offlineComponentProvider=new Zx(e)}toJSON(){return{kind:this.kind}}}function gV(){return new pV}function _V(t){return new mV(t==null?void 0:t.cacheSizeBytes)}function yV(t){return new dV(t)}function vV(t){return new fV(t)}class wV{constructor(e){this.forceOwnership=e,this.kind="persistentSingleTab"}toJSON(){return{kind:this.kind}}_initialize(e){this._onlineComponentProvider=new rs,this._offlineComponentProvider=new Fd(this._onlineComponentProvider,e==null?void 0:e.cacheSizeBytes,this.forceOwnership)}}class EV{constructor(){this.kind="PersistentMultipleTab"}toJSON(){return{kind:this.kind}}_initialize(e){this._onlineComponentProvider=new rs,this._offlineComponentProvider=new Nw(this._onlineComponentProvider,e==null?void 0:e.cacheSizeBytes)}}function fE(t){return new wV(t==null?void 0:t.forceOwnership)}function IV(){return new EV}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function AV(){return new Bo("deleteField")}function SV(){return new Ud("serverTimestamp")}function RV(...t){return new xD("arrayUnion",t)}function PV(...t){return new DD("arrayRemove",t)}function CV(t){return new VD("increment",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xV(t){return je(t=ue(t,Re)),new pE(t,e=>os(t,e))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DV(t,e){var n;const r=je(t=ue(t,Re));if(!r._uninitializedComponentsProvider||((n=r._uninitializedComponentsProvider)===null||n===void 0?void 0:n._offlineKind)==="memory")return Lt("Cannot enable indexes when persistence is disabled"),Promise.resolve();const i=function(o){const a=typeof o=="string"?function(l){try{return JSON.parse(l)}catch(h){throw new A(w.INVALID_ARGUMENT,"Failed to parse JSON: "+(h==null?void 0:h.message))}}(o):o,c=[];if(Array.isArray(a.indexes))for(const u of a.indexes){const l=Wm(u,"collectionGroup"),h=[];if(Array.isArray(u.fields))for(const d of u.fields){const f=Jc("setIndexConfiguration",Wm(d,"fieldPath"));d.arrayConfig==="CONTAINS"?h.push(new da(f,2)):d.order==="ASCENDING"?h.push(new da(f,0)):d.order==="DESCENDING"&&h.push(new da(f,1))}c.push(new La(La.UNKNOWN_ID,l,h,oo.empty()))}return c}(e);return hD(r,i)}function Wm(t,e){if(typeof t[e]!="string")throw new A(w.INVALID_ARGUMENT,"Missing string value for: "+e);return t[e]}(function(e,n=!0){(function(i){Qi=i})(KS),Yn(new wn("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),a=new Re(new dP(r.getProvider("auth-internal")),new mP(r.getProvider("app-check-internal")),function(u,l){if(!Object.prototype.hasOwnProperty.apply(u.options,["projectId"]))throw new A(w.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new er(u.options.projectId,l)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),a._setSettings(s),a},"PUBLIC").setMultipleInstances(!0)),cn(Kp,"4.1.0",e),cn(Kp,"4.1.0","esm2017")})();const VV=(t,e)=>e.some(n=>t instanceof n);let Qm,Jm;function kV(){return Qm||(Qm=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function NV(){return Jm||(Jm=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const gE=new WeakMap,Xl=new WeakMap,_E=new WeakMap,Ou=new WeakMap,Qd=new WeakMap;function OV(t){const e=new Promise((n,r)=>{const i=()=>{t.removeEventListener("success",s),t.removeEventListener("error",o)},s=()=>{n(Wn(t.result)),i()},o=()=>{r(t.error),i()};t.addEventListener("success",s),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&gE.set(n,t)}).catch(()=>{}),Qd.set(e,t),e}function MV(t){if(Xl.has(t))return;const e=new Promise((n,r)=>{const i=()=>{t.removeEventListener("complete",s),t.removeEventListener("error",o),t.removeEventListener("abort",o)},s=()=>{n(),i()},o=()=>{r(t.error||new DOMException("AbortError","AbortError")),i()};t.addEventListener("complete",s),t.addEventListener("error",o),t.addEventListener("abort",o)});Xl.set(t,e)}let Zl={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return Xl.get(t);if(e==="objectStoreNames")return t.objectStoreNames||_E.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return Wn(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function FV(t){Zl=t(Zl)}function LV(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const r=t.call(Mu(this),e,...n);return _E.set(r,e.sort?e.sort():[e]),Wn(r)}:NV().includes(t)?function(...e){return t.apply(Mu(this),e),Wn(gE.get(this))}:function(...e){return Wn(t.apply(Mu(this),e))}}function BV(t){return typeof t=="function"?LV(t):(t instanceof IDBTransaction&&MV(t),VV(t,kV())?new Proxy(t,Zl):t)}function Wn(t){if(t instanceof IDBRequest)return OV(t);if(Ou.has(t))return Ou.get(t);const e=BV(t);return e!==t&&(Ou.set(t,e),Qd.set(e,t)),e}const Mu=t=>Qd.get(t);function $V(t,e,{blocked:n,upgrade:r,blocking:i,terminated:s}={}){const o=indexedDB.open(t,e),a=Wn(o);return r&&o.addEventListener("upgradeneeded",c=>{r(Wn(o.result),c.oldVersion,c.newVersion,Wn(o.transaction))}),n&&o.addEventListener("blocked",()=>n()),a.then(c=>{s&&c.addEventListener("close",()=>s()),i&&c.addEventListener("versionchange",()=>i())}).catch(()=>{}),a}const qV=["get","getKey","getAll","getAllKeys","count"],UV=["put","add","delete","clear"],Fu=new Map;function Ym(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(Fu.get(e))return Fu.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,i=UV.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||qV.includes(n)))return;const s=async function(o,...a){const c=this.transaction(o,i?"readwrite":"readonly");let u=c.store;return r&&(u=u.index(a.shift())),(await Promise.all([u[n](...a),i&&c.done]))[0]};return Fu.set(e,s),s}FV(t=>({...t,get:(e,n,r)=>Ym(e,n)||t.get(e,n,r),has:(e,n)=>!!Ym(e,n)||t.has(e,n)}));const yE="@firebase/installations",Jd="0.6.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vE=1e4,wE=`w:${Jd}`,EE="FIS_v2",jV="https://firebaseinstallations.googleapis.com/v1",KV=60*60*1e3,zV="installations",GV="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ZV=/^[cdef][\w-]{21}$/,eh="";function e1(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const n=t1(t);return ZV.test(n)?n:eh}catch{return eh}}function t1(t){return XV(t).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const CE=new Map;function xE(t,e){const n=eu(t);DE(n,e),n1(n,e)}function DE(t,e){const n=CE.get(t);if(!!n)for(const r of n)r(e)}function n1(t,e){const n=r1();n&&n.postMessage({key:t,fid:e}),i1()}let Vr=null;function r1(){return!Vr&&"BroadcastChannel"in self&&(Vr=new BroadcastChannel("[Firebase] FID Change"),Vr.onmessage=t=>{DE(t.data.key,t.data.fid)}),Vr}function i1(){CE.size===0&&Vr&&(Vr.close(),Vr=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xd(t){let e;const n=await tu(t.appConfig,r=>{const i=a1(r),s=c1(t,i);return e=s.registrationPromise,s.installationEntry});return n.fid===eh?{installationEntry:await e}:{installationEntry:n,registrationPromise:e}}function a1(t){const e=t||{fid:e1(),registrationStatus:0};return kE(e)}function c1(t,e){if(e.registrationStatus===0){if(!navigator.onLine){const i=Promise.reject(Wr.create("app-offline"));return{installationEntry:e,registrationPromise:i}}const n={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},r=u1(t,n);return{installationEntry:n,registrationPromise:r}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:l1(t)}:{installationEntry:e}}async function u1(t,e){try{const n=await YV(t,e);return Ya(t.appConfig,n)}catch(n){throw IE(n)&&n.customData.serverCode===409?await VE(t.appConfig):await Ya(t.appConfig,{fid:e.fid,registrationStatus:0}),n}}async function l1(t){let e=await Xm(t.appConfig);for(;e.registrationStatus===1;)await PE(100),e=await Xm(t.appConfig);if(e.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await Xd(t);return r||n}return e}function Xm(t){return tu(t,e=>{if(!e)throw Wr.create("installation-not-found");return kE(e)})}function kE(t){return h1(t)?{fid:t.fid,registrationStatus:0}:t}function h1(t){return t.registrationStatus===1&&t.registrationTime+vE<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function d1({appConfig:t,heartbeatServiceProvider:e},n){const r=f1(t,n),i=WV(t,n),s=e.getImmediate({optional:!0});if(s){const u=await s.getHeartbeatsHeader();u&&i.append("x-firebase-client",u)}const o={installation:{sdkVersion:wE,appId:t.appId}},a={method:"POST",headers:i,body:JSON.stringify(o)},c=await RE(()=>fetch(r,a));if(c.ok){const u=await c.json();return bE(u)}else throw await AE("Generate Auth Token",c)}function f1(t,{fid:e}){return`${TE(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zd(t,e=!1){let n;const r=await tu(t.appConfig,s=>{if(!NE(s))throw Wr.create("not-registered");const o=s.authToken;if(!e&&g1(o))return s;if(o.requestStatus===1)return n=p1(t,e),s;{if(!navigator.onLine)throw Wr.create("app-offline");const a=y1(s);return n=m1(t,a),a}});return n?await n:r.authToken}async function p1(t,e){let n=await Zm(t.appConfig);for(;n.authToken.requestStatus===1;)await PE(100),n=await Zm(t.appConfig);const r=n.authToken;return r.requestStatus===0?Zd(t,e):r}function Zm(t){return tu(t,e=>{if(!NE(e))throw Wr.create("not-registered");const n=e.authToken;return v1(n)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function m1(t,e){try{const n=await d1(t,e),r=Object.assign(Object.assign({},e),{authToken:n});return await Ya(t.appConfig,r),n}catch(n){if(IE(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await VE(t.appConfig);else{const r=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await Ya(t.appConfig,r)}throw n}}function NE(t){return t!==void 0&&t.registrationStatus===2}function g1(t){return t.requestStatus===2&&!_1(t)}function _1(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+KV}function y1(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}function v1(t){return t.requestStatus===1&&t.requestTime+vE<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function w1(t){const e=t,{installationEntry:n,registrationPromise:r}=await Xd(e);return r?r.catch(console.error):Zd(e).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function E1(t,e=!1){const n=t;return await I1(n),(await Zd(n,e)).token}async function I1(t){const{registrationPromise:e}=await Xd(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function T1(t){if(!t||!t.options)throw Bu("App Configuration");if(!t.name)throw Bu("App Name");const e=["projectId","apiKey","appId"];for(const n of e)if(!t.options[n])throw Bu(n);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}function Bu(t){return Wr.create("missing-app-config-values",{valueName:t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OE="installations",b1="installations-internal",A1=t=>{const e=t.getProvider("app").getImmediate(),n=T1(e),r=Gi(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},S1=t=>{const e=t.getProvider("app").getImmediate(),n=Gi(e,OE).getImmediate();return{getId:()=>w1(n),getToken:i=>E1(n,i)}};function R1(){Yn(new wn(OE,A1,"PUBLIC")),Yn(new wn(b1,S1,"PRIVATE"))}R1();cn(yE,Jd);cn(yE,Jd,"esm2017");const P1=(t,e)=>e.some(n=>t instanceof n);let eg,tg;function C1(){return eg||(eg=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function x1(){return tg||(tg=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const ME=new WeakMap,th=new WeakMap,FE=new WeakMap,$u=new WeakMap,ef=new WeakMap;function D1(t){const e=new Promise((n,r)=>{const i=()=>{t.removeEventListener("success",s),t.removeEventListener("error",o)},s=()=>{n(yn(t.result)),i()},o=()=>{r(t.error),i()};t.addEventListener("success",s),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&ME.set(n,t)}).catch(()=>{}),ef.set(e,t),e}function V1(t){if(th.has(t))return;const e=new Promise((n,r)=>{const i=()=>{t.removeEventListener("complete",s),t.removeEventListener("error",o),t.removeEventListener("abort",o)},s=()=>{n(),i()},o=()=>{r(t.error||new DOMException("AbortError","AbortError")),i()};t.addEventListener("complete",s),t.addEventListener("error",o),t.addEventListener("abort",o)});th.set(t,e)}let nh={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return th.get(t);if(e==="objectStoreNames")return t.objectStoreNames||FE.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return yn(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function k1(t){nh=t(nh)}function N1(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const r=t.call(qu(this),e,...n);return FE.set(r,e.sort?e.sort():[e]),yn(r)}:x1().includes(t)?function(...e){return t.apply(qu(this),e),yn(ME.get(this))}:function(...e){return yn(t.apply(qu(this),e))}}function O1(t){return typeof t=="function"?N1(t):(t instanceof IDBTransaction&&V1(t),P1(t,C1())?new Proxy(t,nh):t)}function yn(t){if(t instanceof IDBRequest)return D1(t);if($u.has(t))return $u.get(t);const e=O1(t);return e!==t&&($u.set(t,e),ef.set(e,t)),e}const qu=t=>ef.get(t);function LE(t,e,{blocked:n,upgrade:r,blocking:i,terminated:s}={}){const o=indexedDB.open(t,e),a=yn(o);return r&&o.addEventListener("upgradeneeded",c=>{r(yn(o.result),c.oldVersion,c.newVersion,yn(o.transaction))}),n&&o.addEventListener("blocked",()=>n()),a.then(c=>{s&&c.addEventListener("close",()=>s()),i&&c.addEventListener("versionchange",()=>i())}).catch(()=>{}),a}function Uu(t,{blocked:e}={}){const n=indexedDB.deleteDatabase(t);return e&&n.addEventListener("blocked",()=>e()),yn(n).then(()=>{})}const M1=["get","getKey","getAll","getAllKeys","count"],F1=["put","add","delete","clear"],ju=new Map;function ng(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(ju.get(e))return ju.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,i=F1.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||M1.includes(n)))return;const s=async function(o,...a){const c=this.transaction(o,i?"readwrite":"readonly");let u=c.store;return r&&(u=u.index(a.shift())),(await Promise.all([u[n](...a),i&&c.done]))[0]};return ju.set(e,s),s}k1(t=>({...t,get:(e,n,r)=>ng(e,n)||t.get(e,n,r),has:(e,n)=>!!ng(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L1="/firebase-messaging-sw.js",B1="/firebase-cloud-messaging-push-scope",BE="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",$1="https://fcmregistrations.googleapis.com/v1",$E="google.c.a.c_id",q1="google.c.a.c_l",U1="google.c.a.ts",j1="google.c.a.e";var rg;(function(t){t[t.DATA_MESSAGE=1]="DATA_MESSAGE",t[t.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(rg||(rg={}));/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mn(t){const e=new Uint8Array(t);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function K1(t){const e="=".repeat((4-t.length%4)%4),n=(t+e).replace(/\-/g,"+").replace(/_/g,"/"),r=atob(n),i=new Uint8Array(r.length);for(let s=0;s<r.length;++s)i[s]=r.charCodeAt(s);return i}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ku="fcm_token_details_db",z1=5,ig="fcm_token_object_Store";async function G1(t){if("databases"in indexedDB&&!(await indexedDB.databases()).map(s=>s.name).includes(Ku))return null;let e=null;return(await LE(Ku,z1,{upgrade:async(r,i,s,o)=>{var a;if(i<2||!r.objectStoreNames.contains(ig))return;const c=o.objectStore(ig),u=await c.index("fcmSenderId").get(t);if(await c.clear(),!!u){if(i===2){const l=u;if(!l.auth||!l.p256dh||!l.endpoint)return;e={token:l.fcmToken,createTime:(a=l.createTime)!==null&&a!==void 0?a:Date.now(),subscriptionOptions:{auth:l.auth,p256dh:l.p256dh,endpoint:l.endpoint,swScope:l.swScope,vapidKey:typeof l.vapidKey=="string"?l.vapidKey:mn(l.vapidKey)}}}else if(i===3){const l=u;e={token:l.fcmToken,createTime:l.createTime,subscriptionOptions:{auth:mn(l.auth),p256dh:mn(l.p256dh),endpoint:l.endpoint,swScope:l.swScope,vapidKey:mn(l.vapidKey)}}}else if(i===4){const l=u;e={token:l.fcmToken,createTime:l.createTime,subscriptionOptions:{auth:mn(l.auth),p256dh:mn(l.p256dh),endpoint:l.endpoint,swScope:l.swScope,vapidKey:mn(l.vapidKey)}}}}}})).close(),await Uu(Ku),await Uu("fcm_vapid_details_db"),await Uu("undefined"),H1(e)?e:null}function H1(t){if(!t||!t.subscriptionOptions)return!1;const{subscriptionOptions:e}=t;return typeof t.createTime=="number"&&t.createTime>0&&typeof t.token=="string"&&t.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const W1="firebase-messaging-database",Q1=1,Jr="firebase-messaging-store";let zu=null;function tf(){return zu||(zu=LE(W1,Q1,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Jr)}}})),zu}async function qE(t){const e=rf(t),r=await(await tf()).transaction(Jr).objectStore(Jr).get(e);if(r)return r;{const i=await G1(t.appConfig.senderId);if(i)return await nf(t,i),i}}async function nf(t,e){const n=rf(t),i=(await tf()).transaction(Jr,"readwrite");return await i.objectStore(Jr).put(e,n),await i.done,e}async function J1(t){const e=rf(t),r=(await tf()).transaction(Jr,"readwrite");await r.objectStore(Jr).delete(e),await r.done}function rf({appConfig:t}){return t.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Y1={["missing-app-config-values"]:'Missing App configuration value: "{$valueName}"',["only-available-in-window"]:"This method is available in a Window context.",["only-available-in-sw"]:"This method is available in a service worker context.",["permission-default"]:"The notification permission was not granted and dismissed instead.",["permission-blocked"]:"The notification permission was not granted and blocked instead.",["unsupported-browser"]:"This browser doesn't support the API's required to use the Firebase SDK.",["indexed-db-unsupported"]:"This browser doesn't support indexedDb.open() (ex. Safari iFrame, Firefox Private Browsing, etc)",["failed-service-worker-registration"]:"We are unable to register the default service worker. {$browserErrorMessage}",["token-subscribe-failed"]:"A problem occurred while subscribing the user to FCM: {$errorInfo}",["token-subscribe-no-token"]:"FCM returned no token when subscribing the user to push.",["token-unsubscribe-failed"]:"A problem occurred while unsubscribing the user from FCM: {$errorInfo}",["token-update-failed"]:"A problem occurred while updating the user from FCM: {$errorInfo}",["token-update-no-token"]:"FCM returned no token when updating the user to push.",["use-sw-after-get-token"]:"The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used.",["invalid-sw-registration"]:"The input to useServiceWorker() must be a ServiceWorkerRegistration.",["invalid-bg-handler"]:"The input to setBackgroundMessageHandler() must be a function.",["invalid-vapid-key"]:"The public VAPID key must be a string.",["use-vapid-key-after-get-token"]:"The usePublicVapidKey() method may only be called once and must be called before calling getToken() to ensure your VAPID key is used."},ct=new gc("messaging","Messaging",Y1);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ek=7*24*60*60*1e3;async function tk(t){const e=await rk(t.swRegistration,t.vapidKey),n={vapidKey:t.vapidKey,swScope:t.swRegistration.scope,endpoint:e.endpoint,auth:mn(e.getKey("auth")),p256dh:mn(e.getKey("p256dh"))},r=await qE(t.firebaseDependencies);if(r){if(ik(r.subscriptionOptions,n))return Date.now()>=r.createTime+ek?nk(t,{token:r.token,createTime:Date.now(),subscriptionOptions:n}):r.token;try{await UE(t.firebaseDependencies,r.token)}catch(i){console.warn(i)}return sg(t.firebaseDependencies,n)}else return sg(t.firebaseDependencies,n)}async function KE(t){const e=await qE(t.firebaseDependencies);e&&(await UE(t.firebaseDependencies,e.token),await J1(t.firebaseDependencies));const n=await t.swRegistration.pushManager.getSubscription();return n?n.unsubscribe():!0}async function nk(t,e){try{const n=await Z1(t.firebaseDependencies,e),r=Object.assign(Object.assign({},e),{token:n,createTime:Date.now()});return await nf(t.firebaseDependencies,r),n}catch(n){throw await KE(t),n}}async function sg(t,e){const r={token:await X1(t,e),createTime:Date.now(),subscriptionOptions:e};return await nf(t,r),r.token}async function rk(t,e){const n=await t.pushManager.getSubscription();return n||t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:K1(e)})}function ik(t,e){const n=e.vapidKey===t.vapidKey,r=e.endpoint===t.endpoint,i=e.auth===t.auth,s=e.p256dh===t.p256dh;return n&&r&&i&&s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function og(t){const e={from:t.from,collapseKey:t.collapse_key,messageId:t.fcmMessageId};return sk(e,t),ok(e,t),ak(e,t),e}function sk(t,e){if(!e.notification)return;t.notification={};const n=e.notification.title;n&&(t.notification.title=n);const r=e.notification.body;r&&(t.notification.body=r);const i=e.notification.image;i&&(t.notification.image=i);const s=e.notification.icon;s&&(t.notification.icon=s)}function ok(t,e){!e.data||(t.data=e.data)}function ak(t,e){var n,r,i,s,o;if(!e.fcmOptions&&!(!((n=e.notification)===null||n===void 0)&&n.click_action))return;t.fcmOptions={};const a=(i=(r=e.fcmOptions)===null||r===void 0?void 0:r.link)!==null&&i!==void 0?i:(s=e.notification)===null||s===void 0?void 0:s.click_action;a&&(t.fcmOptions.link=a);const c=(o=e.fcmOptions)===null||o===void 0?void 0:o.analytics_label;c&&(t.fcmOptions.analyticsLabel=c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ck(t){return typeof t=="object"&&!!t&&$E in t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lk{constructor(e,n,r){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const i=uk(e);this.firebaseDependencies={app:e,appConfig:i,installations:n,analyticsProvider:r}}_delete(){return Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function GE(t){try{t.swRegistration=await navigator.serviceWorker.register(L1,{scope:B1}),t.swRegistration.update().catch(()=>{})}catch(e){throw ct.create("failed-service-worker-registration",{browserErrorMessage:e==null?void 0:e.message})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hk(t,e){if(!e&&!t.swRegistration&&await GE(t),!(!e&&!!t.swRegistration)){if(!(e instanceof ServiceWorkerRegistration))throw ct.create("invalid-sw-registration");t.swRegistration=e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dk(t,e){e?t.vapidKey=e:t.vapidKey||(t.vapidKey=BE)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function HE(t,e){if(!navigator)throw ct.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw ct.create("permission-blocked");return await dk(t,e==null?void 0:e.vapidKey),await hk(t,e==null?void 0:e.serviceWorkerRegistration),tk(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fk(t,e,n){const r=pk(e);(await t.firebaseDependencies.analyticsProvider.get()).logEvent(r,{message_id:n[$E],message_name:n[q1],message_time:n[U1],message_device_time:Math.floor(Date.now()/1e3)})}function pk(t){switch(t){case yo.NOTIFICATION_CLICKED:return"notification_open";case yo.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mk(t,e){const n=e.data;if(!n.isFirebaseMessaging)return;t.onMessageHandler&&n.messageType===yo.PUSH_RECEIVED&&(typeof t.onMessageHandler=="function"?t.onMessageHandler(og(n)):t.onMessageHandler.next(og(n)));const r=n.data;ck(r)&&r[j1]==="1"&&await fk(t,n.messageType,r)}const ag="@firebase/messaging",cg="0.12.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gk=t=>{const e=new lk(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>mk(e,n)),e},_k=t=>{const e=t.getProvider("messaging").getImmediate();return{getToken:r=>HE(e,r)}};function yk(){Yn(new wn("messaging",gk,"PUBLIC")),Yn(new wn("messaging-internal",_k,"PRIVATE")),cn(ag,cg),cn(ag,cg,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function WE(){try{await $_()}catch{return!1}return typeof window!="undefined"&&Ch()&&q0()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vk(t){if(!navigator)throw ct.create("only-available-in-window");return t.swRegistration||await GE(t),KE(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wk(t,e){if(!navigator)throw ct.create("only-available-in-window");return t.onMessageHandler=e,()=>{t.onMessageHandler=null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function QE(t=G_()){return WE().then(e=>{if(!e)throw ct.create("unsupported-browser")},e=>{throw ct.create("indexed-db-unsupported")}),Gi(Le(t),"messaging").getImmediate()}async function Ek(t,e){return t=Le(t),HE(t,e)}function Ik(t){return t=Le(t),vk(t)}function Tk(t,e){return t=Le(t),wk(t,e)}yk();const bk={apiKey:"AIzaSyCcRSq6K213Zn_64FKVfQP-GvGKqDlEykk",authDomain:"firumon-9abec.firebaseapp.com",projectId:"firumon-9abec",storageBucket:"firumon-9abec.appspot.com",messagingSenderId:"985218982992",appId:"1:985218982992:web:cb6f437c446a40f204dd55"},af=z_(bk),JE=Ww(af),Ak=QE(af);var Sk=Object.freeze(Object.defineProperty({__proto__:null,default:af,firestore:JE,messaging:Ak,AbstractUserDataWriter:Hd,AggregateField:Ui,AggregateQuerySnapshot:Xw,Bytes:sr,CACHE_SIZE_UNLIMITED:mD,CollectionReference:Gt,DocumentReference:Fe,DocumentSnapshot:Gr,FieldPath:dr,FieldValue:fr,Firestore:Re,FirestoreError:A,GeoPoint:Hc,LoadBundleTask:Hw,Query:et,QueryCompositeFilterConstraint:ni,QueryConstraint:is,QueryDocumentSnapshot:Fs,QueryEndAtConstraint:Uo,QueryFieldFilterConstraint:ss,QueryLimitConstraint:$o,QueryOrderByConstraint:Xc,QuerySnapshot:Hr,QueryStartAtConstraint:qo,SnapshotMetadata:Un,Timestamp:Ne,Transaction:mE,WriteBatch:pE,_ByteString:We,_DatabaseId:er,_DocumentKey:N,_EmptyAppCheckTokenProvider:gP,_EmptyAuthCredentialsProvider:Xy,_FieldPath:Me,_TestingHooks:Lc,_cast:ue,_debugAssert:lP,_isBase64Available:jP,_logWarn:Lt,_validateIsNotUsedTogether:Uw,addDoc:cV,aggregateFieldEqual:QD,aggregateQuerySnapshotEqual:JD,and:LD,arrayRemove:PV,arrayUnion:RV,average:WD,clearIndexedDbPersistence:vD,collection:zw,collectionGroup:dD,connectFirestoreEmulator:Kw,count:hE,deleteDoc:aV,deleteField:AV,disableNetwork:ID,doc:Gw,documentId:SD,enableIndexedDbPersistence:_D,enableMultiTabIndexedDbPersistence:yD,enableNetwork:ED,endAt:zD,endBefore:KD,ensureFirestoreConfigured:je,executeWrite:os,getAggregateFromServer:dE,getCountFromServer:hV,getDoc:ZD,getDocFromCache:eV,getDocFromServer:tV,getDocs:nV,getDocsFromCache:rV,getDocsFromServer:iV,getFirestore:Ww,increment:CV,initializeFirestore:gD,limit:$D,limitToLast:qD,loadBundle:bD,memoryEagerGarbageCollector:gV,memoryLocalCache:yV,memoryLruGarbageCollector:_V,namedQuery:AD,onSnapshot:uV,onSnapshotsInSync:lV,or:FD,orderBy:BD,persistentLocalCache:vV,persistentMultipleTabManager:IV,persistentSingleTabManager:fE,query:OD,queryEqual:qd,refEqual:fD,runTransaction:bV,serverTimestamp:SV,setDoc:sV,setIndexConfiguration:DV,setLogLevel:uP,snapshotEqual:XD,startAfter:jD,startAt:UD,sum:HD,terminate:TD,updateDoc:oV,waitForPendingWrites:wD,where:MD,writeBatch:xV,deleteToken:Ik,getMessaging:QE,getToken:Ek,isSupported:WE,onMessage:Tk},Symbol.toStringTag,{value:"Module"}));zw(JE,"updates");T0("/sw.js",{ready(t){},registered(){},cached(){},updatefound(){},updated(){},offline(){},error(){}});const Rk="/";async function Pk({app:t,router:e,store:n},r){let i=!1;const s=c=>{try{return e.resolve(c).href}catch{}return Object(c)===c?null:c},o=c=>{if(i=!0,typeof c=="string"&&/^https?:\/\//.test(c)){window.location.href=c;return}const u=s(c);u!==null&&(window.location.href=u,window.location.reload())},a=window.location.href.replace(window.location.origin,"");for(let c=0;i===!1&&c<r.length;c++)try{await r[c]({app:t,router:e,store:n,ssrContext:null,redirect:o,urlPath:a,publicPath:Rk})}catch(u){if(u&&u.url){o(u.url);return}console.error("[Quasar] boot error:",u);return}i!==!0&&(t.use(e),t.mount("#q-app"))}w0(Vb,E0).then(t=>{const[e,n]=Promise.allSettled!==void 0?["allSettled",r=>r.map(i=>{if(i.status==="rejected"){console.error("[Quasar] boot error:",i.reason);return}return i.value.default})]:["all",r=>r.map(i=>i.default)];return Promise[e]([mi(()=>Promise.resolve().then(function(){return Sk}),void 0),mi(()=>import("./vuefire.0d8d4d5c.js"),["assets/vuefire.0d8d4d5c.js","assets/index.cf7752d6.js"]),mi(()=>import("./notification.9aeb46fb.js"),[])]).then(r=>{const i=n(r).filter(s=>typeof s=="function");Pk(t,i)})});export{pI as $,Ep as A,iN as B,wn as C,F0 as D,gc as E,Xr as F,dN as G,uN as H,sN as I,aN as J,S0 as K,U_ as L,hN as M,eN as N,rN as O,nN as P,fN as Q,Wk as R,KS as S,C0 as T,rc as U,yi as V,UI as W,qe as X,As as Y,vT as Z,Yn as _,Xk as a,_g as a0,nV as a1,uV as a2,ZD as a3,Ne as a4,Hc as a5,Nt as a6,Ah as a7,Fr as a8,Hg as a9,s_ as aA,a_ as aB,nT as aC,xt as aD,kk as aE,HT as aF,Ck as aG,TT as aH,u_ as aI,Vk as aJ,Dk as aK,Xt as aL,WT as aM,Uk as aN,d_ as aO,vo as aP,Hk as aQ,zw as aR,JE as aS,Wg as aa,zs as ab,yh as ac,Si as ad,zk as ae,jk as af,Kb as ag,Mt as ah,Lk as ai,Mk as aj,pT as ak,al,Nk as am,$k as an,Bk as ao,Qf as ap,Fk as aq,Ok as ar,qk as as,xk as at,la as au,Kk as av,Yr as aw,Qg as ax,wh as ay,iA as az,Gk as b,Yk as c,Le as d,lN as e,af as f,Qk as g,Gi as h,Jk as i,O0 as j,G_ as k,ge as l,Ws as m,Qs as n,pl as o,Zk as p,cN as q,cn as r,oN as s,Ch as t,F_ as u,gg as v,XT as w,an as x,A0 as y,tN as z};
