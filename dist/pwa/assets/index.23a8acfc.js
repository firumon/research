import{E as Zt,g as Fs,L as zn,i as Yn,a as Ws,_ as Ge,C as qe,r as we,c as jo,S as Ne,d as Ae,e as zo,h as Hs,j as Yo,k as Vs,l as Xn,m as B,n as Xo,F as en,q as Ye,o as Qo,p as Jo,s as Rn,D as Mt,t as Zo,u as Bs,v as ea,w as Gs,x as qs,y as _,z as L,A as Qn,B as he,G as ta,H as na,I as Ke,J as Lt,K as ft,M as ia,N as Ks,O as sa,P as ra,Q as tn,R as oa,T as aa,U as Fe,V as se,W as la,X as ca,Y as ua,Z as ha,$ as da,a0 as fa,a1 as pa,a2 as Jn,a3 as $s,a4 as _a,a5 as ga}from"./index.43be54d4.js";function Zn(n,e){var t={};for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&e.indexOf(i)<0&&(t[i]=n[i]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,i=Object.getOwnPropertySymbols(n);s<i.length;s++)e.indexOf(i[s])<0&&Object.prototype.propertyIsEnumerable.call(n,i[s])&&(t[i[s]]=n[i[s]]);return t}function js(){return{["dependent-sdk-initialized-before-auth"]:"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const ma=js,zs=new Zt("auth","Firebase",js());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yu{constructor(){this.counters_={}}incrementCounter(e,t=1){he(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return oa(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
