 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function J(e,t=!1){let n;const o=await A(e.appConfig,i=>{if(!Re(i))throw w.create("not-registered");const s=i.authToken;if(!t&&$t(s))return i;if(s.requestStatus===1)return n=Lt(e,t),i;{if(!navigator.onLine)throw w.create("app-offline");const a=Kt(i);return n=jt(e,a),a}});return n?await n:o.authToken}async function Lt(e,t){let n=await ie(e.appConfig);for(;n.authToken.requestStatus===1;)await _e(100),n=await ie(e.appConfig);const o=n.authToken;return o.requestStatus===0?J(e,t):o}function ie(e){return A(e,t=>{if(!Re(t))throw w.create("not-registered");const n=t.authToken;return xt(n)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function jt(e,t){try{const n=await Bt(e,t),o=Object.assign(Object.assign({},t),{authToken:n});return await S(e.appConfig,o),n}catch(n){if(Se(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await Pe(e.appConfig);else{const o=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await S(e.appConfig,o)}throw n}}function Re(e){return e!==void 0&&e.registrationStatus===2}function $t(e){return e.requestStatus===2&&!Ft(e)}function Ft(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+pt}function Kt(e){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}function xt(e){return e.requestStatus===1&&e.requestTime+Ie<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pn(e){if(!e||!e.options)throw j("App Configuration Object");if(!e.name)throw j("App Name");const t=["projectId","apiKey","appId","messagingSenderId"],{options:n}=e;for(const o of t)if(!n[o])throw j(o);return{appName:e.name,projectId:n.projectId,apiKey:n.apiKey,appId:n.appId,senderId:n.messagingSenderId}}function j(e){return f.create("missing-app-config-values",{valueName:e})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jn(e,t){t?e.vapidKey=t:e.vapidKey||(e.vapidKey=Ke)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ue(e,t){if(!navigator)throw f.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw f.create("permission-blocked");return await jn(e,t==null?void 0:t.vapidKey),await Ln(e,t==null?void 0:t.serviceWorkerRegistration),vn(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kn(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===y.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(pe(n)):e.onMessageHandler.next(pe(n)));const o=n.data;Nn(o)&&o[pn]==="1"&&await $n(e,n.messageType,o)}const le="@firebase/messaging",ge="0.12.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hn(e=ze()){return Wn().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),q(we(e),"messaging").getImmediate()}async function Un(e,t){return e=we(e),Ue(e,t)}qn();const Ge=Hn(Ze);console.log({messaging:Ge});navigator.serviceWorker.ready.then(e=>{Un(Ge,{vapidKey:"BKebiwNapiHH6w2mi5B8m7i0_DfYvVOmaByt7DqlVjy-Abdilhkd6WHb29zfifbdx_yU4uCpaEKzTIcZPVTL8ws",serviceWorkerRegistration:e}).then(t=>{console.log("Messaging Token",{token:t})}).catch(t=>console.log("Get token error",{e:t}))});
